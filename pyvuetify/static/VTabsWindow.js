...
const lT = {
  __name: "VTabsWindow",
  setup(e) {
    const t = fn("children"), n = fn("tag"), a = fn("reverse"), l = fn("disabled"), i = fn("model_value"), o = fn("theme"), r = fn("selected_class"), s = fn("direction"), u = fn("crossfade"), c = fn("transition_duration"), d = fn("vertical_arrows");
    return (f, v) => {
      const k = Nv("v-tabs-window", !0);
      return XS(), QS(k, {
        tag: Ke(n),
        reverse: Ke(a),
        disabled: Ke(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "reverse", "disabled", "modelValue", "theme", "selectedClass", "direction", "crossfade", "transitionDuration", "verticalArrows"]);
    };
  }
