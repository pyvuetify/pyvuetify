...
const lT = {
  __name: "VFileUpload",
  setup(e) {
    const t = He("children"), n = He("title"), a = He("length"), l = He("border"), i = He("icon"), o = He("model_value"), r = He("density"), s = He("height"), u = He("max_height"), c = He("max_width"), d = He("min_height"), f = He("min_width"), v = He("width"), k = He("elevation"), m = He("location"), y = He("position"), h = He("rounded"), x = He("tile"), w = He("tag"), b = He("theme"), S = He("color"), g = He("name"), I = He("disabled"), C = He("multiple"), T = He("subtitle"), P = He("opacity"), F = He("scrim"), A = He("close_delay"), B = He("open_delay"), D = He("clearable"), L = He("thickness"), W = He("show_size"), N = He("filter_by_type"), J = He("browse_text"), q = He("divider_text"), $ = He("hide_browse");
    return (ne, K) => {
      const H = Nv("v-file-upload", !0);
      return XS(), QS(H, {
        title: Ie(n),
        length: Ie(a),
        border: Ie(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "length", "border", "icon", "modelValue", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "location", "position", "rounded", "tile", "tag", "theme", "color", "name", "disabled", "multiple", "subtitle", "opacity", "scrim", "closeDelay", "openDelay", "clearable", "thickness", "showSize", "filterByType", "browseText", "dividerText", "hideBrowse"]);
    };
  }
