...
class tS {
  ...
  get value() {
    ...
    return this._shallow && (t = Pe(t)), this._value = t === void 0 ? this._defaultValue : t;
  }
  set value(t) {
...
function wm(e, t) {
  ...
  const a = function() {
    for (var l = arguments.length, i = new Array(l), o = 0; o < l; o++)
      i[o] = arguments[o];
    clearTimeout(n), n = setTimeout(() => e(...i), Pe(t));
  };
  return a.clear = () => {
    clearTimeout(n);
  }, a.immediate = e, a;
...
function lt(e, t) {
  const n = Bu(), a = /* @__PURE__ */ ae(e), l = _(() => {
    if (Pe(t?.disabled)) return n.value;
    const o = Pe(t?.scoped), r = Pe(t?.reset), s = Pe(t?.root);
...
function Ca(e, t) {
  ...
  function o(f, v) {
    ...
    Pe(k.value) === void 0 && (k.value = h, k.useIndexAsValue = !0), h > -1 ? a.splice(h, 0, k) : a.push(k);
  }
  function r(f) {
    if (n) return;
    s();
...
function Tg(e) {
  ...
  })), m = ct("validation"), y = _(() => e.name ?? Pe(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
...
const Gu = /* @__PURE__ */ Symbol.for("vuetify:v-slide-group"), qu = R({
  ...
  setup(e, t) {
    ...
    const {
      ...
      themeClasses: d
    } = He(e), f = ke(e, "modelValue"), v = ba(e, Eg, !1), k = ba(e, Gu, !1), m = zi(e, n), y = /* @__PURE__ */ E(() => e.link !== !1 && m.isLink.value), h = _(() => !e.disabled && e.link !== !1 && (!!v || e.link || m.isClickable.value)), x = /* @__PURE__ */ E(() => ({
...
function dh(e, t) {
  ...
  const b = wm(() => {
    ...
    $ && (S(), c = u.value.offsetTop, b.immediate(), W(), ~x && Ie(() => {
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = _(() => a?.transform ? Pe(t).map((s) => [s, a.transform(s)]) : Pe(t));
  at(() => {
    const s = typeof n == "function" ? n() : Pe(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = mC(o.value, u, {
      customKeyFilter: {
        ...e.customKeyFilter,
        ...Pe(a?.customKeyFilter)
      },
      default: e.customFilter,
      filterKeys: e.filterKeys,
      filterMode: e.filterMode,
      noFilter: e.noFilter
    }), d = Pe(t), f = [], v = /* @__PURE__ */ new Map();
    c.forEach((k) => {
      let {
        index: m,
        matches: y
...
const gC = R({
  ...
  setup(e, t) {
    ...
    return ue(i, (z, oe) => {
      z !== oe && (z ? (j.value = !0, x.value = e.multiple || F.value ? "" : String(w.value.at(-1)?.props.title ?? ""), o.value = !0, Ie(() => j.value = !1)) : (!e.multiple && x.value == null && (w.value = []), N.value = !1, !o.value && x.value && (d.value = x.value), x.value = "", c.value = -1));
    }), ue(x, (z) => {
...
const T_ = Ot({
  ...
  setup(e, t) {
    ...
    ue(C, (Y) => {
      f ? Ie(() => f = !1) : o.value && !N.value && (N.value = !0), n("update:search", Y);
    }), ue(w, (Y) => {
    ...
    function ve(Y) {
      f = !0, Ie(() => f = !1), e.openOnClear && (N.value = !0);
    }
    function Z() {
      L.value || (N.value = !0);
    }
...
const TI = R({
  ...
  setup(e, t) {
    ...
    function A(H) {
      ...
      if (new RegExp(`^-?\\d*${To(c.value)}?\\d*$`).test(de) || (H.preventDefault(), G.value = xe, Ie(() => m.value = xe)), e.precision != null) {
...
const BI = R({
  ...
  setup(e, t) {
    ...
    const {
      ...
      themeClasses: l
    } = He(e), i = /* @__PURE__ */ ae(), o = ke(e, "modelValue"), r = _(() => je(parseFloat(o.value), 0, Number(e.length))), s = _(() => Jt(Number(e.length), 1)), u = _(() => s.value.flatMap((b) => e.halfIncrements ? [b - 0.5, b] : [b])), c = /* @__PURE__ */ se(-1), d = _(() => u.value.map((b) => {
...
function We(e) {
  ...
  const a = eS((i, o) => (n = o, {
    ...
    set(r) {
      t.set(Pe(e), kt(r)), t.save_changes();
    }
  })), l = () => {
    a.value = t.get(Pe(e)), n();
  };
  return ht(() => {
    t.on(`change:${e}`, l);
  }), Xo(() => {
...
const lT = {
  __name: "VTabs",
  setup(e) {
    const t = We("children"), n = We("symbol"), a = We("model_value"), l = We("density"), i = We("height"), o = We("tag"), r = We("color"), s = We("disabled"), u = We("max"), c = We("multiple"), d = We("items"), f = We("stacked"), v = We("selected_class"), k = We("spaced"), m = We("bg_color"), y = We("mandatory"), h = We("content_class"), x = We("direction"), w = We("mobile"), b = We("next_icon"), S = We("prev_icon"), g = We("inset"), I = We("mobile_breakpoint"), C = We("center_active"), T = We("scroll_to_active"), P = We("show_arrows"), F = We("slider_color"), A = We("grow"), B = We("slider_transition_duration"), D = We("hide_slider"), L = We("slider_transition"), W = We("align_tabs"), N = We("fixed_tabs"), J = We("inset_padding"), q = We("inset_radius");
    return ($, ne) => {
      const K = Nv("v-tabs", !0);
      return XS(), QS(K, {
        symbol: Pe(n),
        ...
        prevIcon: Pe(S),
        inset: Pe(g),
        mobileBreakpoint: Pe(I),
        centerActive: Pe(C),
        scrollToActive: Pe(T),
        showArrows: Pe(P),
        sliderColor: Pe(F),
        grow: Pe(A),
        sliderTransitionDuration: Pe(B),
        hideSlider: Pe(D),
        sliderTransition: Pe(L),
        alignTabs: Pe(W),
        fixedTabs: Pe(N),
        insetPadding: Pe(J),
        insetRadius: Pe(q)
        ...
        _: 1
        /* STABLE */
      }, 8, ["symbol", "modelValue", "density", "height", "tag", "color", "disabled", "max", "multiple", "items", "stacked", "selectedClass", "spaced", "bgColor", "mandatory", "contentClass", "direction", "mobile", "nextIcon", "prevIcon", "inset", "mobileBreakpoint", "centerActive", "scrollToActive", "showArrows", "sliderColor", "grow", "sliderTransitionDuration", "hideSlider", "sliderTransition", "alignTabs", "fixedTabs", "insetPadding", "insetRadius"]);
    };
  }
