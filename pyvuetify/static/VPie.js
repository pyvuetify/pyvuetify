...
const lT = {
  __name: "VPie",
  setup(e) {
    const t = mt("children"), n = mt("legend"), a = mt("title"), l = mt("size"), i = mt("density"), o = mt("rounded"), r = mt("bg_color"), s = mt("items"), u = mt("item_value"), c = mt("item_key"), d = mt("tooltip"), f = mt("palette"), v = mt("item_title"), k = mt("rotate"), m = mt("gauge_cut"), y = mt("inner_cut"), h = mt("hover_scale"), x = mt("gap"), w = mt("animation"), b = mt("hide_slice"), S = mt("reveal");
    return (g, I) => {
      const C = Nv("v-pie", !0);
      return XS(), QS(C, {
        legend: Oe(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["legend", "title", "size", "density", "rounded", "bgColor", "items", "itemValue", "itemKey", "tooltip", "palette", "itemTitle", "rotate", "gaugeCut", "innerCut", "hoverScale", "gap", "animation", "hideSlice", "reveal"]);
    };
  }
