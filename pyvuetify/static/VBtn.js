...
const Kh = R({
  ...
  function B(Z) {
    ...
    const xe = t.direction === "vertical", Ce = xe ? "top" : "left", Ie = xe ? "height" : "width", M = xe ? "clientY" : "clientX", {
      [Ce]: O,
      [Ie]: j
    } = ce.getBoundingClientRect(), re = t1(Z, M);
...
const h_ = ["auto", "start", "end", "center", "baseline", "stretch"], y_ = R({
  cols: {
    type: [Boolean, String, Number],
    default: !1
  },
...
}), B_ = ["default", "accordion", "inset", "popout"], F_ = R({
  flat: Boolean,
  ...ll(),
...
const z_ = R({
  ...
  setup(e, t) {
    ...
    const {
      ...
      filterAccepted: o
    } = H_(e), r = ke(e, "modelValue", e.modelValue, (q) => qe(q), (q) => !e.multiple && Array.isArray(q) ? q[0] : q), {
      isFocused: s,
      focus: u,
      blur: c
...
const lT = {
  __name: "VBtn",
  setup(e) {
    const t = Oe("children"), n = Oe("symbol"), a = Oe("flat"), l = Oe("replace"), i = Oe("tag"), o = Oe("disabled"), r = Oe("height"), s = Oe("size"), u = Oe("value"), c = Oe("width"), d = Oe("location"), f = Oe("color"), v = Oe("density"), k = Oe("border"), m = Oe("elevation"), y = Oe("rounded"), h = Oe("tile"), x = Oe("theme"), w = Oe("text"), b = Oe("icon"), S = Oe("variant"), g = Oe("max_height"), I = Oe("max_width"), C = Oe("min_height"), T = Oe("min_width"), P = Oe("stacked"), F = Oe("position"), A = Oe("base_color"), B = Oe("active"), D = Oe("selected_class"), L = Oe("block"), W = Oe("active_color"), N = Oe("href"), J = Oe("to"), q = Oe("exact"), $ = Oe("prepend_icon"), ne = Oe("append_icon"), K = Oe("readonly"), H = Oe("slim"), G = Oe("ripple"), X = Oe("loading"), fe = Oe("spaced");
    return (Z, ce) => {
      const xe = Nv("v-btn", !0);
      return XS(), QS(xe, {
        symbol: _e(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["symbol", "flat", "replace", "tag", "disabled", "height", "size", "value", "width", "location", "color", "density", "border", "elevation", "rounded", "tile", "theme", "text", "icon", "variant", "maxHeight", "maxWidth", "minHeight", "minWidth", "stacked", "position", "baseColor", "active", "selectedClass", "block", "activeColor", "href", "to", "exact", "prependIcon", "appendIcon", "readonly", "slim", "ripple", "loading", "spaced"]);
    };
  }
