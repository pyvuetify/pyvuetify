...
const lT = {
  __name: "VInput",
  setup(e) {
    const t = Ue("children"), n = Ue("name"), a = Ue("error"), l = Ue("label"), i = Ue("disabled"), o = Ue("width"), r = Ue("id"), s = Ue("model_value"), u = Ue("color"), c = Ue("density"), d = Ue("theme"), f = Ue("max_width"), v = Ue("min_width"), k = Ue("base_color"), m = Ue("prepend_icon"), y = Ue("append_icon"), h = Ue("readonly"), x = Ue("direction"), w = Ue("messages"), b = Ue("center_affix"), S = Ue("glow"), g = Ue("icon_color"), I = Ue("hide_spin_buttons"), C = Ue("hint"), T = Ue("persistent_hint"), P = Ue("error_messages"), F = Ue("max_errors"), A = Ue("rules"), B = Ue("validate_on"), D = Ue("validation_value"), L = Ue("focused"), W = Ue("hide_details");
    return (N, J) => {
      const q = Nv("v-input", !0);
      return XS(), QS(q, {
        name: De(n),
        error: De(a),
        label: De(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["name", "error", "label", "disabled", "width", "id", "modelValue", "color", "density", "theme", "maxWidth", "minWidth", "baseColor", "prependIcon", "appendIcon", "readonly", "direction", "messages", "centerAffix", "glow", "iconColor", "hideSpinButtons", "hint", "persistentHint", "errorMessages", "maxErrors", "rules", "validateOn", "validationValue", "focused", "hideDetails"]);
    };
  }
