...
const lT = {
  __name: "VBreadcrumbsItem",
  setup(e) {
    const t = jt("children"), n = jt("replace"), a = jt("tag"), l = jt("title"), i = jt("disabled"), o = jt("width"), r = jt("color"), s = jt("max_width"), u = jt("active"), c = jt("active_class"), d = jt("active_color"), f = jt("href"), v = jt("to"), k = jt("exact");
    return (m, y) => {
      const h = Nv("v-breadcrumbs-item", !0);
      return XS(), QS(h, {
        replace: Ye(n),
        tag: Ye(a),
        title: Ye(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["replace", "tag", "title", "disabled", "width", "color", "maxWidth", "active", "activeClass", "activeColor", "href", "to", "exact"]);
    };
  }
