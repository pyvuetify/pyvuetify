  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      const Ce = w.value === "split" ? V("div", {
        ...
        vertical: !0
      }, null), ve()]) : e.reverse || w.value === "hidden" ? void 0 : V(he, null, [xe(), ce()]), Ie = n["append-inner"] || Ce, M = w.value === "split" ? V("div", {
        class: "v-number-input__control"
      }, [Z(), p(tn, {
        vertical: !0
...
const lT = {
  __name: "VAppBarNavIcon",
  setup(e) {
    const t = Oe("children"), n = Oe("symbol"), a = Oe("text"), l = Oe("flat"), i = Oe("replace"), o = Oe("border"), r = Oe("icon"), s = Oe("density"), u = Oe("height"), c = Oe("max_height"), d = Oe("max_width"), f = Oe("min_height"), v = Oe("min_width"), k = Oe("width"), m = Oe("elevation"), y = Oe("location"), h = Oe("position"), x = Oe("rounded"), w = Oe("tile"), b = Oe("tag"), S = Oe("theme"), g = Oe("color"), I = Oe("variant"), C = Oe("disabled"), T = Oe("size"), P = Oe("value"), F = Oe("active"), A = Oe("active_color"), B = Oe("base_color"), D = Oe("prepend_icon"), L = Oe("append_icon"), W = Oe("block"), N = Oe("readonly"), J = Oe("slim"), q = Oe("stacked"), $ = Oe("ripple"), ne = Oe("selected_class"), K = Oe("loading"), H = Oe("href"), G = Oe("exact"), X = Oe("to");
    return (ve, Z) => {
      const ce = Nv("v-app-bar-nav-icon", !0);
      return XS(), QS(ce, {
        symbol: _e(n),
        text: _e(a),
        flat: _e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["symbol", "text", "flat", "replace", "border", "icon", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "location", "position", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "size", "value", "active", "activeColor", "baseColor", "prependIcon", "appendIcon", "block", "readonly", "slim", "stacked", "ripple", "selectedClass", "loading", "href", "exact", "to"]);
    };
  }
