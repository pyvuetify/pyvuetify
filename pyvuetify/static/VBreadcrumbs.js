...
const lT = {
  __name: "VBreadcrumbs",
  setup(e) {
    const t = Gt("children"), n = Gt("tag"), a = Gt("disabled"), l = Gt("color"), i = Gt("density"), o = Gt("rounded"), r = Gt("tile"), s = Gt("icon"), u = Gt("bg_color"), c = Gt("divider"), d = Gt("active_class"), f = Gt("active_color"), v = Gt("items");
    return (k, m) => {
      const y = Nv("v-breadcrumbs", !0);
      return XS(), QS(y, {
        tag: Ye(n),
        disabled: Ye(a),
        color: Ye(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "disabled", "color", "density", "rounded", "tile", "icon", "bgColor", "divider", "activeClass", "activeColor", "items"]);
    };
  }
