...
const lT = {
  __name: "VResponsive",
  setup(e) {
    const t = Cn("children"), n = Cn("height"), a = Cn("width"), l = Cn("inline"), i = Cn("max_height"), o = Cn("max_width"), r = Cn("min_height"), s = Cn("min_width"), u = Cn("content_class"), c = Cn("aspect_ratio");
    return (d, f) => {
      const v = Nv("v-responsive", !0);
      return XS(), QS(v, {
        height: Ze(n),
        width: Ze(a),
        inline: Ze(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["height", "width", "inline", "maxHeight", "maxWidth", "minHeight", "minWidth", "contentClass", "aspectRatio"]);
    };
  }
