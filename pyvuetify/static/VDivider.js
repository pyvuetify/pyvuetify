...
const lT = {
  __name: "VDivider",
  setup(e) {
    const t = fn("children"), n = fn("length"), a = fn("theme"), l = fn("color"), i = fn("variant"), o = fn("opacity"), r = fn("vertical"), s = fn("gradient"), u = fn("inset"), c = fn("thickness"), d = fn("content_offset");
    return (f, v) => {
      const k = Nv("v-divider", !0);
      return XS(), QS(k, {
        length: Ke(n),
        theme: Ke(a),
        color: Ke(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["length", "theme", "color", "variant", "opacity", "vertical", "gradient", "inset", "thickness", "contentOffset"]);
    };
  }
