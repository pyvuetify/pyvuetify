...
const lT = {
  __name: "VBanner",
  setup(e) {
    const t = et("children"), n = et("tag"), a = et("height"), l = et("width"), i = et("location"), o = et("color"), r = et("density"), s = et("border"), u = et("elevation"), c = et("rounded"), d = et("tile"), f = et("theme"), v = et("text"), k = et("icon"), m = et("max_height"), y = et("max_width"), h = et("min_height"), x = et("min_width"), w = et("avatar"), b = et("bg_color"), S = et("stacked"), g = et("sticky"), I = et("mobile"), C = et("mobile_breakpoint"), T = et("position"), P = et("lines");
    return (F, A) => {
      const B = Nv("v-banner", !0);
      return XS(), QS(B, {
        tag: $e(n),
        height: $e(a),
        width: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "height", "width", "location", "color", "density", "border", "elevation", "rounded", "tile", "theme", "text", "icon", "maxHeight", "maxWidth", "minHeight", "minWidth", "avatar", "bgColor", "stacked", "sticky", "mobile", "mobileBreakpoint", "position", "lines"]);
    };
  }
