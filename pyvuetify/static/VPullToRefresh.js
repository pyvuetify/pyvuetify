...
const lT = {
  __name: "VPullToRefresh",
  setup(e) {
    const t = ns("children"), n = ns("disabled"), a = ns("pull_down_threshold");
    return (l, i) => {
      const o = Nv("v-pull-to-refresh", !0);
      return XS(), QS(o, {
        disabled: mt(n),
        pullDownThreshold: mt(a)
      }, {
        default: pv(() => [
          Ut(
            Pn(mt(t)),
