...
const lT = {
  __name: "VChip",
  setup(e) {
    const t = He("children"), n = He("filter"), a = He("replace"), l = He("link"), i = He("tag"), o = He("label"), r = He("disabled"), s = He("size"), u = He("value"), c = He("draggable"), d = He("model_value"), f = He("color"), v = He("density"), k = He("border"), m = He("elevation"), y = He("rounded"), h = He("tile"), x = He("theme"), w = He("text"), b = He("variant"), S = He("base_color"), g = He("selected_class"), I = He("active_class"), C = He("href"), T = He("to"), P = He("exact"), F = He("prepend_icon"), A = He("append_icon"), B = He("ripple"), D = He("append_avatar"), L = He("prepend_avatar"), W = He("closable"), N = He("close_icon"), J = He("close_label"), q = He("filter_icon"), $ = He("pill");
    return (ne, K) => {
      const H = Nv("v-chip", !0);
      return XS(), QS(H, {
        filter: Ie(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["filter", "replace", "link", "tag", "label", "disabled", "size", "value", "draggable", "modelValue", "color", "density", "border", "elevation", "rounded", "tile", "theme", "text", "variant", "baseColor", "selectedClass", "activeClass", "href", "to", "exact", "prependIcon", "appendIcon", "ripple", "appendAvatar", "prependAvatar", "closable", "closeIcon", "closeLabel", "filterIcon", "pill"]);
    };
  }
