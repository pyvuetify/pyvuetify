...
const lT = {
  __name: "VLocaleProvider",
  setup(e) {
    const t = Gl("children"), n = Gl("locale"), a = Gl("rtl"), l = Gl("messages"), i = Gl("fallback_locale");
    return (o, r) => {
      const s = Nv("v-locale-provider", !0);
      return XS(), QS(s, {
        locale: it(n),
        rtl: it(a),
        messages: it(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["locale", "rtl", "messages", "fallbackLocale"]);
    };
  }
