...
const lT = {
  __name: "VPieSegment",
  setup(e) {
    const t = Gt("children"), n = Gt("pattern"), a = Gt("value"), l = Gt("color"), i = Gt("rounded"), o = Gt("active"), r = Gt("rotate"), s = Gt("inner_cut"), u = Gt("hover_scale"), c = Gt("gap"), d = Gt("animation"), f = Gt("hide_slice"), v = Gt("reveal");
    return (k, m) => {
      const y = Nv("v-pie-segment", !0);
      return XS(), QS(y, {
        pattern: Ye(n),
        value: Ye(a),
        color: Ye(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["pattern", "value", "color", "rounded", "active", "rotate", "innerCut", "hoverScale", "gap", "animation", "hideSlice", "reveal"]);
    };
  }
