  ...
  setup(e) {
    ...
    return (Z, ce) => {
      ...
      return XS(), QS(xe, {
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "replace", "link", "border", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "value", "active", "activeColor", "baseColor", "prependIcon", "appendIcon", "slim", "ripple", "href", "exact", "to", "subtitle", "activeClass", "lines", "prependGap", "nav", "clearable", "showSize", "file", "fileIcon", "appendAvatar", "prependAvatar"]);
    };
  }
