...
const lT = {
  __name: "VStepper",
  setup(e) {
    const t = Ne("children"), n = Ne("flat"), a = Ne("border"), l = Ne("model_value"), i = Ne("height"), o = Ne("max_height"), r = Ne("max_width"), s = Ne("min_height"), u = Ne("min_width"), c = Ne("width"), d = Ne("elevation"), f = Ne("location"), v = Ne("position"), k = Ne("rounded"), m = Ne("tile"), y = Ne("tag"), h = Ne("theme"), x = Ne("color"), w = Ne("disabled"), b = Ne("max"), S = Ne("multiple"), g = Ne("items"), I = Ne("selected_class"), C = Ne("bg_color"), T = Ne("mandatory"), P = Ne("item_title"), F = Ne("item_value"), A = Ne("item_props"), B = Ne("mobile"), D = Ne("hide_actions"), L = Ne("mobile_breakpoint"), W = Ne("alt_labels"), N = Ne("complete_icon"), J = Ne("edit_icon"), q = Ne("editable"), $ = Ne("error_icon"), ne = Ne("non_linear"), K = Ne("prev_text"), H = Ne("next_text");
    return (G, X) => {
      const fe = Nv("v-stepper", !0);
      return XS(), QS(fe, {
        flat: _e(n),
        border: _e(a),
        modelValue: _e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["flat", "border", "modelValue", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "location", "position", "rounded", "tile", "tag", "theme", "color", "disabled", "max", "multiple", "items", "selectedClass", "bgColor", "mandatory", "itemTitle", "itemValue", "itemProps", "mobile", "hideActions", "mobileBreakpoint", "altLabels", "completeIcon", "editIcon", "editable", "errorIcon", "nonLinear", "prevText", "nextText"]);
    };
  }
