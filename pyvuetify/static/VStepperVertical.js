      ...
      return p(Mn, U({
        ...
        "append-inner": function() {
          for (var Ce = arguments.length, _e = new Array(Ce), M = 0; M < Ce; M++)
            _e[M] = arguments[M];
          return V(he, null, [n["append-inner"]?.(..._e), e.menuIcon ? p(He, {
...
const lT = {
  __name: "VStepperVertical",
  setup(e) {
    const t = Re("children"), n = Re("flat"), a = Re("model_value"), l = Re("elevation"), i = Re("rounded"), o = Re("tile"), r = Re("tag"), s = Re("theme"), u = Re("color"), c = Re("variant"), d = Re("disabled"), f = Re("max"), v = Re("multiple"), k = Re("items"), m = Re("readonly"), y = Re("ripple"), h = Re("selected_class"), x = Re("eager"), w = Re("bg_color"), b = Re("expand_icon"), S = Re("collapse_icon"), g = Re("mandatory"), I = Re("item_title"), C = Re("item_value"), T = Re("item_props"), P = Re("mobile"), F = Re("hide_actions"), A = Re("focusable"), B = Re("mobile_breakpoint"), D = Re("alt_labels"), L = Re("complete_icon"), W = Re("edit_icon"), N = Re("editable"), J = Re("error_icon"), q = Re("non_linear"), $ = Re("prev_text"), ne = Re("next_text");
    return (K, H) => {
      const G = Nv("v-stepper-vertical", !0);
      return XS(), QS(G, {
        flat: Ie(n),
        modelValue: Ie(a),
        elevation: Ie(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["flat", "modelValue", "elevation", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "max", "multiple", "items", "readonly", "ripple", "selectedClass", "eager", "bgColor", "expandIcon", "collapseIcon", "mandatory", "itemTitle", "itemValue", "itemProps", "mobile", "hideActions", "focusable", "mobileBreakpoint", "altLabels", "completeIcon", "editIcon", "editable", "errorIcon", "nonLinear", "prevText", "nextText"]);
    };
  }
