...
const Xu = (e) => {
  ...
  setup(e, t) {
    ...
    return te(() => {
      const Z = b.value ? "a" : e.tag, de = a.title || e.title != null, xe = a.subtitle || e.subtitle != null, Ce = !!(e.appendAvatar || e.appendIcon), Ie = !!(Ce || a.append), M = !!(e.prependAvatar || e.prependIcon), O = !!(M || a.prepend);
      ...
      if (y.value && !An()) {
        ...
        requestAnimationFrame(() => {
          const q = Du(N), $ = J.getBoundingClientRect(), ne = $.x - q.x, K = $.y - q.y - (q.height / 2 - $.height / 2), H = $.width / 0.75, G = Math.abs(H - q.width) > 1 ? {
            maxWidth: ce(H)
          } : void 0, X = getComputedStyle(N), fe = getComputedStyle(J), Z = parseFloat(X.transitionDuration) * 1e3 || 150, de = parseFloat(fe.getPropertyValue("--v-field-label-scale")), xe = fe.getPropertyValue("color");
...
const sc = R({
  ...
  setup(e, t) {
    ...
    function q(X) {
      ...
      if (!X.props.disabled)
        if (e.multiple) {
          const Z = c.value.findIndex((xe) => (e.valueComparator || xt)(xe.value, X.value)), de = fe ?? !~Z;
          if (~Z) {
    ...
    return ue(C, () => {
      ...
      const X = !!(e.chips || n.chip), fe = !!(!e.hideNoData || S.value.length || n["prepend-item"] || n["append-item"] || n["no-data"]), Z = c.value.length > 0, de = Mn.filterProps(e), xe = Z || !m.value && e.label && !e.persistentPlaceholder ? void 0 : e.placeholder;
      return p(Mn, U({
        ref: l
      }, de, {
  ...
  setup(e, t) {
    ...
    function H(X, fe) {
      ...
      if ([N, J, q, $].includes(X.key)) {
        ...
        Ce === -1 && fe === s.value && !Ie && !Number.isInteger(de) ? fe = fe - de % 1 * Z : fe = fe + Ce * Z * K.value[Ie];
      } else if (X.key === W)
        fe = r.value;
      else if (X.key === L)
        fe = s.value;
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      return p(Za, U({
        ...
        bottom: () => a.bottom ? a.bottom(Z.value) : !e.hideDefaultFooter && V(he, null, [p(tn, null, null), p(Ti, de, {
...
`) : G;
    ...
    return ue(r, (G, X) => {
      ...
      if (!Z.length) return;
      const de = l.date(fe[fe.length - 1]), xe = l.date(Z[Z.length - 1]);
      ...
      const G = El.filterProps(e), X = Me(Ks.filterProps(e), ["viewMode"]), fe = Gs.filterProps(e), Z = qs.filterProps(e), de = Me(Xs.filterProps(e), ["modelValue"]), xe = Me(Zs.filterProps(e), ["modelValue"]), Ce = {
        color: v.value,
        header: w.value,
        transition: C.value
      };
  ...
  setup(e, t) {
    ...
    return ue(r, (q) => {
      ...
      const q = !!(l.counter || e.counter), $ = !!(q || l.details), [ne, K] = Fn(n), {
        ...
        ...wa.filterProps(e),
        "onClick:clear": A
      }, fe = n.webkitdirectory !== void 0 && n.webkitdirectory !== !1, Z = n.accept ? String(n.accept) : void 0, de = fe ? void 0 : e.filterByType ?? Z;
      return p(Tt, U({
        ref: y,
  ...
  setup(e, t) {
    ...
    function A(H) {
      ...
      const G = H.target, {
        ...
        selectionStart: fe,
        selectionEnd: Z
      } = G ?? {}, de = X ? X.slice(0, fe) + H.data + X.slice(Z) : H.data, xe = e0(de, e.precision, c.value);
    ...
    return te(() => {
      ...
      const Ce = w.value === "split" ? V("div", {
        ...
        vertical: !0
      }, null), fe()]) : e.reverse || w.value === "hidden" ? void 0 : V(he, null, [xe(), de()]), Ie = n["append-inner"] || Ce, M = w.value === "split" ? V("div", {
        class: "v-number-input__control"
      }, [Z(), p(tn, {
        vertical: !0
  ...
  setup(e, t) {
    ...
    function W($) {
      ...
      const {
        ...
        x: X - H,
        y: K - fe
      }, xe = Math.round(D(Z, de) - e.rotate + 360) % 360, Ce = e.double && B(Z, de) < (G + G * w.value) / 4, Ie = Math.ceil(15 / y.value);
      let M;
      for (let O = 0; O < Ie; O++)
...
const lT = {
  __name: "VRadioGroup",
  setup(e) {
    const t = Ne("children"), n = Ne("type"), a = Ne("name"), l = Ne("error"), i = Ne("label"), o = Ne("disabled"), r = Ne("height"), s = Ne("width"), u = Ne("id"), c = Ne("model_value"), d = Ne("color"), f = Ne("density"), v = Ne("theme"), k = Ne("inline"), m = Ne("max_width"), y = Ne("min_width"), h = Ne("base_color"), x = Ne("prepend_icon"), w = Ne("append_icon"), b = Ne("readonly"), S = Ne("ripple"), g = Ne("messages"), I = Ne("center_affix"), C = Ne("glow"), T = Ne("icon_color"), P = Ne("hide_spin_buttons"), F = Ne("hint"), A = Ne("persistent_hint"), B = Ne("error_messages"), D = Ne("max_errors"), L = Ne("rules"), W = Ne("validate_on"), N = Ne("validation_value"), J = Ne("focused"), q = Ne("hide_details"), $ = Ne("defaults_target"), ne = Ne("false_icon"), K = Ne("true_icon"), H = Ne("value_comparator");
    return (G, X) => {
      const fe = Nv("v-radio-group", !0);
      return XS(), QS(fe, {
        type: _e(n),
        name: _e(a),
        error: _e(l),
        ...
        rules: _e(L),
        validateOn: _e(W),
        validationValue: _e(N),
        focused: _e(J),
        hideDetails: _e(q),
        defaultsTarget: _e($),
        falseIcon: _e(ne),
        trueIcon: _e(K),
        valueComparator: _e(H)
      }, {
        default: pv(() => [
          Kt(
            Tn(_e(t)),
        ...
        _: 1
        /* STABLE */
      }, 8, ["type", "name", "error", "label", "disabled", "height", "width", "id", "modelValue", "color", "density", "theme", "inline", "maxWidth", "minWidth", "baseColor", "prependIcon", "appendIcon", "readonly", "ripple", "messages", "centerAffix", "glow", "iconColor", "hideSpinButtons", "hint", "persistentHint", "errorMessages", "maxErrors", "rules", "validateOn", "validationValue", "focused", "hideDetails", "defaultsTarget", "falseIcon", "trueIcon", "valueComparator"]);
    };
  }
