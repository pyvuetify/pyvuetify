...
function sl(e) {
  ...
  return t === e ? t : (Bt(t, "iterate", ui), /* @__PURE__ */ cn(e) ? t : t.map(qn));
}
function mu(e) {
  return Bt(e = /* @__PURE__ */ Ve(e), "iterate", ui), e;
}
function ua(e, t) {
...
class sv {
  ...
  get(t, n, a) {
    ...
    return tt(r) ? l ? /* @__PURE__ */ Wa(r) : /* @__PURE__ */ wt(r) : r;
  }
}
class uv extends sv {
  constructor(t = !1) {
...
function zb(e, t) {
  const n = {
    get(l) {
      ...
      e || (fa(l, r) && Bt(o, "get", l), Bt(o, "get", r));
    ...
    get size() {
      ...
      return !e && Bt(/* @__PURE__ */ Ve(l), "iterate", Ba), l.size;
    },
    has(l) {
      const i = this.__v_raw, o = /* @__PURE__ */ Ve(i), r = /* @__PURE__ */ Ve(l);
      return e || (fa(l, r) && Bt(o, "has", l), Bt(o, "has", r)), l === r ? i.has(l) : i.has(l) || i.has(r);
    },
    forEach(l, i) {
      const o = this, r = o.__v_raw, s = /* @__PURE__ */ Ve(r), u = t ? is : e ? ci : qn;
      return !e && Bt(s, "iterate", Ba), r.forEach((c, d) => l.call(i, u(c), u(d), o));
    }
  };
  return kt(
    n,
...
const qn = (e) => tt(e) ? /* @__PURE__ */ wt(e) : e, ci = (e) => tt(e) ? /* @__PURE__ */ Wa(e) : e;
// @__NO_SIDE_EFFECTS__
function rt(e) {
...
function VS(e) {
  ...
  if (W(Bl, d), W(gt, f), W($v, v), W(qo, k), W(Fv, m), W(ku, y), W(wS, C), W(kS, g), W(SS, I), W(At, p), W(Xo, b), W(bS, T), De(P))
    if (P.length) {
...
function DS(e, t) {
  return function(a, l = null) {
    Me(a) || (a = kt({}, a)), l != null && !tt(l) && (l = null);
...
function jv(e, t, n = !1) {
  ...
  return !i && !r ? (tt(e) && a.set(e, null), null) : (De(i) ? i.forEach((s) => o[s] = null) : kt(o, i), tt(e) && a.set(e, o), o);
}
function Zo(e, t) {
  ...
  const {
    ...
    if (j && _a(j, !1), (we = Se.onVnodeBeforeUpdate) && Cn(we, j, $, M), ge && Va($, M, j, "beforeUpdate"), j && _a(j, !0), (ye.innerHTML && Se.innerHTML == null || ye.textContent && Se.textContent == null) && c(Y, ""), ie ? P(
      ...
      if (le & 16)
        ...
        for (let Be = 0; Be < Ae.length; Be++) {
          const Oe = Ae[Be], bt = ye[Oe], Ze = Se[Oe];
          (Ze !== bt || Oe === "value") && i(Y, Oe, bt, Ze, z, j);
        }
      }
    ...
    const Y = () => {
      if (M.isMounted) {
        ...
        let Oe = ye, bt;
        _a(M, !1), ye ? (ye.el = Be.el, R(M, ye, me)) : ye = Be, Se && uo(Se), (bt = ye.props && ye.props.onVnodeBeforeUpdate) && Cn(bt, Ae, ye, Be), _a(M, !0);
        ...
        M.subTree = Ze, m(
          ...
          z,
          oe
        ), ye.el = Ze.el, Oe === null && OS(M, Ze.el), we && Ht(we, z), (bt = ye.props && ye.props.onVnodeUpdated) && Ht(
          () => Cn(bt, Ae, ye, Be),
          z
        );
      } else {
        let ye;
        const { el: Se, props: we } = $, { bm: Ae, m: Be, parent: Oe, root: bt, type: Ze } = M, rn = ai($);
        _a(M, !1), Ae && uo(Ae), !rn && (ye = we && we.onVnodeBeforeMount) && Cn(ye, Oe, $), _a(M, !0);
        {
          bt.ce && // @ts-expect-error _def is private
          bt.ce._def.shadowRoot !== !1 && bt.ce._injectChildStyle(Ze);
        ...
        ($.shapeFlag & 256 || Oe && ai(Oe.vnode) && Oe.vnode.shapeFlag & 256) && M.a && Ht(M.a, z), M.isMounted = !0, $ = j = re = null;
      }
    };
    M.scope.on();
    ...
    if (ie > ye) {
      ...
      for (Oe = Mc.length - 1, ie = Ze - 1; ie >= 0; ie--) {
        ...
        zl[ie] === 0 ? m(
          ...
          Y,
          le
        ) : rn && (Oe < 0 || ie !== Mc[Oe] ? ne(pn, j, Fc, 2) : Oe--);
      }
    }
  }, ne = (M, $, j, re, z = null) => {
    ...
    let Oe;
    if (Be && (Oe = me && me.onVnodeBeforeUnmount) && Cn(Oe, $, M), ge & 6)
      X(M.component, j, re);
    else {
      if (ge & 128) {
    ...
    (Be && (Oe = me && me.onVnodeUnmounted) || Ae) && Ht(() => {
      Oe && Cn(Oe, $, M), Ae && Va(M, null, $, "unmounted");
    }, j);
  }, H = (M) => {
...
function ek(e, t = null, n = null, a = 0, l = null, i = !1) {
  ...
  if (uk(e) && (e = e.__vccOpts), t) {
    ...
    r && !st(r) && (t.class = ee(r)), tt(s) && (/* @__PURE__ */ Ei(s) && !De(s) && (s = kt({}, s)), t.style = fe(s));
  }
...
function am(e) {
  return e ? /* @__PURE__ */ Ei(e) || Kv(e) ? kt({}, e) : e : null;
}
...
function wm(e, t) {
  ...
  const a = function() {
    for (var l = arguments.length, i = new Array(l), o = 0; o < l; o++)
      i[o] = arguments[o];
    clearTimeout(n), n = setTimeout(() => e(...i), We(t));
  };
  return a.clear = () => {
    clearTimeout(n);
  }, a.immediate = e, a;
...
function at(e, t) {
  const n = Bu(), a = /* @__PURE__ */ ae(e), l = _(() => {
    if (We(t?.disabled)) return n.value;
    const o = We(t?.scoped), r = We(t?.reset), s = We(t?.root);
...
function A0() {
  ...
  function r() {
    const s = I0(Il, a);
    qe(Il, _(() => o.value ? _t(s?.value ?? {}, o.value) : s?.value));
  }
  return {
    props: i,
...
function xt(e, t) {
  ...
  if (a.length !== Object.keys(t).length)
    return !1;
  const l = M0(e, t, n);
  return l || (E0(e, t, n, !0), a.every((i) => xt(e[i], t[i], n)));
}
function $m(e) {
...
async function tf(e, t, n, a) {
  const l = n ? "scrollLeft" : "scrollTop", i = _t(a?.options ?? qm(), t), o = a?.rtl.value, r = (typeof e == "number" ? e : Ru(e)) ?? 0, s = i.container === "parent" && r instanceof HTMLElement ? r.parentElement : Ow(i.container), u = An() ? i.patterns.instant : typeof i.easing == "function" ? i.easing : i.patterns[i.easing];
...
function nl(e) {
  ...
  const n = e.id ?? `layout-item-${Tt()}`, a = ut("useLayoutItem");
  qe(Xm, {
    id: n
  });
...
function Qm(e) {
  const t = Le(ki, null), n = _(() => t ? t.rootZIndex.value - 100 : lf), a = /* @__PURE__ */ ae([]), l = /* @__PURE__ */ wt(/* @__PURE__ */ new Map()), i = /* @__PURE__ */ wt(/* @__PURE__ */ new Map()), o = /* @__PURE__ */ wt(/* @__PURE__ */ new Map()), r = /* @__PURE__ */ wt(/* @__PURE__ */ new Map()), s = /* @__PURE__ */ wt(/* @__PURE__ */ new Map()), {
    resizeRef: u,
    contentRect: c
  } = dn(), d = _(() => {
...
function Ca(e, t) {
  let n = !1;
  const a = /* @__PURE__ */ wt([]), l = ke(e, "modelValue", [], (f) => f === void 0 ? [] : dg(a, f === null ? [null] : Ge(f)), (f) => {
    const v = Vx(a, f);
    return e.multiple ? v : v[0];
  }), i = ut("useGroup");
  function o(f, v) {
    const k = f, m = /* @__PURE__ */ Symbol.for(`${t.description}:id`), h = hl(m, i?.vnode).indexOf(v);
    We(k.value) === void 0 && (k.value = h, k.useIndexAsValue = !0), h > -1 ? a.splice(h, 0, k) : a.push(k);
  }
  function r(f) {
    if (n) return;
    s();
...
function zi(e, t) {
  ...
  }), o = _(() => e.to ? i : void 0), r = Fx(), s = _(() => o.value ? e.exact ? r.value ? o.value.isExactActive?.value && xt(o.value.route.value.query, r.value.query) : o.value.isExactActive?.value ?? !1 : o.value.isActive?.value ?? !1 : !1), u = _(() => e.to ? o.value?.route.value.href : e.href);
  return {
    isLink: a,
...
const ka = J()({
  ...
  setup(e, t) {
    ...
    const {
      ...
      backgroundColorStyles: d,
      trueValue: f
    } = Qx(e), v = Tt(), k = /* @__PURE__ */ se(!1), m = /* @__PURE__ */ se(!1), y = /* @__PURE__ */ ae(), h = /* @__PURE__ */ E(() => e.id || `input-${v}`), p = /* @__PURE__ */ E(() => !e.disabled && !e.readonly);
    l?.onForceUpdate(() => {
...
function Tg(e) {
  let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Ln(), n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : Tt();
  ...
  })), m = ut("validation"), y = _(() => e.name ?? We(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
...
const ip = N({
  ...
  setup(e, t) {
    ...
    const l = ke(e, "modelValue"), {
      ...
      focus: o,
      blur: r
    } = ia(e), s = /* @__PURE__ */ ae(), u = Tt();
    return te(() => {
      const [c, d] = Fn(n), f = Pt.filterProps(e), v = kn.filterProps(e);
      return x(Pt, U({
        ref: s,
...
const Gu = /* @__PURE__ */ Symbol.for("vuetify:v-slide-group"), qu = N({
  ...
  setup(e, t) {
    ...
    const {
      ...
      themeClasses: d
    } = Re(e), f = ke(e, "modelValue"), v = ba(e, Eg, !1), k = ba(e, Gu, !1), m = zi(e, n), y = /* @__PURE__ */ E(() => e.link !== !1 && m.isLink.value), h = _(() => !e.disabled && e.link !== !1 && (!!v || e.link || m.isClickable.value)), p = /* @__PURE__ */ E(() => ({
    ...
    return () => {
      ...
      return f.value && Ke(x(C, U(m.linkProps, {
        ...
        }, l.prepend) : V(he, null, [e.prependIcon && x(Ne, {
          key: "prepend-icon",
          icon: e.prependIcon,
          start: !0
        ...
        }, l.append) : V(he, null, [e.appendIcon && x(Ne, {
          key: "append-icon",
          end: !0,
          icon: e.appendIcon
...
function Ju(e) {
  ...
  function i(r) {
    const s = a.value, u = t.value, c = l.value, d = n.value, f = e.returnObject, v = !!e.valueComparator, k = e.valueComparator || xt, m = jt(e, vn.neededProps), y = [];
    e: for (const h of r) {
...
function Op(e, t) {
  ...
  je && It(() => !!(t.isActive.value && e.locationStrategy), (r) => {
...
function Hp(e, t, n) {
  ...
  const v = new pm(4), k = new ResizeObserver(() => {
    ...
    if (requestAnimationFrame((p) => {
      ...
      const p = v.values();
      if (xt(p.at(-1), p.at(-3)) && !xt(p.at(-1), p.at(-2)))
        return;
    }
    const h = y();
    h && v.push(h.flipped);
  ...
  ue(e.target, (h, p) => {
    p && !Array.isArray(p) && k.unobserve(p), Array.isArray(h) ? xt(h, p) || y() : h && k.observe(h);
  }, {
    immediate: !0
  }), ue(e.contentEl, (h, p) => {
...
const yf = /* @__PURE__ */ Symbol.for("vuetify:stack"), Kl = /* @__PURE__ */ wt([]);
function Zp(e, t, n) {
  const a = ut("useStack"), l = !n, i = Le(yf, void 0), o = /* @__PURE__ */ wt({
  ...
  It(e, () => {
    const c = Kl.at(-1)?.[1];
    r.value = c ? c + 10 : Number(St(t)), l && Kl.push([a.uid, r.value]), i?.activeChildren.add(a.uid), lt(() => {
      if (l) {
...
const Ki = N({
  ...
  setup(e, t) {
    ...
    const a = ke(e, "modelValue"), {
      ...
      isRtl: i
    } = vt(), o = Tt(), r = /* @__PURE__ */ E(() => e.id || `v-menu-${o}`), s = /* @__PURE__ */ ae(), u = Le(Ms, null), c = /* @__PURE__ */ se(/* @__PURE__ */ new Set());
    qe(Ms, {
      register() {
        c.value.add(o);
      },
  ...
  setup(e, t) {
    ...
    const {
      ...
      rtlClasses: v
    } = vt(), k = /* @__PURE__ */ E(() => e.dirty || e.active), m = /* @__PURE__ */ E(() => !!(e.label || l.label)), y = /* @__PURE__ */ E(() => !e.singleLine && m.value), h = Tt(), p = _(() => e.id || `input-${h}`), w = /* @__PURE__ */ E(() => e.details ? `${p.value}-messages` : void 0), b = /* @__PURE__ */ ae(), S = /* @__PURE__ */ ae(), g = /* @__PURE__ */ ae(), I = _(() => ["plain", "underlined"].includes(e.variant)), C = _(() => e.error || e.disabled ? void 0 : k.value && s.value ? e.color : e.baseColor), T = _(() => {
  ...
  setup(e, t) {
    ...
    return te(() => {
      const I = !!(l.counter || e.counter !== !1 && e.counter != null), C = !!(I || l.details), [T, P] = Fn(n), {
        modelValue: F,
        ...A
      } = Pt.filterProps(e), B = wa.filterProps(e);
      return x(Pt, U({
        ref: v,
        modelValue: i.value,
...
const sc = N({
  ...
  setup(e, t) {
    ...
    let p = "", w = 0, b;
    const S = _(() => e.hideSelected ? r.value.filter((X) => !c.value.some((ve) => (e.valueComparator || xt)(ve, X))) : r.value), g = _(() => e.hideNoData && !S.value.length || f.isReadonly.value || f.isDisabled.value), I = ke(e, "menu"), C = _({
      get: () => I.value,
      set: (X) => {
    ...
    function q(X) {
      ...
      if (!X.props.disabled)
        if (e.multiple) {
          const Z = c.value.findIndex((pe) => (e.valueComparator || xt)(pe.value, X.value)), de = ve ?? !~Z;
          if (~Z) {
    ...
    return ue(C, () => {
      if (!e.hideSelected && C.value && c.value.length) {
        const X = S.value.findIndex((ve) => c.value.some((Z) => (e.valueComparator || xt)(Z.value, ve.value)));
      ...
      return x(Mn, U({
        ...
        "append-inner": function() {
          for (var Ce = arguments.length, _e = new Array(Ce), M = 0; M < Ce; M++)
            _e[M] = arguments[M];
          return V(he, null, [n["append-inner"]?.(..._e), e.menuIcon ? x(Ne, {
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = _(() => a?.transform ? We(t).map((s) => [s, a.transform(s)]) : We(t));
  nt(() => {
    const s = typeof n == "function" ? n() : We(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = mC(o.value, u, {
      customKeyFilter: {
        ...e.customKeyFilter,
        ...We(a?.customKeyFilter)
      },
      default: e.customFilter,
      filterKeys: e.filterKeys,
      filterMode: e.filterMode,
      noFilter: e.noFilter
    }), d = We(t), f = [], v = /* @__PURE__ */ new Map();
    c.forEach((k) => {
      let {
        index: m,
        matches: y
...
const gC = N({
      ...
      return x(Mn, U({
                ...
                default: (ie) => {
                  ...
                  return ge.type === "divider" ? n.divider?.({
                    ...
                    prepend: (Ae) => {
                      ...
                      }, null), ge.props.prependIcon && x(Ne, {
        ...
        "append-inner": function() {
          for (var Y = arguments.length, le = new Array(Y), ie = 0; ie < Y; ie++)
            le[ie] = arguments[ie];
          return V(he, null, [n["append-inner"]?.(...le), e.menuIcon ? x(Ne, {
      ...
      return x(e.tag, U({
        ...
        default: () => [V("div", {
          ...
          default: () => [Ke(V("span", U({
            ...
            "aria-live": "polite",
            role: "status"
          }, v), [e.dot ? void 0 : t.slots.badge ? t.slots.badge?.() : e.icon ? x(Ne, {
            icon: e.icon
  ...
  setup(e, t) {
    ...
    const l = zi(e, a), i = _(() => e.active || l.isActive?.value), {
      ...
      textColorClasses: r,
      textColorStyles: s
    } = pt(() => i.value ? e.activeColor : e.color);
    return te(() => x(e.tag, {
...
function Ua(e, t) {
  let n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1, a = mt(t), l = mt(e), i = a === l;
...
function $o(e, t, n, a) {
  ...
  for (; (!c || r.length < i) && r.length < l; ) {
    if (u = mt(s), c = c || u === o, a[s.weekday] === 0) {
      s = ma(s);
      continue;
    }
    const d = Ut(s);
...
const aV = $t({
  ...
  setup(e, t) {
    ...
    function c(S) {
      const g = mt(S);
      return g < mt(l.parsedStart.value) || g > mt(l.parsedEnd.value);
    }
    function d() {
      return V("div", {
...
function bV(e, t, n, a) {
  ...
  const o = e[n], r = e[a], s = Un(o, !0), u = r ? Un(r, !0) : s, c = wf(o) ? xf(s, l) : s, d = wf(r) ? xf(u, l) : u, f = mt(c), v = xa(c), k = mt(d), m = c.hasTime ? 0 : 2359, y = xa(d) + m, h = !c.hasTime;
  return {
    input: e,
    start: c,
    startIdentifier: f,
...
function VV(e, t, n) {
  ...
  function p(D, L) {
    ...
    const R = e.eventHeight || 0, Q = e.eventMarginBottom || 0, q = mt(L), O = L.week, ne = q === W.startIdentifier;
  ...
  function w(D, L) {
    ...
    if (O === !1 || q === !1 || O < 0 || q >= 1 || kV(W, L))
      return !1;
    const ne = mt(L), K = W.startIdentifier >= ne, H = W.endIdentifier > ne, G = L.timeToY(W.start, L), X = L.timeToY(W.end, L), ve = Math.max(e.eventHeight || 0, X - G);
    return b(W, {
      eventParsed: W,
      day: L,
      start: K,
  ...
  function C() {
    const D = a.days.value, L = mt(D[0]), W = mt(D[D.length - 1]);
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      return x(e.tag, {
        ...
        }, n.append) : V(he, null, [e.appendIcon && x(Ne, {
          key: "append-icon",
          density: e.density,
          icon: e.appendIcon
        }, null), e.appendAvatar && x(nn, {
...
const Kh = N({
  ...
  setup(e, t) {
    ...
    return te(() => {
      const P = Pt.filterProps(e), [F, A] = Fn(l), B = !!(e.label || n.label || n.prepend);
      return x(Pt, U({
        ref: o,
        class: ["v-slider", {
  ...
  setup(e, t) {
    ...
    function j(Y) {
      ...
      if (!(!Y || Y.props.disabled))
        if (e.multiple) {
          const ge = w.value.findIndex((Se) => (e.valueComparator || xt)(Se.value, Y.value)), ye = le ?? !~ge;
          if (~ge) {
      ...
      return x(Mn, U({
        ...
        default: (ge) => {
          ...
          return V(he, null, [x(Dl, U({
                ...
                default: (Se) => {
                  ...
                  return we.type === "divider" ? a.divider?.({
                    ...
                    prepend: (bt) => {
                      ...
                      }, null), we.props.prependIcon && x(Ne, {
            ...
            const Be = U(Jn.filterProps(Se.props), {
              ...
              modelValue: !0,
              "onUpdate:modelValue": void 0
            }), Oe = g.value ? !!a.chip : !!a.selection, bt = Oe ? er(g.value ? a.chip({
              item: Se,
              index: we,
              props: Be
            }) : a.selection({
        ...
        "append-inner": function() {
          for (var ge = arguments.length, ye = new Array(ge), Se = 0; Se < ge; Se++)
            ye[Se] = arguments[Se];
          return V(he, null, [a["append-inner"]?.(...ye), (!e.hideNoData || e.items.length) && e.menuIcon ? x(Ne, {
...
function pr(e, t) {
  ...
  const l = ke(e, "modelValue", e.modelValue, (p) => {
    ...
    return w ? new Set(Ge(p).map((b) => n.value.find((S) => w(b, S.value))?.value ?? b)) : new Set(Ge(p).map((b) => ya(b) ? n.value.find((S) => b === S.value)?.value ?? b : n.value.find((S) => xt(b, S.value))?.value ?? b));
...
const K1 = N({
  ...
  setup(e, t) {
    ...
    return te(() => x(e.tag, {
      ...
      default: () => [n.header?.(ne.value), x(Lt, {
        transition: e.transition
      }, {
    ...
    const {
      ...
      return x(Ai, U({
        ...
        default: () => {
          ...
          }, [V("span", null, [P.title]), P.sortable && !e.disableSort && x(Ne, {
            key: "icon",
...
`) : G;
  ...
  setup(e, t) {
    ...
    return te(() => Ke(V("button", {
      ...
      }, [n.actions?.(r.value) ?? x(Ne, null, null)])]
    })]), [[Vt, e.ripple]])), {};
  }
}), Hy = N({
  title: String,
...
const BI = N({
  ...
  setup(e, t) {
    ...
    return te(() => {
      const [s, u] = Fn(n), c = Pt.filterProps(e), d = ka.filterProps(e), f = a.label ? a.label({
        label: e.label,
        props: {
          for: i.value
        }
  ...
  setup(e, t) {
    ...
    return te(() => {
      const A = Pt.filterProps(e), [B, D] = Fn(l), L = !!(e.label || n.label || n.prepend);
      return x(Pt, U({
  ...
  setup(e, t) {
    ...
    const {
      ...
      themeClasses: l
    } = Re(e), i = /* @__PURE__ */ ae(), o = ke(e, "modelValue"), r = _(() => ze(parseFloat(o.value), 0, Number(e.length))), s = _(() => Jt(Number(e.length), 1)), u = _(() => s.value.flatMap((b) => e.halfIncrements ? [b - 0.5, b] : [b])), c = /* @__PURE__ */ se(-1), d = _(() => u.value.map((b) => {
...
const Xy = N({
  ...
  setup(e, t) {
    ...
    const {
      textColorClasses: a,
      textColorStyles: l
    } = pt(() => e.color), i = _(() => !!(e.showLabels || e.labels.length > 0 || n?.label)), o = _(() => {
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      return Ke(V("button", {
        ...
        default: () => [n.icon?.(d.value) ?? (c.value ? x(Ne, {
          icon: c.value
        }, null) : l.value)]
      }), V("div", {
  ...
  setup(e, t) {
    ...
    const l = ke(e, "indeterminate"), i = ke(e, "modelValue"), {
      ...
      focus: s,
      blur: u
    } = ia(e), c = /* @__PURE__ */ ae(), d = /* @__PURE__ */ ae(), f = Iu && window.matchMedia("(forced-colors: active)").matches, v = /* @__PURE__ */ E(() => typeof e.loading == "string" && e.loading !== "" ? e.loading : e.color), k = Tt(), m = /* @__PURE__ */ E(() => e.id || `switch-${k}`);
    function y() {
      l.value && (l.value = !1);
    }
    function h(p) {
    ...
    return te(() => {
      const [p, w] = Fn(n), b = Pt.filterProps(e), S = ka.filterProps(e);
      return x(Pt, U({
        ref: d,
        class: ["v-switch", {
...
const bP = N({
  ...
  setup(e, t) {
    ...
    } = He(() => e.color), k = _(() => e.max - e.min + 1), m = _(() => e.double ? k.value / 2 : k.value), y = _(() => 360 / m.value), h = _(() => y.value * Math.PI / 180), p = _(() => e.modelValue == null ? e.min : e.modelValue), w = _(() => 0.62), b = _(() => {
      const O = [];
  ...
  setup(e, t) {
    ...
    const {
      textColorClasses: l,
      textColorStyles: i
    } = pt(() => e.color), o = /* @__PURE__ */ ae(), r = /* @__PURE__ */ se(!1);
    function s(u) {
...
function Nt(e) {
  ...
  const a = eS((i, o) => (n = o, {
    ...
    set(r) {
      t.set(We(e), St(r)), t.save_changes();
    }
  })), l = () => {
    a.value = t.get(We(e)), n();
  };
  return gt(() => {
    t.on(`change:${e}`, l);
  }), Xo(() => {
...
const lT = {
  __name: "VInfiniteScroll",
  setup(e) {
    const t = Nt("children"), n = Nt("height"), a = Nt("max_height"), l = Nt("max_width"), i = Nt("min_height"), o = Nt("min_width"), r = Nt("width"), s = Nt("tag"), u = Nt("color"), c = Nt("mode"), d = Nt("direction"), f = Nt("side"), v = Nt("margin"), k = Nt("load_more_text"), m = Nt("empty_text");
    return (y, h) => {
      const p = Nv("v-infinite-scroll", !0);
      return XS(), QS(p, {
        height: We(n),
        maxHeight: We(a),
        maxWidth: We(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "tag", "color", "mode", "direction", "side", "margin", "loadMoreText", "emptyText"]);
    };
  }
