...
const lT = {
  __name: "VBottomNavigation",
  setup(e) {
    const t = lt("children"), n = lt("tag"), a = lt("name"), l = lt("mode"), i = lt("disabled"), o = lt("height"), r = lt("max"), s = lt("multiple"), u = lt("model_value"), c = lt("absolute"), d = lt("color"), f = lt("density"), v = lt("border"), k = lt("elevation"), m = lt("rounded"), y = lt("tile"), h = lt("theme"), x = lt("order"), w = lt("bg_color"), b = lt("base_color"), S = lt("grow"), g = lt("active"), I = lt("selected_class"), C = lt("mandatory");
    return (T, P) => {
      const F = Nv("v-bottom-navigation", !0);
      return XS(), QS(F, {
        tag: $e(n),
        name: $e(a),
        mode: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "name", "mode", "disabled", "height", "max", "multiple", "modelValue", "absolute", "color", "density", "border", "elevation", "rounded", "tile", "theme", "order", "bgColor", "baseColor", "grow", "active", "selectedClass", "mandatory"]);
    };
  }
