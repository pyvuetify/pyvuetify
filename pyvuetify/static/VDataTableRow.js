...
function US(e, t) {
  ...
  const {
    ...
    Ae && Se.beforeEnter(le), a(le, $, j), ((ie = ge && ge.onVnodeMounted) || Ae || we) && Rt(() => {
      ie && xn(ie, re, M), Ae && Se.enter(le), we && Va(M, null, re, "mounted");
    }, z);
  }, I = (M, $, j, re, z) => {
    if (j && v(M, j), re)
    ...
    let we;
    if (j && _a(j, !1), (we = Se.onVnodeBeforeUpdate) && xn(we, j, $, M), ge && Va($, M, j, "beforeUpdate"), j && _a(j, !0), (ye.innerHTML && Se.innerHTML == null || ye.textContent && Se.textContent == null) && c(Y, ""), ie ? P(
      M.dynamicChildren,
      ie,
      Y,
      j,
    ...
    ((we = Se.onVnodeUpdated) || ge) && Rt(() => {
      we && xn(we, j, $, M), ge && Va($, M, j, "updated");
    }, re);
  }, P = (M, $, j, re, z, oe, me) => {
    ...
    const Y = () => {
      if (M.isMounted) {
        ...
        let Oe = ye, bt;
        _a(M, !1), ye ? (ye.el = Be.el, R(M, ye, me)) : ye = Be, Se && uo(Se), (bt = ye.props && ye.props.onVnodeBeforeUpdate) && xn(bt, Ae, ye, Be), _a(M, !0);
        ...
        _a(M, !1), Ae && uo(Ae), !on && (ye = we && we.onVnodeBeforeMount) && xn(ye, Oe, $), _a(M, !0);
        {
    ...
    if (ie > ye) {
      ...
      for (ie = we; ie <= ye; ie++) {
        ...
        pn === void 0 ? K(Kt, z, oe, !0) : (zl[pn - Ae] = ie + 1, pn >= wn ? wn = pn : on = !0, m(
          Kt,
          $[pn],
          j,
          null,
    ...
    (Be && (Oe = me && me.onVnodeUnmounted) || Ae) && Rt(() => {
      Oe && xn(Oe, $, M), Ae && Va(M, null, $, "unmounted");
    }, j);
  }, H = (M) => {
...
function Tg(e) {
  ...
  const a = ke(e, "modelValue"), l = _(() => e.validationValue === void 0 ? a.value : e.validationValue), i = Nl(e), o = lx(() => e.rules), r = /* @__PURE__ */ ae([]), s = /* @__PURE__ */ se(!0), u = _(() => !!(Ke(a.value === "" ? null : a.value).length || Ke(l.value === "" ? null : l.value).length)), c = _(() => e.errorMessages?.length ? Ke(e.errorMessages).concat(r.value).slice(0, Math.max(0, Number(e.maxErrors))) : r.value), d = _(() => {
...
const ix = N({
  ...
  setup(e, t) {
    ...
    return te(() => {
      const [c, d] = Fn(n), f = Pt.filterProps(e), v = Sn.filterProps(e);
      return p(Pt, U({
        ref: s,
...
const gC = N({
  ...
  setup(e, t) {
    ...
    const {
      ...
      InputIcon: h
    } = Yi(e), x = ke(e, "search", ""), w = ke(e, "modelValue", [], (z) => v(z === null ? [null] : Ke(z)), (z) => {
      const oe = k(z);
    ...
    for (const d of c) {
      ...
      for (const v of d.visuals) {
        ...
        if (m === !1) {
          ...
          for (const x of h)
            x.parent === y && (x.parent = k), x.index - k.index <= 1 && k.sibling && gn(k.start, ho(k.start, n), x.start, x.end) && (x.sibling = !0);
        }
        f.push(k);
      }
      cV(f, n);
...
function xr(e, t) {
  ...
  const l = ke(e, "modelValue", e.modelValue, (x) => {
    ...
    return w ? new Set(Ke(x).map((b) => n.value.find((S) => w(b, S.value))?.value ?? b)) : new Set(Ke(x).map((b) => ya(b) ? n.value.find((S) => b === S.value)?.value ?? b : n.value.find((S) => pt(b, S.value))?.value ?? b));
...
const lT = {
  __name: "VDataTableRow",
  setup(e) {
    const t = Cn("children"), n = Cn("color"), a = Cn("density"), l = Cn("mobile"), i = Cn("mobile_breakpoint"), o = Cn("item"), r = Cn("cell_props"), s = Cn("index"), u = Cn("collapse_icon"), c = Cn("expand_icon");
    return (d, f) => {
      const v = Nv("v-data-table-row", !0);
      return XS(), QS(v, {
        color: Ze(n),
        density: Ze(a),
        mobile: Ze(l),
        mobileBreakpoint: Ze(i),
        item: Ze(o),
        cellProps: Ze(r),
        index: Ze(s),
        collapseIcon: Ze(u),
        ...
        _: 1
        /* STABLE */
      }, 8, ["color", "density", "mobile", "mobileBreakpoint", "item", "cellProps", "index", "collapseIcon", "expandIcon"]);
    };
  }
