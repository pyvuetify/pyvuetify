...
const lT = {
  __name: "VCheckboxBtn",
  setup(e) {
    const t = at("children"), n = at("type"), a = at("name"), l = at("error"), i = at("label"), o = at("disabled"), r = at("indeterminate"), s = at("multiple"), u = at("value"), c = at("id"), d = at("model_value"), f = at("color"), v = at("density"), k = at("theme"), m = at("inline"), y = at("base_color"), h = at("readonly"), x = at("ripple"), w = at("indeterminate_icon"), b = at("true_value"), S = at("false_value"), g = at("defaults_target"), I = at("false_icon"), C = at("true_icon"), T = at("value_comparator");
    return (P, F) => {
      const A = Nv("v-checkbox-btn", !0);
      return XS(), QS(A, {
        type: $e(n),
        name: $e(a),
        error: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["type", "name", "error", "label", "disabled", "indeterminate", "multiple", "value", "id", "modelValue", "color", "density", "theme", "inline", "baseColor", "readonly", "ripple", "indeterminateIcon", "trueValue", "falseValue", "defaultsTarget", "falseIcon", "trueIcon", "valueComparator"]);
    };
  }
