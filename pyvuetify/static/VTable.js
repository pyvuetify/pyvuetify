...
const lT = {
  __name: "VTable",
  setup(e) {
    const t = Nn("children"), n = Nn("density"), a = Nn("height"), l = Nn("tag"), i = Nn("theme"), o = Nn("striped"), r = Nn("hover"), s = Nn("fixed_header"), u = Nn("fixed_footer");
    return (c, d) => {
      const f = Nv("v-table", !0);
      return XS(), QS(f, {
        density: Ze(n),
        height: Ze(a),
        tag: Ze(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["density", "height", "tag", "theme", "striped", "hover", "fixedHeader", "fixedFooter"]);
    };
  }
