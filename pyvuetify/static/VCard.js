...
const lT = {
  __name: "VCard",
  setup(e) {
    const t = He("children"), n = He("flat"), a = He("replace"), l = He("link"), i = He("tag"), o = He("title"), r = He("disabled"), s = He("height"), u = He("width"), c = He("image"), d = He("location"), f = He("color"), v = He("density"), k = He("border"), m = He("elevation"), y = He("rounded"), h = He("tile"), x = He("theme"), w = He("text"), b = He("variant"), S = He("max_height"), g = He("max_width"), I = He("min_height"), C = He("min_width"), T = He("position"), P = He("href"), F = He("to"), A = He("exact"), B = He("prepend_icon"), D = He("append_icon"), L = He("ripple"), W = He("loading"), N = He("subtitle"), J = He("append_avatar"), q = He("hover"), $ = He("prepend_avatar");
    return (ne, K) => {
      const H = Nv("v-card", !0);
      return XS(), QS(H, {
        flat: Ie(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["flat", "replace", "link", "tag", "title", "disabled", "height", "width", "image", "location", "color", "density", "border", "elevation", "rounded", "tile", "theme", "text", "variant", "maxHeight", "maxWidth", "minHeight", "minWidth", "position", "href", "to", "exact", "prependIcon", "appendIcon", "ripple", "loading", "subtitle", "appendAvatar", "hover", "prependAvatar"]);
    };
  }
