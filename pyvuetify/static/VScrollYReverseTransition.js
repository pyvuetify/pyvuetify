...
const lT = {
  __name: "VScrollYReverseTransition",
  setup(e) {
    const t = Ta("children"), n = Ta("disabled"), a = Ta("mode"), l = Ta("origin"), i = Ta("group"), o = Ta("hide_on_leave"), r = Ta("leave_absolute");
    return (s, u) => {
      const c = Nv("v-scroll-y-reverse-transition", !0);
      return XS(), QS(c, {
        disabled: nt(n),
        mode: nt(a),
        origin: nt(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["disabled", "mode", "origin", "group", "hideOnLeave", "leaveAbsolute"]);
    };
  }
