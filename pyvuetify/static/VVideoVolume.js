...
const lT = {
  __name: "VVideoVolume",
  setup(e) {
    const t = Ta("children"), n = Ta("model_value"), a = Ta("label"), l = Ta("menu_props"), i = Ta("direction"), o = Ta("inline"), r = Ta("slider_props");
    return (s, u) => {
      const c = Nv("v-video-volume", !0);
      return XS(), QS(c, {
        modelValue: nt(n),
        label: nt(a),
        menuProps: nt(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["modelValue", "label", "menuProps", "direction", "inline", "sliderProps"]);
    };
  }
