  ...
  setup(e, t) {
    ...
    return ue(r, (q) => {
      ...
      return p(Tt, U({
        ...
        details: O ? (Ce) => _(he, null, [l.details?.(Ce), q && _(he, null, [_("span", null, null), p(dr, {
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      const _e = w.value === "split" ? _("div", {
        ...
        vertical: !0
      }, null), fe()]) : e.reverse || w.value === "hidden" ? void 0 : _(he, null, [Ce(), ce()]), Ie = n["append-inner"] || _e, M = w.value === "split" ? _("div", {
        class: "v-number-input__control"
      }, [Z(), p(tn, {
        vertical: !0
      }, null)]) : e.reverse && w.value !== "hidden" ? _(he, null, [ce(), Ce()]) : void 0, $ = n["prepend-inner"] || M;
      return p(Mn, U({
        ref: a
      }, X, {
        modelValue: m.value,
...
const Ky = R({
  ...
  setup(e, t) {
    ...
    te(() => {
      ...
      return _(he, null, [o.value && !!r.value && (a.default ? p(De, {
        defaults: {
          VSnackbar: r.value
        }
      }, {
        ...
        actions: f ? () => _(he, null, [a.actions ? p(De, {
          defaults: {
            VBtn: d.value
          }
        }, {
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      return p(Vi, U(o, {
        ...
        ...n,
        activator: n.activator ? (r) => _(he, null, [p(De, {
          defaults: i.value
        }, {
    ...
    return te(() => {
      ...
      return p(fn, U({
        ...
        prepend: v ? (k) => _(he, null, [e.indentLines && e.indentLines.length > 0 ? _("div", {
          ...
          default: () => [e.toggleIcon ? _(he, null, [n.toggle ? p(De, {
            key: "prepend-defaults",
            defaults: {
              VBtn: {
                density: "compact",
...
const lT = {
  __name: "VFileInput",
  setup(e) {
    const t = Pe("children"), n = Pe("flat"), a = Pe("model_value"), l = Pe("error"), i = Pe("reverse"), o = Pe("density"), r = Pe("max_width"), s = Pe("min_width"), u = Pe("width"), c = Pe("rounded"), d = Pe("tile"), f = Pe("theme"), v = Pe("color"), k = Pe("variant"), m = Pe("name"), y = Pe("disabled"), h = Pe("multiple"), x = Pe("id"), w = Pe("active"), b = Pe("base_color"), S = Pe("prepend_icon"), g = Pe("append_icon"), I = Pe("readonly"), C = Pe("loading"), T = Pe("label"), P = Pe("chips"), F = Pe("bg_color"), A = Pe("counter"), B = Pe("center_affix"), D = Pe("glow"), L = Pe("icon_color"), W = Pe("hide_spin_buttons"), N = Pe("hint"), J = Pe("persistent_hint"), q = Pe("messages"), O = Pe("error_messages"), ne = Pe("max_errors"), K = Pe("rules"), H = Pe("validate_on"), G = Pe("validation_value"), X = Pe("focused"), fe = Pe("hide_details"), Z = Pe("append_inner_icon"), ce = Pe("clearable"), Ce = Pe("clear_icon"), _e = Pe("dirty"), Ie = Pe("persistent_clear"), M = Pe("prepend_inner_icon"), $ = Pe("single_line"), j = Pe("counter_size_string"), re = Pe("counter_string"), z = Pe("hide_input"), oe = Pe("show_size"), me = Pe("truncate_length"), Y = Pe("filter_by_type");
    return (le, ie) => {
      const ge = Nv("v-file-input", !0);
      return XS(), QS(ge, {
        flat: xe(n),
        modelValue: xe(a),
        error: xe(l),
        ...
        rules: xe(K),
        validateOn: xe(H),
        validationValue: xe(G),
        focused: xe(X),
        hideDetails: xe(fe),
        appendInnerIcon: xe(Z),
        clearable: xe(ce),
        clearIcon: xe(Ce),
        dirty: xe(_e),
        persistentClear: xe(Ie),
        prependInnerIcon: xe(M),
        singleLine: xe($),
        counterSizeString: xe(j),
        counterString: xe(re),
        hideInput: xe(z),
        showSize: xe(oe),
        truncateLength: xe(me),
        filterByType: xe(Y)
      }, {
        default: pv(() => [
          Kt(
        ...
        _: 1
        /* STABLE */
      }, 8, ["flat", "modelValue", "error", "reverse", "density", "maxWidth", "minWidth", "width", "rounded", "tile", "theme", "color", "variant", "name", "disabled", "multiple", "id", "active", "baseColor", "prependIcon", "appendIcon", "readonly", "loading", "label", "chips", "bgColor", "counter", "centerAffix", "glow", "iconColor", "hideSpinButtons", "hint", "persistentHint", "messages", "errorMessages", "maxErrors", "rules", "validateOn", "validationValue", "focused", "hideDetails", "appendInnerIcon", "clearable", "clearIcon", "dirty", "persistentClear", "prependInnerIcon", "singleLine", "counterSizeString", "counterString", "hideInput", "showSize", "truncateLength", "filterByType"]);
    };
  }
