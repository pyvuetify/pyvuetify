...
const lT = {
  __name: "VCarouselItem",
  setup(e) {
    const t = Ue("children"), n = Ue("alt"), a = Ue("disabled"), l = Ue("height"), i = Ue("src"), o = Ue("value"), r = Ue("width"), s = Ue("draggable"), u = Ue("absolute"), c = Ue("color"), d = Ue("rounded"), f = Ue("tile"), v = Ue("inline"), k = Ue("transition"), m = Ue("max_height"), y = Ue("max_width"), h = Ue("min_height"), x = Ue("min_width"), w = Ue("position"), b = Ue("selected_class"), S = Ue("content_class"), g = Ue("eager"), I = Ue("options"), C = Ue("cover"), T = Ue("gradient"), P = Ue("lazy_src"), F = Ue("sizes"), A = Ue("srcset"), B = Ue("aspect_ratio"), D = Ue("crossorigin"), L = Ue("referrerpolicy"), W = Ue("reverse_transition");
    return (N, J) => {
      const q = Nv("v-carousel-item", !0);
      return XS(), QS(q, {
        alt: De(n),
        disabled: De(a),
        height: De(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["alt", "disabled", "height", "src", "value", "width", "draggable", "absolute", "color", "rounded", "tile", "inline", "transition", "maxHeight", "maxWidth", "minHeight", "minWidth", "position", "selectedClass", "contentClass", "eager", "options", "cover", "gradient", "lazySrc", "sizes", "srcset", "aspectRatio", "crossorigin", "referrerpolicy", "reverseTransition"]);
    };
  }
