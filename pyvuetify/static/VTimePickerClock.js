...
const lT = {
  __name: "VTimePickerClock",
  setup(e) {
    const t = Nt("children"), n = Nt("disabled"), a = Nt("max"), l = Nt("min"), i = Nt("step"), o = Nt("model_value"), r = Nt("color"), s = Nt("scrollable"), u = Nt("readonly"), c = Nt("rotate"), d = Nt("ampm"), f = Nt("displayed_value"), v = Nt("double"), k = Nt("format"), m = Nt("allowed_values");
    return (y, h) => {
      const x = Nv("v-time-picker-clock", !0);
      return XS(), QS(x, {
        disabled: We(n),
        max: We(a),
        min: We(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["disabled", "max", "min", "step", "modelValue", "color", "scrollable", "readonly", "rotate", "ampm", "displayedValue", "double", "format", "allowedValues"]);
    };
  }
