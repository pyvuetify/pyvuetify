...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, Tk = (e, t, n, a, l, i) => {
  const o = l === "svg";
  t === "class" ? yk(e, a, o) : t === "style" ? kk(e, n, a) : Ro(t) ? su(t) || xk(e, t, n, a, i) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : Ak(e, t, a, o)) ? (vd(e, t, a), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && fd(e, t, a, o, i, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && (/[A-Z]/.test(t) || !st(a)) ? vd(e, Wt(t), a, i, t) : (t === "true-value" ? e._trueValue = a : t === "false-value" && (e._falseValue = a), fd(e, t, a, o));
};
function Ak(e, t, n, a) {
  if (a)
...
const ze = typeof window < "u", _u = ze && "IntersectionObserver" in window, Yk = ze && ("ontouchstart" in window || window.navigator.maxTouchPoints > 0), pd = ze && "EyeDropper" in window, Iu = ze && "matchMedia" in window && typeof window.matchMedia == "function", An = () => Iu && window.matchMedia("(prefers-reduced-motion: reduce)").matches;
function xd(e, t, n) {
  Uk(e, t), t.set(e, n);
}
function Uk(e, t) {
  ...
  function f(h) {
    ...
    if (x) {
      ...
      if (x.push) {
        ...
        ze ? (x.addHeadObjs(/* @__PURE__ */ E(w)), nt(() => x.updateDOM())) : x.addHeadObjs(w());
    } else {
      let w = function() {
...
function tg() {
  ...
  return r.run(() => {
    ...
    function m(h) {
      ...
      if (x.run(() => {
        c.install(h);
      }), h.onUnmount(() => x.stop()), h.provide(Il, s), h.provide(Cs, u), h.provide(Si, c), h.provide(ps, d), h.provide(Pl, f), h.provide(Ym, v.options), h.provide(Xd, v.instance), h.provide(Gm, k), ze && a.ssr)
        if (h.$nuxt)
...
const Ap = N({
  ...
  setup(e, t) {
    ...
    const a = 20, l = 2 * Math.PI * a, i = /* @__PURE__ */ ae(), {
      ...
      resizeRef: m,
      contentRect: y
    } = dn(), h = /* @__PURE__ */ E(() => We(parseFloat(e.modelValue), 0, 100)), x = /* @__PURE__ */ E(() => Number(e.width)), w = /* @__PURE__ */ E(() => s.value ? Number(e.size) : y.value ? y.value.width : Math.max(x.value, 32)), b = /* @__PURE__ */ E(() => a / (1 - x.value / w.value) * 2), S = /* @__PURE__ */ E(() => x.value / w.value * b.value), g = /* @__PURE__ */ E(() => {
...
function Ju(e) {
  ...
  function i(r) {
    const s = a.value, u = t.value, c = l.value, d = n.value, f = e.returnObject, v = !!e.valueComparator, k = e.valueComparator || pt, m = zt(e, vn.neededProps), y = [];
    e: for (const h of r) {
...
const lT = {
  __name: "VDataTableFooter",
  setup(e) {
    const t = jt("children"), n = jt("color"), a = jt("next_icon"), l = jt("prev_icon"), i = jt("first_icon"), o = jt("last_icon"), r = jt("items_per_page_text"), s = jt("page_text"), u = jt("first_page_label"), c = jt("prev_page_label"), d = jt("next_page_label"), f = jt("last_page_label"), v = jt("items_per_page_options"), k = jt("show_current_page");
    return (m, y) => {
      const h = Nv("v-data-table-footer", !0);
      return XS(), QS(h, {
        color: Ye(n),
        nextIcon: Ye(a),
        prevIcon: Ye(l),
        firstIcon: Ye(i),
        lastIcon: Ye(o),
        itemsPerPageText: Ye(r),
        pageText: Ye(s),
        firstPageLabel: Ye(u),
        prevPageLabel: Ye(c),
        nextPageLabel: Ye(d),
        lastPageLabel: Ye(f),
        itemsPerPageOptions: Ye(v),
        showCurrentPage: Ye(k)
      }, {
        default: pv(() => [
          Kt(
            Tn(Ye(t)),
        ...
        _: 1
        /* STABLE */
      }, 8, ["color", "nextIcon", "prevIcon", "firstIcon", "lastIcon", "itemsPerPageText", "pageText", "firstPageLabel", "prevPageLabel", "nextPageLabel", "lastPageLabel", "itemsPerPageOptions", "showCurrentPage"]);
    };
  }
