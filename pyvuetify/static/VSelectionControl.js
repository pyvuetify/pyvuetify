...
const lT = {
  __name: "VSelectionControl",
  setup(e) {
    const t = ot("children"), n = ot("type"), a = ot("model_value"), l = ot("error"), i = ot("density"), o = ot("theme"), r = ot("color"), s = ot("name"), u = ot("disabled"), c = ot("multiple"), d = ot("value"), f = ot("id"), v = ot("base_color"), k = ot("readonly"), m = ot("ripple"), y = ot("label"), h = ot("value_comparator"), x = ot("inline"), w = ot("true_value"), b = ot("false_value"), S = ot("defaults_target"), g = ot("false_icon"), I = ot("true_icon");
    return (C, T) => {
      const P = Nv("v-selection-control", !0);
      return XS(), QS(P, {
        type: $e(n),
        modelValue: $e(a),
        error: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["type", "modelValue", "error", "density", "theme", "color", "name", "disabled", "multiple", "value", "id", "baseColor", "readonly", "ripple", "label", "valueComparator", "inline", "trueValue", "falseValue", "defaultsTarget", "falseIcon", "trueIcon"]);
    };
  }
