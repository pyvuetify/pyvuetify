...
const lT = {
  __name: "VTreeview",
  setup(e) {
    const t = Ve("children"), n = Ve("search"), a = Ve("border"), l = Ve("model_value"), i = Ve("density"), o = Ve("height"), r = Ve("max_height"), s = Ve("max_width"), u = Ve("min_height"), c = Ve("min_width"), d = Ve("width"), f = Ve("elevation"), v = Ve("rounded"), k = Ve("tile"), m = Ve("tag"), y = Ve("theme"), h = Ve("color"), x = Ve("variant"), w = Ve("activated"), b = Ve("disabled"), S = Ve("items"), g = Ve("active_color"), I = Ve("base_color"), C = Ve("slim"), T = Ve("filter_mode"), P = Ve("no_filter"), F = Ve("custom_filter"), A = Ve("custom_key_filter"), B = Ve("filter_keys"), D = Ve("hide_no_data"), L = Ve("active_class"), W = Ve("bg_color"), N = Ve("filterable"), J = Ve("expand_icon"), q = Ve("collapse_icon"), O = Ve("lines"), ne = Ve("prepend_gap"), K = Ve("indent"), H = Ve("activatable"), G = Ve("selectable"), X = Ve("opened"), fe = Ve("selected"), Z = Ve("mandatory"), ce = Ve("items_registration"), Ce = Ve("active_strategy"), _e = Ve("select_strategy"), Pe = Ve("item_title"), M = Ve("item_value"), $ = Ve("item_children"), j = Ve("item_props"), re = Ve("item_type"), z = Ve("return_object"), oe = Ve("value_comparator"), me = Ve("open_on_click"), Y = Ve("no_data_text"), le = Ve("hide_actions"), ie = Ve("false_icon"), ge = Ve("true_icon"), he = Ve("open_all"), Se = Ve("fluid"), we = Ve("loading_icon"), De = Ve("indeterminate_icon"), Fe = Ve("selected_color"), Re = Ve("separate_roots"), mt = Ve("indent_lines"), Ke = Ve("load_children");
    return (Gt, vn) => {
      const _a = Nv("v-treeview", !0);
      return XS(), QS(_a, {
        search: ke(n),
        border: ke(a),
        modelValue: ke(l),
        ...
        selected: ke(fe),
        mandatory: ke(Z),
        itemsRegistration: ke(ce),
        activeStrategy: ke(Ce),
        selectStrategy: ke(_e),
        itemTitle: ke(Pe),
        itemValue: ke(M),
        itemChildren: ke($),
        itemProps: ke(j),
        ...
        _: 1
        /* STABLE */
      }, 8, ["search", "border", "modelValue", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "rounded", "tile", "tag", "theme", "color", "variant", "activated", "disabled", "items", "activeColor", "baseColor", "slim", "filterMode", "noFilter", "customFilter", "customKeyFilter", "filterKeys", "hideNoData", "activeClass", "bgColor", "filterable", "expandIcon", "collapseIcon", "lines", "prependGap", "indent", "activatable", "selectable", "opened", "selected", "mandatory", "itemsRegistration", "activeStrategy", "selectStrategy", "itemTitle", "itemValue", "itemChildren", "itemProps", "itemType", "returnObject", "valueComparator", "openOnClick", "noDataText", "hideActions", "falseIcon", "trueIcon", "openAll", "fluid", "loadingIcon", "indeterminateIcon", "selectedColor", "separateRoots", "indentLines", "loadChildren"]);
    };
  }
