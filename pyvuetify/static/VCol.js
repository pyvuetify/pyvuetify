...
const yx = [null, "prominent", "default", "comfortable", "compact"], ug = N({
  ...
  setup(e, t) {
    ...
    const {
      ...
      rtlClasses: u
    } = vt(), c = /* @__PURE__ */ se(e.extended === null ? !!n.extension?.() : e.extended), d = _(() => parseInt(Number(e.height) + (e.density === "prominent" ? Number(e.height) : 0) - (e.density === "comfortable" ? 8 : 0) - (e.density === "compact" ? 16 : 0), 10)), f = _(() => c.value ? parseInt(Number(e.extensionHeight) + (e.density === "prominent" ? Number(e.extensionHeight) : 0) - (e.density === "comfortable" ? 4 : 0) - (e.density === "compact" ? 8 : 0), 10) : 0);
    return at({
      VBtn: {
        variant: "text"
      }
...
const Ki = N({
  ...
  setup(e, t) {
    ...
    const a = ke(e, "modelValue"), {
      ...
      isRtl: i
    } = vt(), o = At(), r = /* @__PURE__ */ E(() => e.id || `v-menu-${o}`), s = /* @__PURE__ */ ae(), u = Le(Ms, null), c = /* @__PURE__ */ se(/* @__PURE__ */ new Set());
    Xe(Ms, {
      register() {
        c.value.add(o);
      },
...
const Kh = N({
  ...
  const r = Nl(t), {
    isRtl: s
  } = vt(), u = /* @__PURE__ */ E(() => t.reverse), c = _(() => t.direction === "vertical"), d = _(() => c.value !== u.value), {
    min: f,
    max: v,
    step: k,
    decimals: m,
  ...
  setup(e, t) {
    ...
    const i = /* @__PURE__ */ ae(), o = /* @__PURE__ */ ae(), {
      rtlClasses: r
    } = vt(), s = Gh(e), u = ke(e, "modelValue", void 0, (P) => s.roundValue(P ?? s.min.value)), {
      min: c,
      max: d,
      mousePressed: f,
      roundValue: v,
    ...
    return te(() => {
      ...
      return e.loading && (!e.items.length || a.loading) ? V("tr", {
        ...
        if (m.type === "group") {
          ...
          return a["group-header"] ? a["group-header"](w) : x(a_, U({
...
const Ly = N({
  ...
  setup(e, t) {
    ...
    const l = /* @__PURE__ */ ae(), {
      ...
      weekNumbers: s,
      weekdayLabels: u
    } = P_(e), c = Qa(), d = /* @__PURE__ */ se(), f = /* @__PURE__ */ se(), v = /* @__PURE__ */ se(!1), k = /* @__PURE__ */ E(() => v.value ? e.reverseTransition : e.transition);
  ...
  setup(e, t) {
    ...
    const l = Qa(), {
      ...
      rtlClasses: o
    } = vt(), r = ke(e, "modelValue", void 0, (G) => Ge(G).map((q) => l.date(q)), (G) => e.multiple ? G : G[0]), s = ke(e, "viewMode"), {
      minDate: u,
      maxDate: c,
      clampDate: d
    } = Fy(e), f = _(() => {
...
const z_ = N({
  ...
  setup(e, t) {
    ...
    const {
      ...
      filterAccepted: o
    } = H_(e), r = ke(e, "modelValue", e.modelValue, (X) => Ge(X), (X) => !e.multiple && Array.isArray(X) ? X[0] : X), {
      isFocused: s,
      focus: u,
      blur: c
...
const J_ = J()({
  ...
  setup(e) {
    ...
    function k(h) {
      ...
      const p = Z_(e.keyMap, String(h[2]), c.value);
      return v(p);
    }
    function m(h, p) {
...
const lT = {
  __name: "VCol",
  setup(e) {
    const t = mt("children"), n = mt("tag"), a = mt("order"), l = mt("sm"), i = mt("md"), o = mt("lg"), r = mt("xl"), s = mt("xxl"), u = mt("offset"), c = mt("cols"), d = mt("offset_sm"), f = mt("offset_md"), v = mt("offset_lg"), k = mt("offset_xl"), m = mt("offset_xxl"), y = mt("order_sm"), h = mt("order_md"), p = mt("order_lg"), w = mt("order_xl"), b = mt("order_xxl"), S = mt("align_self");
    return (g, I) => {
      const C = Nv("v-col", !0);
      return qS(), QS(C, {
        tag: Oe(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "order", "sm", "md", "lg", "xl", "xxl", "offset", "cols", "offsetSm", "offsetMd", "offsetLg", "offsetXl", "offsetXxl", "orderSm", "orderMd", "orderLg", "orderXl", "orderXxl", "alignSelf"]);
    };
  }
