...
const lT = {
  __name: "VSystemBar",
  setup(e) {
    const t = sn("children"), n = sn("height"), a = sn("elevation"), l = sn("absolute"), i = sn("rounded"), o = sn("tile"), r = sn("tag"), s = sn("theme"), u = sn("color"), c = sn("name"), d = sn("order"), f = sn("window");
    return (v, k) => {
      const m = Nv("v-system-bar", !0);
      return XS(), QS(m, {
        height: Ue(n),
        elevation: Ue(a),
        absolute: Ue(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["height", "elevation", "absolute", "rounded", "tile", "tag", "theme", "color", "name", "order", "window"]);
    };
  }
