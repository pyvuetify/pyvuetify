...
const lT = {
  __name: "VChipGroup",
  setup(e) {
    const t = at("children"), n = at("symbol"), a = at("filter"), l = at("tag"), i = at("disabled"), o = at("max"), r = at("multiple"), s = at("model_value"), u = at("color"), c = at("theme"), d = at("variant"), f = at("mobile"), v = at("mobile_breakpoint"), k = at("base_color"), m = at("selected_class"), y = at("mandatory"), h = at("content_class"), x = at("direction"), w = at("column"), b = at("next_icon"), S = at("prev_icon"), g = at("show_arrows"), I = at("value_comparator"), C = at("center_active"), T = at("scroll_to_active");
    return (P, F) => {
      const A = Nv("v-chip-group", !0);
      return XS(), QS(A, {
        symbol: $e(n),
        filter: $e(a),
        tag: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["symbol", "filter", "tag", "disabled", "max", "multiple", "modelValue", "color", "theme", "variant", "mobile", "mobileBreakpoint", "baseColor", "selectedClass", "mandatory", "contentClass", "direction", "column", "nextIcon", "prevIcon", "showArrows", "valueComparator", "centerActive", "scrollToActive"]);
    };
  }
