...
function wm(e, t) {
  ...
  const a = function() {
    for (var l = arguments.length, i = new Array(l), o = 0; o < l; o++)
      i[o] = arguments[o];
    clearTimeout(n), n = setTimeout(() => e(...i), Ae(t));
  };
  return a.clear = () => {
    clearTimeout(n);
  }, a.immediate = e, a;
...
function lt(e, t) {
  const n = Bu(), a = /* @__PURE__ */ ae(e), l = _(() => {
    ...
    const o = Ae(t?.scoped), r = Ae(t?.reset), s = Ae(t?.root);
...
function Ca(e, t) {
  ...
  function o(f, v) {
    ...
    Ae(k.value) === void 0 && (k.value = h, k.useIndexAsValue = !0), h > -1 ? a.splice(h, 0, k) : a.push(k);
  }
  function r(f) {
    if (n) return;
    s();
...
function Tg(e) {
  ...
  })), m = ct("validation"), y = _(() => e.name ?? Ae(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = _(() => a?.transform ? Ae(t).map((s) => [s, a.transform(s)]) : Ae(t));
  at(() => {
    const s = typeof n == "function" ? n() : Ae(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = mC(o.value, u, {
      customKeyFilter: {
        ...e.customKeyFilter,
        ...Ae(a?.customKeyFilter)
      },
      default: e.customFilter,
      filterKeys: e.filterKeys,
      filterMode: e.filterMode,
      noFilter: e.noFilter
    }), d = Ae(t), f = [], v = /* @__PURE__ */ new Map();
    c.forEach((k) => {
      let {
        index: m,
        matches: y
...
const bP = R({
  ...
  setup(e, t) {
    ...
    } = We(() => e.color), k = _(() => e.max - e.min + 1), m = _(() => e.double ? k.value / 2 : k.value), y = _(() => 360 / m.value), h = _(() => y.value * Math.PI / 180), x = _(() => e.modelValue == null ? e.min : e.modelValue), w = _(() => 0.62), b = _(() => {
      const $ = [];
...
function ze(e) {
  ...
  const a = eS((i, o) => (n = o, {
    ...
    set(r) {
      t.set(Ae(e), kt(r)), t.save_changes();
    }
  })), l = () => {
    a.value = t.get(Ae(e)), n();
  };
  return ht(() => {
    t.on(`change:${e}`, l);
  }), Xo(() => {
...
const lT = {
  __name: "VNavigationDrawer",
  setup(e) {
    const t = ze("children"), n = ze("border"), a = ze("model_value"), l = ze("width"), i = ze("elevation"), o = ze("location"), r = ze("absolute"), s = ze("sticky"), u = ze("rounded"), c = ze("tile"), d = ze("tag"), f = ze("theme"), v = ze("color"), k = ze("name"), m = ze("persistent"), y = ze("scrim"), h = ze("close_delay"), x = ze("open_delay"), w = ze("retain_focus"), b = ze("capture_focus"), S = ze("image"), g = ze("mobile"), I = ze("order"), C = ze("floating"), T = ze("disable_resize_watcher"), P = ze("disable_route_watcher"), F = ze("expand_on_hover"), A = ze("permanent"), B = ze("rail"), D = ze("rail_width"), L = ze("temporary"), W = ze("touchless"), N = ze("mobile_breakpoint");
    return (J, q) => {
      const $ = Nv("v-navigation-drawer", !0);
      return XS(), QS($, {
        border: Ae(n),
        modelValue: Ae(a),
        width: Ae(l),
        ...
        order: Ae(I),
        floating: Ae(C),
        disableResizeWatcher: Ae(T),
        disableRouteWatcher: Ae(P),
        expandOnHover: Ae(F),
        permanent: Ae(A),
        rail: Ae(B),
        railWidth: Ae(D),
        ...
        _: 1
        /* STABLE */
      }, 8, ["border", "modelValue", "width", "elevation", "location", "absolute", "sticky", "rounded", "tile", "tag", "theme", "color", "name", "persistent", "scrim", "closeDelay", "openDelay", "retainFocus", "captureFocus", "image", "mobile", "order", "floating", "disableResizeWatcher", "disableRouteWatcher", "expandOnHover", "permanent", "rail", "railWidth", "temporary", "touchless", "mobileBreakpoint"]);
    };
  }
