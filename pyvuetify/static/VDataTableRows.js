...
function VS(e) {
  ...
  if (W(Bl, d), W(gt, f), W($v, v), W(qo, k), W(Fv, m), W(ku, y), W(wS, C), W(kS, g), W(SS, I), W(At, x), W(Xo, b), W(bS, T), De(P))
    if (P.length) {
...
const Xy = N({
  ...
  setup(e, t) {
    ...
    return te(() => {
      const [x, w] = Fn(n), b = Pt.filterProps(e), S = ka.filterProps(e);
      return p(Pt, U({
        ref: d,
        class: ["v-switch", {
...
const lT = {
  __name: "VDataTableRows",
  setup(e) {
    const t = Mt("children"), n = Mt("color"), a = Mt("density"), l = Mt("mobile"), i = Mt("mobile_breakpoint"), o = Mt("items"), r = Mt("loading"), s = Mt("cell_props"), u = Mt("loading_text"), c = Mt("hide_no_data"), d = Mt("no_data_text"), f = Mt("collapse_icon"), v = Mt("expand_icon"), k = Mt("group_collapse_icon"), m = Mt("group_expand_icon"), y = Mt("row_props");
    return (h, x) => {
      const w = Nv("v-data-table-rows", !0);
      return XS(), QS(w, {
        color: He(n),
        density: He(a),
        mobile: He(l),
        mobileBreakpoint: He(i),
        items: He(o),
        loading: He(r),
        cellProps: He(s),
        loadingText: He(u),
        ...
        collapseIcon: He(f),
        expandIcon: He(v),
        groupCollapseIcon: He(k),
        groupExpandIcon: He(m),
        rowProps: He(y)
      }, {
        default: pv(() => [
          Kt(
        ...
        _: 1
        /* STABLE */
      }, 8, ["color", "density", "mobile", "mobileBreakpoint", "items", "loading", "cellProps", "loadingText", "hideNoData", "noDataText", "collapseIcon", "expandIcon", "groupCollapseIcon", "groupExpandIcon", "rowProps"]);
    };
  }
