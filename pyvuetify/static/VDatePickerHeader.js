...
const lT = {
  __name: "VDatePickerHeader",
  setup(e) {
    const t = Gl("children"), n = Gl("color"), a = Gl("append_icon"), l = Gl("header"), i = Gl("transition");
    return (o, r) => {
      const s = Nv("v-date-picker-header", !0);
      return XS(), QS(s, {
        color: it(n),
        appendIcon: it(a),
        header: it(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["color", "appendIcon", "header", "transition"]);
    };
  }
