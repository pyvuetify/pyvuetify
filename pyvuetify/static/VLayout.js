...
const lT = {
  __name: "VLayout",
  setup(e) {
    const t = Nn("children"), n = Nn("height"), a = Nn("max_height"), l = Nn("max_width"), i = Nn("min_height"), o = Nn("min_width"), r = Nn("width"), s = Nn("full_height"), u = Nn("overlaps");
    return (c, d) => {
      const f = Nv("v-layout", !0);
      return XS(), QS(f, {
        height: Ze(n),
        maxHeight: Ze(a),
        maxWidth: Ze(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "fullHeight", "overlaps"]);
    };
  }
