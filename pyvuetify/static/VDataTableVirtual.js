...
const lT = {
  __name: "VDataTableVirtual",
  setup(e) {
    const t = Pe("children"), n = Pe("search"), a = Pe("tag"), l = Pe("height"), i = Pe("width"), o = Pe("model_value"), r = Pe("color"), s = Pe("density"), u = Pe("theme"), c = Pe("sticky"), d = Pe("mobile"), f = Pe("mobile_breakpoint"), v = Pe("items"), k = Pe("loading"), m = Pe("hover"), y = Pe("value_comparator"), h = Pe("item_value"), x = Pe("item_selectable"), w = Pe("return_object"), b = Pe("show_select"), S = Pe("select_strategy"), g = Pe("initial_sort_order"), I = Pe("sort_by"), C = Pe("multi_sort"), T = Pe("must_sort"), P = Pe("custom_key_sort"), F = Pe("expand_on_click"), A = Pe("show_expand"), B = Pe("expanded"), D = Pe("group_by"), L = Pe("filter_mode"), W = Pe("no_filter"), N = Pe("custom_filter"), J = Pe("custom_key_filter"), q = Pe("filter_keys"), O = Pe("header_props"), ne = Pe("cell_props"), K = Pe("disable_sort"), H = Pe("headers"), G = Pe("loading_text"), X = Pe("hide_no_data"), fe = Pe("no_data_text"), Z = Pe("collapse_icon"), ce = Pe("expand_icon"), Ce = Pe("group_collapse_icon"), _e = Pe("group_expand_icon"), Ie = Pe("row_props"), M = Pe("hide_default_body"), $ = Pe("hide_default_header"), j = Pe("fixed_header"), re = Pe("sort_asc_icon"), z = Pe("sort_desc_icon"), oe = Pe("fixed_footer"), me = Pe("striped"), Y = Pe("item_height"), le = Pe("item_key");
    return (ie, ge) => {
      const he = Nv("v-data-table-virtual", !0);
      return XS(), QS(he, {
        search: xe(n),
        tag: xe(a),
        height: xe(l),
        ...
        sticky: xe(c),
        mobile: xe(d),
        mobileBreakpoint: xe(f),
        items: xe(v),
        loading: xe(k),
        hover: xe(m),
        valueComparator: xe(y),
        itemValue: xe(h),
        itemSelectable: xe(x),
        returnObject: xe(w),
        showSelect: xe(b),
        selectStrategy: xe(S),
        initialSortOrder: xe(g),
        sortBy: xe(I),
        multiSort: xe(C),
        mustSort: xe(T),
        customKeySort: xe(P),
        ...
        collapseIcon: xe(Z),
        expandIcon: xe(ce),
        groupCollapseIcon: xe(Ce),
        groupExpandIcon: xe(_e),
        rowProps: xe(Ie),
        hideDefaultBody: xe(M),
        hideDefaultHeader: xe($),
        fixedHeader: xe(j),
        sortAscIcon: xe(re),
        sortDescIcon: xe(z),
        fixedFooter: xe(oe),
        ...
        _: 1
        /* STABLE */
      }, 8, ["search", "tag", "height", "width", "modelValue", "color", "density", "theme", "sticky", "mobile", "mobileBreakpoint", "items", "loading", "hover", "valueComparator", "itemValue", "itemSelectable", "returnObject", "showSelect", "selectStrategy", "initialSortOrder", "sortBy", "multiSort", "mustSort", "customKeySort", "expandOnClick", "showExpand", "expanded", "groupBy", "filterMode", "noFilter", "customFilter", "customKeyFilter", "filterKeys", "headerProps", "cellProps", "disableSort", "headers", "loadingText", "hideNoData", "noDataText", "collapseIcon", "expandIcon", "groupCollapseIcon", "groupExpandIcon", "rowProps", "hideDefaultBody", "hideDefaultHeader", "fixedHeader", "sortAscIcon", "sortDescIcon", "fixedFooter", "striped", "itemHeight", "itemKey"]);
    };
  }
