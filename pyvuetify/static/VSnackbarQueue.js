...
function Qm(e) {
  const t = $e(ki, null), n = V(() => t ? t.rootZIndex.value - 100 : lf), a = /* @__PURE__ */ ae([]), l = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), i = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), o = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), r = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), s = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), {
    resizeRef: u,
    contentRect: c
  } = dn(), d = V(() => {
...
const Xu = (e) => {
  ...
  const a = $e(Tl, Ng), l = /* @__PURE__ */ Symbol("nested item"), i = V(() => {
...
const Xy = R({
  ...
  setup(e, t) {
    ...
    const a = $e(Dc, null), l = ke(e, "modelValue"), i = V({
      get() {
  ...
  setup(e, t) {
    ...
    const a = $e(Ec, null), l = ke(e, "modelValue"), i = V({
      get() {
        return l.value != null || !a ? l.value : a.items.value.find((o) => a.selected.value.includes(o.id))?.value;
      },
      set(o) {
...
const lT = {
  __name: "VSnackbarQueue",
  setup(e) {
    const t = Le("children"), n = Le("text"), a = Le("closable"), l = Le("model_value"), i = Le("height"), o = Le("max_height"), r = Le("max_width"), s = Le("min_height"), u = Le("min_width"), c = Le("width"), d = Le("location"), f = Le("position"), v = Le("absolute"), k = Le("rounded"), m = Le("tile"), y = Le("theme"), h = Le("color"), x = Le("variant"), w = Le("disabled"), b = Le("eager"), S = Le("activator"), g = Le("close_on_back"), I = Le("contained"), C = Le("content_class"), T = Le("content_props"), P = Le("opacity"), F = Le("z_index"), A = Le("target"), B = Le("activator_props"), D = Le("open_on_click"), L = Le("open_on_hover"), W = Le("open_on_focus"), N = Le("close_on_content_click"), J = Le("close_delay"), q = Le("open_delay"), O = Le("location_strategy"), ne = Le("origin"), K = Le("offset"), H = Le("transition"), G = Le("attach"), X = Le("close_text"), fe = Le("vertical"), Z = Le("multi_line"), ce = Le("timer"), xe = Le("timeout");
    return (Ce, Ie) => {
      const M = Nv("v-snackbar-queue", !0);
      return XS(), QS(M, {
        text: _e(n),
        closable: _e(a),
        modelValue: _e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["text", "closable", "modelValue", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "location", "position", "absolute", "rounded", "tile", "theme", "color", "variant", "disabled", "eager", "activator", "closeOnBack", "contained", "contentClass", "contentProps", "opacity", "zIndex", "target", "activatorProps", "openOnClick", "openOnHover", "openOnFocus", "closeOnContentClick", "closeDelay", "openDelay", "locationStrategy", "origin", "offset", "transition", "attach", "closeText", "vertical", "multiLine", "timer", "timeout"]);
    };
  }
