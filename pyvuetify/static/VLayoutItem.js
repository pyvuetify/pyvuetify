...
const lT = {
  __name: "VLayoutItem",
  setup(e) {
    const t = Ta("children"), n = Ta("name"), a = Ta("size"), l = Ta("model_value"), i = Ta("absolute"), o = Ta("order"), r = Ta("position");
    return (s, u) => {
      const c = Nv("v-layout-item", !0);
      return XS(), QS(c, {
        name: nt(n),
        size: nt(a),
        modelValue: nt(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["name", "size", "modelValue", "absolute", "order", "position"]);
    };
  }
