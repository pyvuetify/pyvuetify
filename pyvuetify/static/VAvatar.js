...
const lT = {
  __name: "VAvatar",
  setup(e) {
    const t = Nt("children"), n = Nt("tag"), a = Nt("size"), l = Nt("image"), i = Nt("start"), o = Nt("end"), r = Nt("color"), s = Nt("density"), u = Nt("border"), c = Nt("rounded"), d = Nt("tile"), f = Nt("theme"), v = Nt("text"), k = Nt("icon"), m = Nt("variant");
    return (y, h) => {
      const x = Nv("v-avatar", !0);
      return XS(), QS(x, {
        tag: We(n),
        size: We(a),
        image: We(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "size", "image", "start", "end", "color", "density", "border", "rounded", "tile", "theme", "text", "icon", "variant"]);
    };
  }
