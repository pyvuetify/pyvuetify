...
const lT = {
  __name: "VTreeviewItem",
  setup(e) {
    const t = Oe("children"), n = Oe("title"), a = Oe("replace"), l = Oe("link"), i = Oe("border"), o = Oe("density"), r = Oe("height"), s = Oe("max_height"), u = Oe("max_width"), c = Oe("min_height"), d = Oe("min_width"), f = Oe("width"), v = Oe("elevation"), k = Oe("rounded"), m = Oe("tile"), y = Oe("tag"), h = Oe("theme"), x = Oe("color"), w = Oe("variant"), b = Oe("disabled"), S = Oe("value"), g = Oe("active"), I = Oe("active_color"), C = Oe("base_color"), T = Oe("prepend_icon"), P = Oe("append_icon"), F = Oe("slim"), A = Oe("ripple"), B = Oe("loading"), D = Oe("href"), L = Oe("exact"), W = Oe("to"), N = Oe("subtitle"), J = Oe("active_class"), q = Oe("lines"), $ = Oe("prepend_gap"), ne = Oe("nav"), K = Oe("hide_actions"), H = Oe("append_avatar"), G = Oe("prepend_avatar"), X = Oe("has_custom_prepend"), fe = Oe("toggle_icon"), Z = Oe("indent_lines");
    return (ce, xe) => {
      const Ce = Nv("v-treeview-item", !0);
      return XS(), QS(Ce, {
        title: Ve(n),
        replace: Ve(a),
        link: Ve(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "replace", "link", "border", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "value", "active", "activeColor", "baseColor", "prependIcon", "appendIcon", "slim", "ripple", "loading", "href", "exact", "to", "subtitle", "activeClass", "lines", "prependGap", "nav", "hideActions", "appendAvatar", "prependAvatar", "hasCustomPrepend", "toggleIcon", "indentLines"]);
    };
  }
