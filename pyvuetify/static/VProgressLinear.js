...
function lt(e, t) {
  const n = Bu(), a = /* @__PURE__ */ ae(e), l = _(() => {
    ...
    const o = Fe(t?.scoped), r = Fe(t?.reset), s = Fe(t?.root);
...
function Ca(e, t) {
  ...
  function o(f, v) {
    ...
    Fe(k.value) === void 0 && (k.value = h, k.useIndexAsValue = !0), h > -1 ? a.splice(h, 0, k) : a.push(k);
  }
  function r(f) {
    if (n) return;
    s();
...
function Tg(e) {
  ...
  })), m = ct("validation"), y = _(() => e.name ?? Fe(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = _(() => a?.transform ? Fe(t).map((s) => [s, a.transform(s)]) : Fe(t));
  at(() => {
    const s = typeof n == "function" ? n() : Fe(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = mC(o.value, u, {
      customKeyFilter: {
        ...e.customKeyFilter,
...
function Je(e) {
  ...
  const a = eS((i, o) => (n = o, {
    ...
    set(r) {
      t.set(Fe(e), kt(r)), t.save_changes();
    }
  })), l = () => {
    a.value = t.get(Fe(e)), n();
  };
  return ht(() => {
    t.on(`change:${e}`, l);
  }), Xo(() => {
...
const lT = {
  __name: "VProgressLinear",
  setup(e) {
    const t = Je("children"), n = Je("model_value"), a = Je("reverse"), l = Je("height"), i = Je("location"), o = Je("absolute"), r = Je("rounded"), s = Je("tile"), u = Je("tag"), c = Je("theme"), d = Je("color"), f = Je("indeterminate"), v = Je("max"), k = Je("active"), m = Je("bg_color"), y = Je("opacity"), h = Je("stream"), x = Je("bg_opacity"), w = Je("buffer_value"), b = Je("buffer_color"), S = Je("buffer_opacity"), g = Je("clickable"), I = Je("striped"), C = Je("rounded_bar"), T = Je("chunk_count"), P = Je("chunk_width"), F = Je("chunk_gap");
    return (A, B) => {
      const D = Nv("v-progress-linear", !0);
      return XS(), QS(D, {
        modelValue: Fe(n),
        reverse: Fe(a),
        height: Fe(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["modelValue", "reverse", "height", "location", "absolute", "rounded", "tile", "tag", "theme", "color", "indeterminate", "max", "active", "bgColor", "opacity", "stream", "bgOpacity", "bufferValue", "bufferColor", "bufferOpacity", "clickable", "striped", "roundedBar", "chunkCount", "chunkWidth", "chunkGap"]);
    };
  }
