...
const lT = {
  __name: "VLazy",
  setup(e) {
    const t = fn("children"), n = fn("model_value"), a = fn("height"), l = fn("max_height"), i = fn("max_width"), o = fn("min_height"), r = fn("min_width"), s = fn("width"), u = fn("tag"), c = fn("transition"), d = fn("options");
    return (f, v) => {
      const k = Nv("v-lazy", !0);
      return XS(), QS(k, {
        modelValue: Ke(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["modelValue", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "tag", "transition", "options"]);
    };
  }
