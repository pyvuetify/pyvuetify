...
const lT = {
  __name: "VAppBar",
  setup(e) {
    const t = et("children"), n = et("flat"), a = et("tag"), l = et("name"), i = et("title"), o = et("height"), r = et("image"), s = et("collapse"), u = et("model_value"), c = et("location"), d = et("absolute"), f = et("collapse_position"), v = et("color"), k = et("density"), m = et("extended"), y = et("extension_height"), h = et("floating"), x = et("border"), w = et("elevation"), b = et("rounded"), S = et("tile"), g = et("theme"), I = et("order"), C = et("scroll_target"), T = et("scroll_threshold"), P = et("scroll_behavior");
    return (F, A) => {
      const B = Nv("v-app-bar", !0);
      return XS(), QS(B, {
        flat: $e(n),
        tag: $e(a),
        name: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["flat", "tag", "name", "title", "height", "image", "collapse", "modelValue", "location", "absolute", "collapsePosition", "color", "density", "extended", "extensionHeight", "floating", "border", "elevation", "rounded", "tile", "theme", "order", "scrollTarget", "scrollThreshold", "scrollBehavior"]);
    };
  }
