...
const lT = {
  __name: "VScrollXTransition",
  setup(e) {
    const t = Ta("children"), n = Ta("mode"), a = Ta("disabled"), l = Ta("group"), i = Ta("origin"), o = Ta("hide_on_leave"), r = Ta("leave_absolute");
    return (s, u) => {
      const c = Nv("v-scroll-x-transition", !0);
      return XS(), QS(c, {
        mode: nt(n),
        disabled: nt(a),
        group: nt(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["mode", "disabled", "group", "origin", "hideOnLeave", "leaveAbsolute"]);
    };
  }
