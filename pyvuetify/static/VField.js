...
const lT = {
  __name: "VField",
  setup(e) {
    const t = Ue("children"), n = Ue("flat"), a = Ue("model_value"), l = Ue("error"), i = Ue("reverse"), o = Ue("rounded"), r = Ue("tile"), s = Ue("theme"), u = Ue("color"), c = Ue("variant"), d = Ue("disabled"), f = Ue("id"), v = Ue("active"), k = Ue("base_color"), m = Ue("loading"), y = Ue("details"), h = Ue("label"), x = Ue("bg_color"), w = Ue("center_affix"), b = Ue("glow"), S = Ue("icon_color"), g = Ue("focused"), I = Ue("append_inner_icon"), C = Ue("clearable"), T = Ue("clear_icon"), P = Ue("dirty"), F = Ue("persistent_clear"), A = Ue("prepend_inner_icon"), B = Ue("single_line"), D = Ue("label_id");
    return (L, W) => {
      const N = Nv("v-field", !0);
      return XS(), QS(N, {
        flat: De(n),
        modelValue: De(a),
        error: De(l),
        ...
        iconColor: De(S),
        focused: De(g),
        appendInnerIcon: De(I),
        clearable: De(C),
        clearIcon: De(T),
        dirty: De(P),
        persistentClear: De(F),
        prependInnerIcon: De(A),
        singleLine: De(B),
        labelId: De(D)
      }, {
        default: pv(() => [
        ...
        _: 1
        /* STABLE */
      }, 8, ["flat", "modelValue", "error", "reverse", "rounded", "tile", "theme", "color", "variant", "disabled", "id", "active", "baseColor", "loading", "details", "label", "bgColor", "centerAffix", "glow", "iconColor", "focused", "appendInnerIcon", "clearable", "clearIcon", "dirty", "persistentClear", "prependInnerIcon", "singleLine", "labelId"]);
    };
  }
