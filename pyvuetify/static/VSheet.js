...
const lT = {
  __name: "VSheet",
  setup(e) {
    const t = Mt("children"), n = Mt("border"), a = Mt("height"), l = Mt("max_height"), i = Mt("max_width"), o = Mt("min_height"), r = Mt("min_width"), s = Mt("width"), u = Mt("elevation"), c = Mt("location"), d = Mt("position"), f = Mt("rounded"), v = Mt("tile"), k = Mt("tag"), m = Mt("theme"), y = Mt("color");
    return (h, x) => {
      const w = Nv("v-sheet", !0);
      return XS(), QS(w, {
        border: He(n),
        height: He(a),
        maxHeight: He(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["border", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "location", "position", "rounded", "tile", "tag", "theme", "color"]);
    };
  }
