...
const lT = {
  __name: "VRating",
  setup(e) {
    const t = mt("children"), n = mt("length"), a = mt("tag"), l = mt("name"), i = mt("disabled"), o = mt("size"), r = mt("model_value"), s = mt("color"), u = mt("density"), c = mt("theme"), d = mt("active_color"), f = mt("readonly"), v = mt("ripple"), k = mt("hover"), m = mt("clearable"), y = mt("item_aria_label"), h = mt("empty_icon"), x = mt("full_icon"), w = mt("half_increments"), b = mt("item_label_position"), S = mt("item_labels");
    return (g, I) => {
      const C = Nv("v-rating", !0);
      return XS(), QS(C, {
        length: Oe(n),
        tag: Oe(a),
        name: Oe(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["length", "tag", "name", "disabled", "size", "modelValue", "color", "density", "theme", "activeColor", "readonly", "ripple", "hover", "clearable", "itemAriaLabel", "emptyIcon", "fullIcon", "halfIncrements", "itemLabelPosition", "itemLabels"]);
    };
  }
