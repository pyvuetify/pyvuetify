...
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), su = (e) => e.startsWith("onUpdate:"), wt = Object.assign, uu = (e, t) => {
  const n = e.indexOf(t);
  n > -1 && e.splice(n, 1);
}, Sb = Object.prototype.hasOwnProperty, Ke = (e, t) => Sb.call(e, t), Ee = Array.isArray, Sl = (e) => Ho(e) === "[object Map]", zf = (e) => Ho(e) === "[object Set]", Fe = (e) => typeof e == "function", ut = (e) => typeof e == "string", xa = (e) => typeof e == "symbol", nt = (e) => e !== null && typeof e == "object", jf = (e) => (nt(e) || Fe(e)) && Fe(e.then) && Fe(e.catch), Yf = Object.prototype.toString, Ho = (e) => Yf.call(e), kb = (e) => Ho(e).slice(8, -1), Uf = (e) => Ho(e) === "[object Object]", Wo = (e) => ut(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, Jl = /* @__PURE__ */ ru(
...
const qf = (e) => !!(e && e.__v_isRef === !0), Tn = (e) => ut(e) ? e : e == null ? "" : Ee(e) || nt(e) && (e.toString === Yf || !Fe(e.toString)) ? qf(e) ? Tn(e.value) : JSON.stringify(e, Xf, 2) : String(e), Xf = (e, t) => qf(t) ? Xf(e, t.value) : Sl(t) ? {
...
// @__NO_SIDE_EFFECTS__
function E(e, t, n) {
  return /* @__PURE__ */ st(e) ? e : Fe(e) ? new nS(e) : nt(e) && arguments.length > 1 ? hv(e, t, n) : /* @__PURE__ */ ae(e);
}
function hv(e, t, n) {
  return new tS(e, t, n);
}
...
function lS(e, t, n = !1) {
  let a, l;
  return Fe(e) ? a = e : (a = e.get, l = e.set), new aS(a, l, n);
}
...
function Oe(e, t, n = !1) {
  ...
  if (a || wl) {
    ...
    if (arguments.length > 1)
      return n && Fe(t) ? t.call(a && a.proxy) : t;
  }
}
const cS = /* @__PURE__ */ Symbol.for("v-scx"), dS = () => Oe(cS);
function at(e, t) {
  return bu(e, null, t);
}
function ue(e, t, n) {
...
function VS(e) {
  ...
  if (ss = !0, i)
    for (const N in i) {
      const J = i[N], q = Fe(J) ? J.bind(n, n) : Fe(J.get) ? J.get.bind(n, n) : Pn, $ = !Fe(J) && Fe(J.set) ? J.set.bind(n) : Pn, ne = _({
        get: q,
        set: $
      });
...
function DS(e, t) {
  return function(a, l = null) {
    Fe(a) || (a = wt({}, a)), l != null && !nt(l) && (l = null);
    ...
    const u = i.app = {
      ...
      use(c, ...d) {
        return o.has(c) || (c && Fe(c.install) ? (o.add(c), c.install(u, ...d)) : Fe(c) && (o.add(c), c(u, ...d))), u;
      },
      mixin(c) {
...
function cs(e, t, n, a, l, i) {
  ...
  if (o != null) {
    ...
    if (r && a === void 0) {
      const s = o.default;
      if (o.type !== Function && !o.skipFactory && Fe(s)) {
...
function qv(e, t, n = !1) {
  ...
  if (Ee(i))
    ...
    for (const c in i) {
      const d = zt(c);
      if (Jc(d)) {
        const f = i[c], v = o[d] = Ee(f) || Fe(f) ? { type: f } : wt({}, f), k = v.type;
        let m = !1, y = !0;
        if (Ee(k))
          for (let h = 0; h < k.length; ++h) {
            const x = k[h], w = Fe(x) && x.name;
            if (w === "Boolean") {
              m = !0;
              break;
            } else w === "String" && (y = !1);
...
function US(e, t) {
  ...
  const {
    ...
    if (le = M.el = o(
      ...
      for (const Le in ge)
        Le !== "value" && !Jl(Le) && i(le, Le, null, ge[Le], oe, re);
    ...
    if (j && _a(j, !1), (we = Se.onVnodeBeforeUpdate) && Cn(we, j, O, M), ge && Va(O, M, j, "beforeUpdate"), j && _a(j, !0), (ye.innerHTML && Se.innerHTML == null || ye.textContent && Se.textContent == null) && c(Y, ""), ie ? P(
      ...
      if (le & 16)
        ...
        for (let Le = 0; Le < De.length; Le++) {
          const Re = De[Le], St = ye[Re], Je = Se[Re];
    ...
    const Y = () => {
      if (M.isMounted) {
        let { next: ye, bu: Se, u: we, parent: De, vnode: Le } = M;
        {
          const pn = Qv(M);
          if (pn) {
            ye && (ye.el = Le.el, N(M, ye, me)), pn.asyncDep.then(() => {
              M.isUnmounted || Y();
            });
            return;
          }
        ...
        let Re = ye, St;
        _a(M, !1), ye ? (ye.el = Le.el, N(M, ye, me)) : ye = Le, Se && uo(Se), (St = ye.props && ye.props.onVnodeBeforeUpdate) && Cn(St, De, ye, Le), _a(M, !0);
        ...
        let ye;
        const { el: Se, props: we } = O, { bm: De, m: Le, parent: Re, root: St, type: Je } = M, rn = ai(O);
        ...
        if (Le && Ht(Le, z), !rn && (ye = we && we.onVnodeMounted)) {
          const pn = O;
          Ht(
            () => Cn(ye, Re, pn),
            z
    ...
    if (ie > ye) {
      ...
      const we = ie, De = ie, Le = /* @__PURE__ */ new Map();
      for (ie = De; ie <= Se; ie++) {
        const Gt = O[ie] = le ? da(O[ie]) : In(O[ie]);
        Gt.key != null && Le.set(Gt.key, ie);
      }
      let Re, St = 0;
      const Je = Se - De + 1;
      let rn = !1, pn = 0;
    ...
    const De = ge & 1 && Se, Le = !ai(M);
    let Re;
    if (Le && (Re = me && me.onVnodeBeforeUnmount) && Cn(Re, O, M), ge & 6)
      X(M.component, j, re);
    else {
      if (ge & 128) {
    ...
    (Le && (Re = me && me.onVnodeUnmounted) || De) && Ht(() => {
...
const nm = ({ key: e }) => e ?? null, fo = ({
  ...
  ref_key: t,
  ref_for: n
}) => (typeof e == "number" && (e = "" + e), e != null ? ut(e) || /* @__PURE__ */ st(e) || Fe(e) ? { i: Xt, r: e, k: t, f: !!n } : e : null);
...
function ek(e, t = null, n = null, a = 0, l = null, i = !1) {
  ...
  const o = ut(e) ? 1 : tm(e) ? 128 : Vv(e) ? 64 : nt(e) ? 4 : Fe(e) ? 2 : 0;
  return V(
    e,
    t,
    n,
...
function Cu(e, t) {
  ...
  else Fe(t) ? (t = { default: t, _ctx: Xt }, n = 32) : (t = String(t), a & 64 ? (n = 16, t = [Kt(t)]) : n = 8);
...
function td(e, t, n) {
  Fe(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : nt(t) && (e.setupState = gv(t)), im(e);
}
function im(e, t, n) {
  const a = e.type;
...
function Ak(e, t, n, a) {
  if (a)
    return !!(t === "innerHTML" || t === "textContent" || t in e && hd(t) && Fe(n));
...
function Qm(e) {
  const t = Oe(ki, null), n = _(() => t ? t.rootZIndex.value - 100 : lf), a = /* @__PURE__ */ ae([]), l = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), i = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), o = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), r = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), s = /* @__PURE__ */ pt(/* @__PURE__ */ new Map()), {
    resizeRef: u,
    contentRect: c
  } = dn(), d = _(() => {
...
const Xu = (e) => {
  ...
  const a = Oe(Tl, Ng), l = /* @__PURE__ */ Symbol("nested item"), i = _(() => {
  ...
  setup(e, t) {
    ...
    const {
      ...
      isBooted: s
    } = al(), u = Oe(Tl), c = /* @__PURE__ */ E(() => u?.root?.itemsRegistration.value === "render");
    function d(m) {
...
const Ki = R({
  ...
  setup(e, t) {
    ...
    const a = ke(e, "modelValue"), {
      ...
      isRtl: i
    } = mt(), o = At(), r = /* @__PURE__ */ E(() => e.id || `v-menu-${o}`), s = /* @__PURE__ */ ae(), u = Oe(Ms, null), c = /* @__PURE__ */ se(/* @__PURE__ */ new Set());
    Xe(Ms, {
      register() {
        c.value.add(o);
      },
      ...
      return p(Mn, U({
        ...
        default: (Y) => {
          ...
          return V(he, null, [p(Dl, U({
            ...
            function ye(Le) {
              Le.stopPropagation(), Le.preventDefault(), re(ie, !1);
            }
            const Se = U(Jn.filterProps(ie.props), {
              "onClick:close": ye,
              onKeydown(Le) {
                Le.key !== "Enter" && Le.key !== " " || (Le.preventDefault(), Le.stopPropagation(), ye(Le));
              },
              onMousedown(Le) {
...
const yl = {
  ...
  setup(e, t) {
    ...
    return te(() => V("div", {
      ...
      style: ve(e.style)
    }, [i.value?.map((o) => p(JV, o, null)), l.value.length > 1 && p($e, {
      icon: "$unfold",
      size: "x-small",
      variant: "plain",
      ...
      return p(Mn, U({
        ...
        default: (ge) => {
          ...
          return V(he, null, [p(Dl, U({
            ...
            const Le = U(Jn.filterProps(Se.props), {
              "onClick:close": De,
              onKeydown(Je) {
...
const Ky = R({
  ...
  setup(e, t) {
    ...
    const a = ke(e, "modelValue"), {
      ...
      roundedClasses: c
    } = et(e), d = qI(() => Number(e.timeout)), f = /* @__PURE__ */ ae(), v = /* @__PURE__ */ ae(), k = /* @__PURE__ */ se(!1), m = /* @__PURE__ */ se(0), y = /* @__PURE__ */ ae(), h = Oe(ki, void 0);
    Pt(() => !!h, () => {
      const F = Jm();
      at(() => {
...
const Xy = R({
  ...
  setup(e, t) {
    ...
    const a = Oe(Dc, null), l = ke(e, "modelValue"), i = _({
      get() {
  ...
  setup(e, t) {
    ...
    const a = Oe(Ec, null), l = ke(e, "modelValue"), i = _({
      get() {
        return l.value != null || !a ? l.value : a.items.value.find((o) => a.selected.value.includes(o.id))?.value;
      },
      set(o) {
...
const lT = {
  __name: "VSwitch",
  setup(e) {
    const t = Be("children"), n = Be("flat"), a = Be("type"), l = Be("model_value"), i = Be("error"), o = Be("density"), r = Be("max_width"), s = Be("min_width"), u = Be("width"), c = Be("theme"), d = Be("color"), f = Be("name"), v = Be("disabled"), k = Be("indeterminate"), m = Be("multiple"), y = Be("value"), h = Be("id"), x = Be("base_color"), w = Be("prepend_icon"), b = Be("append_icon"), S = Be("readonly"), g = Be("ripple"), I = Be("loading"), C = Be("label"), T = Be("value_comparator"), P = Be("center_affix"), F = Be("glow"), A = Be("icon_color"), B = Be("hide_spin_buttons"), D = Be("hint"), L = Be("persistent_hint"), W = Be("messages"), N = Be("direction"), J = Be("error_messages"), q = Be("max_errors"), $ = Be("rules"), ne = Be("validate_on"), K = Be("validation_value"), H = Be("focused"), G = Be("hide_details"), X = Be("inset"), fe = Be("inline"), Z = Be("true_value"), ce = Be("false_value"), xe = Be("defaults_target"), Ce = Be("false_icon"), Ie = Be("true_icon");
    return (M, O) => {
      const j = Nv("v-switch", !0);
      return XS(), QS(j, {
        flat: Ve(n),
        type: Ve(a),
        modelValue: Ve(l),
        ...
        loading: Ve(I),
        label: Ve(C),
        valueComparator: Ve(T),
        centerAffix: Ve(P),
        glow: Ve(F),
        iconColor: Ve(A),
        hideSpinButtons: Ve(B),
        hint: Ve(D),
        persistentHint: Ve(L),
        messages: Ve(W),
        direction: Ve(N),
        ...
        _: 1
        /* STABLE */
      }, 8, ["flat", "type", "modelValue", "error", "density", "maxWidth", "minWidth", "width", "theme", "color", "name", "disabled", "indeterminate", "multiple", "value", "id", "baseColor", "prependIcon", "appendIcon", "readonly", "ripple", "loading", "label", "valueComparator", "centerAffix", "glow", "iconColor", "hideSpinButtons", "hint", "persistentHint", "messages", "direction", "errorMessages", "maxErrors", "rules", "validateOn", "validationValue", "focused", "hideDetails", "inset", "inline", "trueValue", "falseValue", "defaultsTarget", "falseIcon", "trueIcon"]);
    };
  }
