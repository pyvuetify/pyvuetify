...
const lT = {
  __name: "VTimePicker",
  setup(e) {
    const t = He("children"), n = He("title"), a = He("border"), l = He("model_value"), i = He("density"), o = He("height"), r = He("max_height"), s = He("max_width"), u = He("min_height"), c = He("min_width"), d = He("width"), f = He("elevation"), v = He("location"), k = He("position"), m = He("rounded"), y = He("tile"), h = He("tag"), x = He("theme"), w = He("color"), b = He("variant"), S = He("disabled"), g = He("max"), I = He("min"), C = He("readonly"), T = He("bg_color"), P = He("divided"), F = He("hide_header"), A = He("hide_title"), B = He("view_mode"), D = He("scrollable"), L = He("format"), W = He("period"), N = He("use_seconds"), J = He("allowed_hours"), q = He("allowed_minutes"), $ = He("allowed_seconds");
    return (ne, K) => {
      const H = Nv("v-time-picker", !0);
      return XS(), QS(H, {
        title: Ie(n),
        border: Ie(a),
        modelValue: Ie(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "border", "modelValue", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "location", "position", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "max", "min", "readonly", "bgColor", "divided", "hideHeader", "hideTitle", "viewMode", "scrollable", "format", "period", "useSeconds", "allowedHours", "allowedMinutes", "allowedSeconds"]);
    };
  }
