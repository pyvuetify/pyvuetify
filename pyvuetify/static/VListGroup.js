...
const lT = {
  __name: "VListGroup",
  setup(e) {
    const t = Nt("children"), n = Nt("tag"), a = Nt("title"), l = Nt("disabled"), i = Nt("value"), o = Nt("color"), r = Nt("base_color"), s = Nt("active_color"), u = Nt("prepend_icon"), c = Nt("append_icon"), d = Nt("fluid"), f = Nt("collapse_icon"), v = Nt("expand_icon"), k = Nt("raw_id"), m = Nt("subgroup");
    return (y, h) => {
      const x = Nv("v-list-group", !0);
      return XS(), QS(x, {
        tag: We(n),
        title: We(a),
        disabled: We(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "title", "disabled", "value", "color", "baseColor", "activeColor", "prependIcon", "appendIcon", "fluid", "collapseIcon", "expandIcon", "rawId", "subgroup"]);
    };
  }
