...
const lT = {
  __name: "VSelectionControlGroup",
  setup(e) {
    const t = Ct("children"), n = Ct("type"), a = Ct("model_value"), l = Ct("error"), i = Ct("density"), o = Ct("theme"), r = Ct("color"), s = Ct("name"), u = Ct("disabled"), c = Ct("multiple"), d = Ct("id"), f = Ct("readonly"), v = Ct("ripple"), k = Ct("value_comparator"), m = Ct("inline"), y = Ct("defaults_target"), h = Ct("false_icon"), x = Ct("true_icon");
    return (w, b) => {
      const S = Nv("v-selection-control-group", !0);
      return XS(), QS(S, {
        type: Re(n),
        modelValue: Re(a),
        error: Re(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["type", "modelValue", "error", "density", "theme", "color", "name", "disabled", "multiple", "id", "readonly", "ripple", "valueComparator", "inline", "defaultsTarget", "falseIcon", "trueIcon"]);
    };
  }
