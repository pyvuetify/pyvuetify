...
function US(e, t) {
  ...
  const {
    ...
    const Y = () => {
      if (M.isMounted) {
        ...
        M.subTree = Je, m(
          ...
          z,
          oe
        ), ye.el = Je.el, Ne === null && $S(M, Je.el), we && Ht(we, z), (St = ye.props && ye.props.onVnodeUpdated) && Ht(
          () => Cn(St, De, ye, Fe),
          z
        );
      } else {
        let ye;
        const { el: Se, props: we } = $, { bm: De, m: Fe, parent: Ne, root: St, type: Je } = M, rn = ai($);
        Va(M, !1), De && uo(De), !rn && (ye = we && we.onVnodeBeforeMount) && Cn(ye, Ne, $), Va(M, !0);
        {
    ...
    let Ne;
    if (Fe && (Ne = me && me.onVnodeBeforeUnmount) && Cn(Ne, $, M), ge & 6)
      X(M.component, j, re);
    else {
      if (ge & 128) {
    ...
    (Fe && (Ne = me && me.onVnodeUnmounted) || De) && Ht(() => {
      Ne && Cn(Ne, $, M), De && _a(M, null, $, "unmounted");
    }, j);
  }, H = (M) => {
...
function wm(e, t) {
  ...
  const a = function() {
    for (var l = arguments.length, i = new Array(l), o = 0; o < l; o++)
      i[o] = arguments[o];
    clearTimeout(n), n = setTimeout(() => e(...i), Te(t));
  };
  return a.clear = () => {
    clearTimeout(n);
  }, a.immediate = e, a;
...
function lt(e, t) {
  const n = Bu(), a = /* @__PURE__ */ ae(e), l = V(() => {
    ...
    const o = Te(t?.scoped), r = Te(t?.reset), s = Te(t?.root);
...
const Si = /* @__PURE__ */ Symbol.for("vuetify:theme"), $e = R({
  theme: String
}, "theme");
function nf() {
  return {
...
function Ca(e, t) {
  ...
  function o(f, v) {
    ...
    Te(k.value) === void 0 && (k.value = h, k.useIndexAsValue = !0), h > -1 ? a.splice(h, 0, k) : a.push(k);
  }
  function r(f) {
    if (n) return;
    s();
...
function Tg(e) {
  ...
  })), m = ct("validation"), y = V(() => e.name ?? Te(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
...
const Gu = /* @__PURE__ */ Symbol.for("vuetify:v-slide-group"), qu = R({
  ...
  setup(e, t) {
    ...
    const {
      ...
      themeClasses: d
    } = He(e), f = ke(e, "modelValue"), v = ba(e, Eg, !1), k = ba(e, Gu, !1), m = zi(e, n), y = /* @__PURE__ */ E(() => e.link !== !1 && m.isLink.value), h = V(() => !e.disabled && e.link !== !1 && (!!v || e.link || m.isClickable.value)), x = /* @__PURE__ */ E(() => ({
    ...
    return () => {
      ...
      return f.value && Ge(p(C, U(m.linkProps, {
        ...
        }, l.prepend) : _(he, null, [e.prependIcon && p(Re, {
          key: "prepend-icon",
          icon: e.prependIcon,
          start: !0
        ...
        }, l.append) : _(he, null, [e.appendIcon && p(Re, {
          key: "append-icon",
          end: !0,
          icon: e.appendIcon
...
const Xu = (e) => {
  ...
  setup(e, t) {
    ...
    return te(() => {
      const Z = b.value ? "a" : e.tag, de = a.title || e.title != null, xe = a.subtitle || e.subtitle != null, Ce = !!(e.appendAvatar || e.appendIcon), Ve = !!(Ce || a.append), M = !!(e.prependAvatar || e.prependIcon), $ = !!(M || a.prepend);
    ...
    return ue(C, () => {
      ...
      return p(Mn, U({
        ...
        default: (Ce) => {
          ...
          return _(he, null, [_("select", {
            ...
            default: () => [ve && p(Al, U({
              ...
              "aria-live": "polite",
              "aria-labelledby": `${Ve.value}-label`,
        ...
        "append-inner": function() {
          for (var Ce = arguments.length, Ve = new Array(Ce), M = 0; M < Ce; M++)
            Ve[M] = arguments[M];
          return _(he, null, [n["append-inner"]?.(...Ve), e.menuIcon ? p(Re, {
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = V(() => a?.transform ? Te(t).map((s) => [s, a.transform(s)]) : Te(t));
  at(() => {
    const s = typeof n == "function" ? n() : Te(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = mC(o.value, u, {
      customKeyFilter: {
        ...e.customKeyFilter,
        ...Te(a?.customKeyFilter)
      },
      default: e.customFilter,
      filterKeys: e.filterKeys,
      filterMode: e.filterMode,
      noFilter: e.noFilter
    }), d = Te(t), f = [], v = /* @__PURE__ */ new Map();
    c.forEach((k) => {
      let {
        index: m,
        matches: y
      ...
      return p(Mn, U({
        ...
        "append-inner": function() {
          for (var Y = arguments.length, le = new Array(Y), ie = 0; ie < Y; ie++)
            le[ie] = arguments[ie];
          return _(he, null, [n["append-inner"]?.(...le), e.menuIcon ? p(Re, {
    ...
    const J = t.event, q = c.value(D.input), O = k(D.input), ne = D.start.hour < 12 && D.end.hour >= 12, K = qC(D.start, D.end) <= u.value, H = (de, xe) => a.getFormatter({
      ...
      if (D.start.hasTime)
        if (W) {
          ...
          }, [_("strong", null, [de]), Ce, xe]);
        } else {
          const xe = H(D.start);
          return _("span", {
            class: "v-event-summary"
          }, [_("strong", null, [xe]), Kt(" "), de]);
        }
      return _("span", {
        class: "v-event-summary"
      }, [de]);
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      return p(e.tag, {
        ...
        }, n.append) : _(he, null, [e.appendIcon && p(Re, {
          key: "append-icon",
          density: e.density,
          icon: e.appendIcon
        }, null), e.appendAvatar && p(nn, {
...
const Kh = R({
  ...
  function B(Z) {
    const de = F.value?.$el;
    if (!de) return;
    const xe = t.direction === "vertical", Ce = xe ? "top" : "left", Ve = xe ? "height" : "width", M = xe ? "clientY" : "clientX", {
      [Ce]: $,
      [Ve]: j
    } = de.getBoundingClientRect(), re = tV(Z, M);
  ...
  setup(e, t) {
    ...
    function H(X, ve) {
      ...
      if ([N, J, q, O].includes(X.key)) {
        const Ce = (h.value ? [i.value ? N : J, y.value ? q : O] : g.value !== i.value ? [N, O] : [J, O]).includes(X.key) ? 1 : -1, Ve = X.shiftKey ? 2 : X.ctrlKey ? 1 : 0;
        Ce === -1 && ve === s.value && !Ve && !Number.isInteger(de) ? ve = ve - de % 1 * Z : ve = ve + Ce * Z * K.value[Ve];
      } else if (X.key === W)
        ve = r.value;
      else if (X.key === L)
        ve = s.value;
      ...
      return p(Mn, U({
        ...
        "append-inner": function() {
          for (var ge = arguments.length, ye = new Array(ge), Se = 0; Se < ge; Se++)
            ye[Se] = arguments[Se];
          return _(he, null, [a["append-inner"]?.(...ye), (!e.hideNoData || e.items.length) && e.menuIcon ? p(Re, {
    ...
    const {
      ...
      return p(Ai, U({
        ...
        default: () => {
          ...
          }, [_("span", null, [P.title]), P.sortable && !e.disableSort && p(Re, {
            key: "icon",
...
const Pc = R({
  ...
  setup(e, t) {
    ...
    return te(() => {
      const de = Ti.filterProps(e), xe = qa.filterProps(Me(e, ["multiSort"])), Ce = Xa.filterProps(e), Ve = Za.filterProps(e);
      return p(Za, U({
        class: ["v-data-table", {
        ...
        bottom: () => a.bottom ? a.bottom(Z.value) : !e.hideDefaultFooter && _(he, null, [p(tn, null, null), p(Ti, de, {
  ...
  setup(e, t) {
    ...
    const {
      ...
      scrollToIndex: de
    } = dh(e, T), xe = V(() => H.value.map((Ve) => ({
      ...Ve.raw,
      virtualIndex: Ve.index
    })));
    pr({
      sortBy: o,
      page: /* @__PURE__ */ se(1),
    ...
    return te(() => {
      const Ve = qa.filterProps(Me(e, ["multiSort"])), M = Xa.filterProps(e), $ = Za.filterProps(e);
      return p(Za, U({
        class: ["v-data-table", {
          "v-data-table--loading": e.loading
        }, e.class],
...
`) : G;
    ...
    return ue(r, (G, X) => {
      ...
      const Ce = l.getMonth(xe), Ve = l.getYear(xe);
      Ce !== m.value && (m.value = Ce, K()), Ve !== h.value && (h.value = Ve, H()), x.value = l.isBefore(de, xe);
    }), te(() => {
      ...
      return p(El, U(G, {
        ...
        default: () => _(he, null, [p(Ks, U(X, {
          ...
          default: () => [s.value === "months" ? p(Xs, U({
            ...
            modelValue: m.value,
            "onUpdate:modelValue": [(Ve) => m.value = Ve, K],
            min: u.value,
            max: c.value,
            year: h.value,
            ...
            modelValue: h.value,
            "onUpdate:modelValue": [(Ve) => h.value = Ve, H],
            min: u.value,
            max: c.value,
            ...
            month: m.value,
            "onUpdate:month": [(Ve) => m.value = Ve, K],
            year: h.value,
            "onUpdate:year": [(Ve) => h.value = Ve, H],
            min: u.value,
            max: c.value
          }), {
            day: a.day
...
const J1 = Q()({
  ...
  setup(e, t) {
    ...
    const l = /* @__PURE__ */ ae(), i = /* @__PURE__ */ se("ok"), o = /* @__PURE__ */ se("ok"), r = V(() => ce(e.margin)), s = /* @__PURE__ */ se(!1);
    function u(g) {
      if (!l.value) return;
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      const Ce = w.value === "split" ? _("div", {
        ...
        vertical: !0
      }, null), ve()]) : e.reverse || w.value === "hidden" ? void 0 : _(he, null, [xe(), de()]), Ve = n["append-inner"] || Ce, M = w.value === "split" ? _("div", {
        class: "v-number-input__control"
      }, [Z(), p(tn, {
        vertical: !0
      }, null)]) : e.reverse && w.value !== "hidden" ? _(he, null, [de(), xe()]) : void 0, $ = n["prepend-inner"] || M;
      return p(Mn, U({
        ref: a
      }, X, {
        modelValue: m.value,
...
const BI = R({
  ...
  setup(e, t) {
    ...
    const {
      ...
      themeClasses: l
    } = He(e), i = /* @__PURE__ */ ae(), o = ke(e, "modelValue"), r = V(() => je(parseFloat(o.value), 0, Number(e.length))), s = V(() => Jt(Number(e.length), 1)), u = V(() => s.value.flatMap((b) => e.halfIncrements ? [b - 0.5, b] : [b])), c = /* @__PURE__ */ se(-1), d = V(() => u.value.map((b) => {
  ...
  setup(e, t) {
    ...
    function W(O) {
      ...
      const {
        ...
        x: X - H,
        y: K - ve
      }, xe = Math.round(D(Z, de) - e.rotate + 360) % 360, Ce = e.double && B(Z, de) < (G + G * w.value) / 4, Ve = Math.ceil(15 / y.value);
      let M;
      for (let $ = 0; $ < Ve; $++)
...
function We(e) {
  ...
  const a = eS((i, o) => (n = o, {
    ...
    set(r) {
      t.set(Te(e), kt(r)), t.save_changes();
    }
  })), l = () => {
    a.value = t.get(Te(e)), n();
  };
  return ht(() => {
    t.on(`change:${e}`, l);
  }), Xo(() => {
...
const lT = {
  __name: "VCalendar",
  setup(e) {
    const t = We("children"), n = We("type"), a = We("model_value"), l = We("start"), i = We("end"), o = We("category_days"), r = We("categories"), s = We("category_text"), u = We("max_days"), c = We("category_hide_dynamic"), d = We("category_show_all"), f = We("category_for_invalid"), v = We("weekdays"), k = We("first_day_of_week"), m = We("first_day_of_year"), y = We("weekday_format"), h = We("day_format"), x = We("locale"), w = We("now"), b = We("events"), S = We("event_start"), g = We("event_end"), I = We("event_timed"), C = We("event_category"), T = We("event_height"), P = We("event_color"), F = We("event_text_color"), A = We("event_name"), B = We("event_overlap_threshold"), D = We("event_overlap_mode"), L = We("event_more"), W = We("event_more_text"), N = We("event_ripple"), J = We("event_margin_bottom");
    return (q, O) => {
      const ne = Nv("v-calendar", !0);
      return XS(), QS(ne, {
        type: Te(n),
        modelValue: Te(a),
        start: Te(l),
        ...
        categoryText: Te(s),
        maxDays: Te(u),
        categoryHideDynamic: Te(c),
        categoryShowAll: Te(d),
        categoryForInvalid: Te(f),
        weekdays: Te(v),
        firstDayOfWeek: Te(k),
        firstDayOfYear: Te(m),
        weekdayFormat: Te(y),
        ...
        eventTextColor: Te(F),
        eventName: Te(A),
        eventOverlapThreshold: Te(B),
        eventOverlapMode: Te(D),
        eventMore: Te(L),
        eventMoreText: Te(W),
        eventRipple: Te(N),
        eventMarginBottom: Te(J)
      }, {
        default: pv(() => [
          Kt(
            Tn(Te(t)),
        ...
        _: 1
        /* STABLE */
      }, 8, ["type", "modelValue", "start", "end", "categoryDays", "categories", "categoryText", "maxDays", "categoryHideDynamic", "categoryShowAll", "categoryForInvalid", "weekdays", "firstDayOfWeek", "firstDayOfYear", "weekdayFormat", "dayFormat", "locale", "now", "events", "eventStart", "eventEnd", "eventTimed", "eventCategory", "eventHeight", "eventColor", "eventTextColor", "eventName", "eventOverlapThreshold", "eventOverlapMode", "eventMore", "eventMoreText", "eventRipple", "eventMarginBottom"]);
    };
  }
