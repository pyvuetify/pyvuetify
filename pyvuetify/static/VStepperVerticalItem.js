...
const lT = {
  __name: "VStepperVerticalItem",
  setup(e) {
    const t = We("children"), n = We("title"), a = We("text"), l = We("icon"), i = We("error"), o = We("height"), r = We("max_height"), s = We("max_width"), u = We("min_height"), c = We("min_width"), d = We("width"), f = We("elevation"), v = We("static"), k = We("rounded"), m = We("tile"), y = We("tag"), h = We("color"), x = We("disabled"), w = We("value"), b = We("readonly"), S = We("ripple"), g = We("selected_class"), I = We("eager"), C = We("subtitle"), T = We("bg_color"), P = We("expand_icon"), F = We("collapse_icon"), A = We("rules"), B = We("hide_actions"), D = We("focusable"), L = We("complete_icon"), W = We("edit_icon"), N = We("editable"), J = We("error_icon"), q = We("complete");
    return ($, ne) => {
      const K = Nv("v-stepper-vertical-item", !0);
      return XS(), QS(K, {
        title: Pe(n),
        text: Pe(a),
        icon: Pe(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "text", "icon", "error", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "static", "rounded", "tile", "tag", "color", "disabled", "value", "readonly", "ripple", "selectedClass", "eager", "subtitle", "bgColor", "expandIcon", "collapseIcon", "rules", "hideActions", "focusable", "completeIcon", "editIcon", "editable", "errorIcon", "complete"]);
    };
  }
