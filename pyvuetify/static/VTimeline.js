...
const lT = {
  __name: "VTimeline",
  setup(e) {
    const t = _t("children"), n = _t("tag"), a = _t("align"), l = _t("size"), i = _t("density"), o = _t("theme"), r = _t("direction"), s = _t("icon_color"), u = _t("justify"), c = _t("line_thickness"), d = _t("line_color"), f = _t("dot_color"), v = _t("fill_dot"), k = _t("hide_opposite"), m = _t("line_inset"), y = _t("side"), h = _t("truncate_line");
    return (x, w) => {
      const b = Nv("v-timeline", !0);
      return XS(), QS(b, {
        tag: He(n),
        align: He(a),
        size: He(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "align", "size", "density", "theme", "direction", "iconColor", "justify", "lineThickness", "lineColor", "dotColor", "fillDot", "hideOpposite", "lineInset", "side", "truncateLine"]);
    };
  }
