...
const lT = {
  __name: "VFooter",
  setup(e) {
    const t = Gt("children"), n = Gt("border"), a = Gt("height"), l = Gt("elevation"), i = Gt("absolute"), o = Gt("rounded"), r = Gt("tile"), s = Gt("tag"), u = Gt("theme"), c = Gt("color"), d = Gt("name"), f = Gt("app"), v = Gt("order");
    return (k, m) => {
      const y = Nv("v-footer", !0);
      return XS(), QS(y, {
        border: Ye(n),
        height: Ye(a),
        elevation: Ye(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["border", "height", "elevation", "absolute", "rounded", "tile", "tag", "theme", "color", "name", "app", "order"]);
    };
  }
