...
const lT = {
  __name: "VStepperWindow",
  setup(e) {
    const t = fn("children"), n = fn("model_value"), a = fn("reverse"), l = fn("tag"), i = fn("theme"), o = fn("disabled"), r = fn("selected_class"), s = fn("direction"), u = fn("crossfade"), c = fn("transition_duration"), d = fn("vertical_arrows");
    return (f, v) => {
      const k = Nv("v-stepper-window", !0);
      return XS(), QS(k, {
        modelValue: Ke(n),
        reverse: Ke(a),
        tag: Ke(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["modelValue", "reverse", "tag", "theme", "disabled", "selectedClass", "direction", "crossfade", "transitionDuration", "verticalArrows"]);
    };
  }
