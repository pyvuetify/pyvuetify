...
const lT = {
  __name: "VBtnGroup",
  setup(e) {
    const t = Gt("children"), n = Gt("tag"), a = Gt("color"), l = Gt("density"), i = Gt("border"), o = Gt("elevation"), r = Gt("rounded"), s = Gt("tile"), u = Gt("theme"), c = Gt("variant"), d = Gt("base_color"), f = Gt("divided"), v = Gt("direction");
    return (k, m) => {
      const y = Nv("v-btn-group", !0);
      return XS(), QS(y, {
        tag: Ye(n),
        color: Ye(a),
        density: Ye(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "color", "density", "border", "elevation", "rounded", "tile", "theme", "variant", "baseColor", "divided", "direction"]);
    };
  }
