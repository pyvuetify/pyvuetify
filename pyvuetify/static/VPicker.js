...
const lT = {
  __name: "VPicker",
  setup(e) {
    const t = vt("children"), n = vt("tag"), a = vt("title"), l = vt("height"), i = vt("width"), o = vt("location"), r = vt("color"), s = vt("border"), u = vt("elevation"), c = vt("rounded"), d = vt("tile"), f = vt("theme"), v = vt("max_height"), k = vt("max_width"), m = vt("min_height"), y = vt("min_width"), h = vt("bg_color"), x = vt("position"), w = vt("divided"), b = vt("hide_header"), S = vt("landscape"), g = vt("hide_title");
    return (I, C) => {
      const T = Nv("v-picker", !0);
      return XS(), QS(T, {
        tag: Oe(n),
        title: Oe(a),
        height: Oe(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "title", "height", "width", "location", "color", "border", "elevation", "rounded", "tile", "theme", "maxHeight", "maxWidth", "minHeight", "minWidth", "bgColor", "position", "divided", "hideHeader", "landscape", "hideTitle"]);
    };
  }
