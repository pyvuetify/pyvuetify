...
const lT = {
  __name: "VProgressCircular",
  setup(e) {
    const t = fn("children"), n = fn("tag"), a = fn("indeterminate"), l = fn("size"), i = fn("width"), o = fn("model_value"), r = fn("color"), s = fn("rounded"), u = fn("theme"), c = fn("bg_color"), d = fn("rotate");
    return (f, v) => {
      const k = Nv("v-progress-circular", !0);
      return XS(), QS(k, {
        tag: Ke(n),
        indeterminate: Ke(a),
        size: Ke(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "indeterminate", "size", "width", "modelValue", "color", "rounded", "theme", "bgColor", "rotate"]);
    };
  }
