...
const lT = {
  __name: "VOtpInput",
  setup(e) {
    const t = at("children"), n = at("length"), a = at("type"), l = at("error"), i = at("label"), o = at("disabled"), r = at("height"), s = at("placeholder"), u = at("width"), c = at("autofocus"), d = at("model_value"), f = at("color"), v = at("rounded"), k = at("theme"), m = at("variant"), y = at("max_height"), h = at("max_width"), x = at("min_height"), w = at("min_width"), b = at("bg_color"), S = at("base_color"), g = at("divider"), I = at("loading"), C = at("focused"), T = at("focus_all");
    return (P, F) => {
      const A = Nv("v-otp-input", !0);
      return XS(), QS(A, {
        length: $e(n),
        type: $e(a),
        error: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["length", "type", "error", "label", "disabled", "height", "placeholder", "width", "autofocus", "modelValue", "color", "rounded", "theme", "variant", "maxHeight", "maxWidth", "minHeight", "minWidth", "bgColor", "baseColor", "divider", "loading", "focused", "focusAll"]);
    };
  }
