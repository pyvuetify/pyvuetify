...
const lT = {
  ...
  setup(e) {
    const t = mt("children"), n = mt("icon"), a = mt("density"), l = mt("height"), i = mt("max_height"), o = mt("max_width"), r = mt("min_height"), s = mt("min_width"), u = mt("width"), c = mt("elevation"), d = mt("rounded"), f = mt("tile"), v = mt("tag"), k = mt("size"), m = mt("icon_color"), y = mt("side"), h = mt("dot_color"), x = mt("fill_dot"), w = mt("hide_dot"), b = mt("hide_opposite"), S = mt("line_inset");
    return (g, I) => {
      const C = Nv("v-timeline-item", !0);
      return XS(), QS(C, {
        icon: Oe(n),
        density: Oe(a),
        height: Oe(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["icon", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "rounded", "tile", "tag", "size", "iconColor", "side", "dotColor", "fillDot", "hideDot", "hideOpposite", "lineInset"]);
    };
  }
