...
const lT = {
  __name: "VDataTableHeaders",
  setup(e) {
    const t = jt("children"), n = jt("color"), a = jt("density"), l = jt("sticky"), i = jt("mobile"), o = jt("mobile_breakpoint"), r = jt("loading"), s = jt("initial_sort_order"), u = jt("multi_sort"), c = jt("header_props"), d = jt("disable_sort"), f = jt("fixed_header"), v = jt("sort_asc_icon"), k = jt("sort_desc_icon");
    return (m, y) => {
      const h = Nv("v-data-table-headers", !0);
      return XS(), QS(h, {
        color: Ye(n),
        density: Ye(a),
        sticky: Ye(l),
        mobile: Ye(i),
        mobileBreakpoint: Ye(o),
        loading: Ye(r),
        initialSortOrder: Ye(s),
        multiSort: Ye(u),
        headerProps: Ye(c),
        disableSort: Ye(d),
        fixedHeader: Ye(f),
        ...
        _: 1
        /* STABLE */
      }, 8, ["color", "density", "sticky", "mobile", "mobileBreakpoint", "loading", "initialSortOrder", "multiSort", "headerProps", "disableSort", "fixedHeader", "sortAscIcon", "sortDescIcon"]);
    };
  }
