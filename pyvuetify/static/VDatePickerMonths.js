...
const lT = {
  __name: "VDatePickerMonths",
  setup(e) {
    const t = ra("children"), n = ra("model_value"), a = ra("height"), l = ra("color"), i = ra("max"), o = ra("min"), r = ra("year"), s = ra("allowed_months");
    return (u, c) => {
      const d = Nv("v-date-picker-months", !0);
      return XS(), QS(d, {
        modelValue: et(n),
        height: et(a),
        color: et(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["modelValue", "height", "color", "max", "min", "year", "allowedMonths"]);
    };
  }
