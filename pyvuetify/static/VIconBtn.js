...
const lT = {
  __name: "VIconBtn",
  setup(e) {
    const t = Ge("children"), n = Ge("text"), a = Ge("border"), l = Ge("icon"), i = Ge("height"), o = Ge("width"), r = Ge("elevation"), s = Ge("icon_sizes"), u = Ge("icon_size"), c = Ge("rounded"), d = Ge("tile"), f = Ge("tag"), v = Ge("theme"), k = Ge("color"), m = Ge("variant"), y = Ge("disabled"), h = Ge("size"), x = Ge("active"), w = Ge("active_color"), b = Ge("readonly"), S = Ge("loading"), g = Ge("opacity"), I = Ge("icon_color"), C = Ge("base_variant"), T = Ge("hide_overlay"), P = Ge("rotate"), F = Ge("sizes"), A = Ge("active_icon"), B = Ge("active_variant");
    return (D, L) => {
      const W = Nv("v-icon-btn", !0);
      return XS(), QS(W, {
        text: Me(n),
        border: Me(a),
        icon: Me(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["text", "border", "icon", "height", "width", "elevation", "iconSizes", "iconSize", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "size", "active", "activeColor", "readonly", "loading", "opacity", "iconColor", "baseVariant", "hideOverlay", "rotate", "sizes", "activeIcon", "activeVariant"]);
    };
  }
