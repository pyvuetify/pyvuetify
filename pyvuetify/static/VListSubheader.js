...
const lT = {
  __name: "VListSubheader",
  setup(e) {
    const t = fl("children"), n = fl("title"), a = fl("sticky"), l = fl("tag"), i = fl("color"), o = fl("inset");
    return (r, s) => {
      const u = Nv("v-list-subheader", !0);
      return XS(), QS(u, {
        title: at(n),
        sticky: at(a),
        tag: at(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "sticky", "tag", "color", "inset"]);
    };
  }
