...
const lT = {
  __name: "VExpansionPanels",
  setup(e) {
    const t = lt("children"), n = lt("flat"), a = lt("model_value"), l = lt("elevation"), i = lt("static"), o = lt("rounded"), r = lt("tile"), s = lt("tag"), u = lt("theme"), c = lt("color"), d = lt("variant"), f = lt("disabled"), v = lt("max"), k = lt("multiple"), m = lt("readonly"), y = lt("ripple"), h = lt("selected_class"), x = lt("eager"), w = lt("bg_color"), b = lt("expand_icon"), S = lt("collapse_icon"), g = lt("mandatory"), I = lt("hide_actions"), C = lt("focusable");
    return (T, P) => {
      const F = Nv("v-expansion-panels", !0);
      return XS(), QS(F, {
        flat: $e(n),
        modelValue: $e(a),
        elevation: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["flat", "modelValue", "elevation", "static", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "max", "multiple", "readonly", "ripple", "selectedClass", "eager", "bgColor", "expandIcon", "collapseIcon", "mandatory", "hideActions", "focusable"]);
    };
  }
