...
const lT = {
  __name: "VSkeletonLoader",
  setup(e) {
    const t = jt("children"), n = jt("type"), a = jt("height"), l = jt("max_height"), i = jt("max_width"), o = jt("min_height"), r = jt("min_width"), s = jt("width"), u = jt("elevation"), c = jt("theme"), d = jt("color"), f = jt("loading"), v = jt("boilerplate"), k = jt("loading_text");
    return (m, y) => {
      const h = Nv("v-skeleton-loader", !0);
      return XS(), QS(h, {
        type: Ye(n),
        height: Ye(a),
        maxHeight: Ye(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["type", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "theme", "color", "loading", "boilerplate", "loadingText"]);
    };
  }
