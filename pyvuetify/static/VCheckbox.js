...
function US(e, t) {
  ...
  const {
    ...
    if (M === O)
      return;
    M && !Ea(M, O) && (re = Z(M), K(M, z, oe, !0), M = null), O.patchFlag === -2 && (le = !1, O.dynamicChildren = null);
    ...
    we & 8 ? (ge & 16 && fe(ie, z, oe), ye !== ie && c(j, ye)) : ge & 16 ? we & 16 ? $(
      ie,
      ye,
      j,
      re,
    ...
    if (Fe && (Re = me && me.onVnodeBeforeUnmount) && Cn(Re, O, M), ge & 6)
      ...
      (oe !== he || ye > 0 && ye & 64) ? fe(
        ...
        !1,
        !0
      ) : (oe === he && ye & 384 || !z && ge & 16) && fe(le, O, j), re && H(M);
    }
...
function ek(e, t = null, n = null, a = 0, l = null, i = !1) {
  ...
  if (uk(e) && (e = e.__vccOpts), t) {
    ...
    r && !ut(r) && (t.class = ee(r)), nt(s) && (/* @__PURE__ */ Ei(s) && !Ee(s) && (s = wt({}, s)), t.style = ve(s));
  }
...
function Tg(e) {
  ...
  })), m = ct("validation"), y = _(() => e.name ?? Ve(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
...
const Xu = (e) => {
  ...
  let a = !1;
  const l = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = /* @__PURE__ */ se(/* @__PURE__ */ new Set()), r = ke(e, "opened", e.opened, (w) => new Set(Array.isArray(w) ? w.map((b) => /* @__PURE__ */ _e(b)) : w), (w) => [...w.values()]), s = _(() => {
  ...
  setup(e, t) {
    ...
    return te(() => {
      const Z = b.value ? "a" : e.tag, ce = a.title || e.title != null, xe = a.subtitle || e.subtitle != null, Ce = !!(e.appendAvatar || e.appendIcon), Ie = !!(Ce || a.append), M = !!(e.prependAvatar || e.prependIcon), O = !!(M || a.prepend);
      return x?.updateHasPrepend(O), e.activeColor && hm("active-color", ["color", "base-color"]), Ge(p(Z, U(i.linkProps, {
        class: ["v-list-item", {
      ...
      if (y.value && !An()) {
        ...
        requestAnimationFrame(() => {
          const q = Du(N), $ = J.getBoundingClientRect(), ne = $.x - q.x, K = $.y - q.y - (q.height / 2 - $.height / 2), H = $.width / 0.75, G = Math.abs(H - q.width) > 1 ? {
            maxWidth: de(H)
          } : void 0, X = getComputedStyle(N), fe = getComputedStyle(J), Z = parseFloat(X.transitionDuration) * 1e3 || 150, ce = parseFloat(fe.getPropertyValue("--v-field-label-scale")), xe = fe.getPropertyValue("color");
...
function dh(e, t) {
  ...
  function N() {
    ...
    const $ = T - c, ne = Math.sign(P), K = Math.max(0, $ - Jr), H = je(C(K), 0, t.value.length), G = $ + v.value + Jr, X = je(C(G) + 1, H + 1, t.value.length);
    if (
      ...
      Math.max(fe, Z) > Jr ? (l.value = H, i.value = X) : (H <= 0 && (l.value = H), X >= t.value.length && (i.value = X));
    }
...
const sc = R({
  ...
  setup(e, t) {
    ...
    let x = "", w = 0, b;
    const S = _(() => e.hideSelected ? r.value.filter((X) => !c.value.some((fe) => (e.valueComparator || xt)(fe, X))) : r.value), g = _(() => e.hideNoData && !S.value.length || f.isReadonly.value || f.isDisabled.value), I = ke(e, "menu"), C = _({
      get: () => I.value,
      set: (X) => {
    ...
    function q(X) {
      ...
      if (!X.props.disabled)
        if (e.multiple) {
          const Z = c.value.findIndex((xe) => (e.valueComparator || xt)(xe.value, X.value)), ce = fe ?? !~Z;
          if (~Z) {
    ...
    return ue(C, () => {
      ...
      const X = !!(e.chips || n.chip), fe = !!(!e.hideNoData || S.value.length || n["prepend-item"] || n["append-item"] || n["no-data"]), Z = c.value.length > 0, ce = Mn.filterProps(e), xe = Z || !m.value && e.label && !e.persistentPlaceholder ? void 0 : e.placeholder;
      return p(Mn, U({
        ref: l
      }, ce, {
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = _(() => a?.transform ? Ve(t).map((s) => [s, a.transform(s)]) : Ve(t));
  at(() => {
...
const Ii = {
  ...
  setup(e, t) {
    ...
    function P() {
      const B = de(e.intervalWidth), D = en(a, ":interval", (L) => ({
        nativeEvent: L,
...
function VV(e, t, n) {
  ...
  function w(D, L) {
    ...
    if ($ === !1 || q === !1 || $ < 0 || q >= 1 || kV(W, L))
      return !1;
    const ne = gt(L), K = W.startIdentifier >= ne, H = W.endIdentifier > ne, G = L.timeToY(W.start, L), X = L.timeToY(W.end, L), fe = Math.max(e.eventHeight || 0, X - G);
    return b(W, {
      eventParsed: W,
      day: L,
      start: K,
  ...
  function b(D, L, W, N) {
    const J = t.event, q = c.value(D.input), $ = k(D.input), ne = D.start.hour < 12 && D.end.hour >= 12, K = qC(D.start, D.end) <= u.value, H = (ce, xe) => a.getFormatter({
      timeZone: "UTC",
      hour: "numeric",
      ...
      if (D.start.hasTime)
        if (W) {
          ...
          }, [V("strong", null, [ce]), Ce, xe]);
        } else {
          const xe = H(D.start);
          return V("span", {
            class: "v-event-summary"
          }, [V("strong", null, [xe]), Kt(" "), ce]);
        }
      return V("span", {
        class: "v-event-summary"
      }, [ce]);
...
const Kh = R({
  ...
  function B(Z) {
    ...
    const xe = t.direction === "vertical", Ce = xe ? "top" : "left", Ie = xe ? "height" : "width", M = xe ? "clientY" : "clientX", {
      [Ce]: O,
      [Ie]: j
    } = ce.getBoundingClientRect(), re = t_(Z, M);
  ...
  setup(e, t) {
    ...
    function H(X, fe) {
      ...
      if ([N, J, q, $].includes(X.key)) {
        const Ce = (h.value ? [i.value ? N : J, y.value ? q : $] : g.value !== i.value ? [N, $] : [J, $]).includes(X.key) ? 1 : -1, Ie = X.shiftKey ? 2 : X.ctrlKey ? 1 : 0;
        Ce === -1 && fe === s.value && !Ie && !Number.isInteger(ce) ? fe = fe - ce % 1 * Z : fe = fe + Ce * Z * K.value[Ie];
      } else if (X.key === W)
        fe = r.value;
      else if (X.key === L)
        fe = s.value;
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      return p(Za, U({
        ...
        }), a)]), a.thead?.(Z.value), !e.hideDefaultBody && V("tbody", null, [a["body.prepend"]?.(Z.value), a.body ? a.body(Z.value) : p(Xa, U(n, Ce, {
          items: N.value
        }), a), a["body.append"]?.(Z.value)]), a.tbody?.(Z.value), a.tfoot?.(Z.value)]),
        bottom: () => a.bottom ? a.bottom(Z.value) : !e.hideDefaultFooter && V(he, null, [p(tn, null, null), p(Ti, ce, {
...
`) : G;
    ...
    return ue(r, (G, X) => {
      const fe = qe(X), Z = qe(G);
      if (!Z.length) return;
      const ce = l.date(fe[fe.length - 1]), xe = l.date(Z[Z.length - 1]);
      ...
      const G = El.filterProps(e), X = Me(Ks.filterProps(e), ["viewMode"]), fe = Gs.filterProps(e), Z = qs.filterProps(e), ce = Me(Xs.filterProps(e), ["modelValue"]), xe = Me(Zs.filterProps(e), ["modelValue"]), Ce = {
        color: v.value,
        header: w.value,
        transition: C.value
      };
...
const J1 = Q()({
  ...
  setup(e, t) {
    ...
    const l = /* @__PURE__ */ ae(), i = /* @__PURE__ */ se("ok"), o = /* @__PURE__ */ se("ok"), r = _(() => de(e.margin)), s = /* @__PURE__ */ se(!1);
    function u(g) {
      if (!l.value) return;
  ...
  setup(e, t) {
    ...
    function A(H) {
      ...
      const G = H.target, {
        ...
        selectionStart: fe,
        selectionEnd: Z
      } = G ?? {}, ce = X ? X.slice(0, fe) + H.data + X.slice(Z) : H.data, xe = e0(ce, e.precision, c.value);
    ...
    return te(() => {
      ...
      const Ce = w.value === "split" ? V("div", {
        ...
        vertical: !0
      }, null), fe()]) : e.reverse || w.value === "hidden" ? void 0 : V(he, null, [xe(), ce()]), Ie = n["append-inner"] || Ce, M = w.value === "split" ? V("div", {
        class: "v-number-input__control"
      }, [Z(), p(tn, {
        vertical: !0
      }, null)]) : e.reverse && w.value !== "hidden" ? V(he, null, [ce(), xe()]) : void 0, O = n["prepend-inner"] || M;
      return p(Mn, U({
        ref: a
      }, X, {
        modelValue: m.value,
...
const FP = R({
  ...
  setup(e, t) {
    ...
    }).visibleIds, i = /* @__PURE__ */ ae(), o = _(() => i.value?.root.activatable.value && i.value?.isGroupActivator), r = _(() => i.value?.link.isClickable.value || e.value != null && !!i.value?.list), s = _(() => !e.disabled && e.link !== !1 && (e.link || r.value || o.value)), u = _(() => l.value && !l.value.has(/* @__PURE__ */ _e(i.value?.id)));
    function c(f) {
...
const lT = {
  __name: "VCheckbox",
  setup(e) {
    const t = Oe("children"), n = Oe("type"), a = Oe("name"), l = Oe("error"), i = Oe("label"), o = Oe("disabled"), r = Oe("indeterminate"), s = Oe("multiple"), u = Oe("value"), c = Oe("width"), d = Oe("id"), f = Oe("model_value"), v = Oe("color"), k = Oe("density"), m = Oe("theme"), y = Oe("max_width"), h = Oe("min_width"), x = Oe("base_color"), w = Oe("prepend_icon"), b = Oe("append_icon"), S = Oe("readonly"), g = Oe("ripple"), I = Oe("messages"), C = Oe("center_affix"), T = Oe("glow"), P = Oe("icon_color"), F = Oe("hide_spin_buttons"), A = Oe("hint"), B = Oe("persistent_hint"), D = Oe("error_messages"), L = Oe("max_errors"), W = Oe("rules"), N = Oe("validate_on"), J = Oe("validation_value"), q = Oe("focused"), $ = Oe("hide_details"), ne = Oe("indeterminate_icon"), K = Oe("true_value"), H = Oe("false_value"), G = Oe("defaults_target"), X = Oe("false_icon"), fe = Oe("true_icon"), Z = Oe("value_comparator");
    return (ce, xe) => {
      const Ce = Nv("v-checkbox", !0);
      return XS(), QS(Ce, {
        type: Ve(n),
        name: Ve(a),
        error: Ve(l),
        ...
        rules: Ve(W),
        validateOn: Ve(N),
        validationValue: Ve(J),
        focused: Ve(q),
        hideDetails: Ve($),
        indeterminateIcon: Ve(ne),
        trueValue: Ve(K),
        falseValue: Ve(H),
        defaultsTarget: Ve(G),
        falseIcon: Ve(X),
        trueIcon: Ve(fe),
        valueComparator: Ve(Z)
      }, {
        default: pv(() => [
          Kt(
            Tn(Ve(t)),
        ...
        _: 1
        /* STABLE */
      }, 8, ["type", "name", "error", "label", "disabled", "indeterminate", "multiple", "value", "width", "id", "modelValue", "color", "density", "theme", "maxWidth", "minWidth", "baseColor", "prependIcon", "appendIcon", "readonly", "ripple", "messages", "centerAffix", "glow", "iconColor", "hideSpinButtons", "hint", "persistentHint", "errorMessages", "maxErrors", "rules", "validateOn", "validationValue", "focused", "hideDetails", "indeterminateIcon", "trueValue", "falseValue", "defaultsTarget", "falseIcon", "trueIcon", "valueComparator"]);
    };
  }
