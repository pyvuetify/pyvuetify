...
const lT = {
  __name: "VList",
  setup(e) {
    const t = Be("children"), n = Be("border"), a = Be("density"), l = Be("height"), i = Be("max_height"), o = Be("max_width"), r = Be("min_height"), s = Be("min_width"), u = Be("width"), c = Be("elevation"), d = Be("rounded"), f = Be("tile"), v = Be("tag"), k = Be("theme"), m = Be("color"), y = Be("variant"), h = Be("activated"), x = Be("disabled"), w = Be("items"), b = Be("active_color"), S = Be("base_color"), g = Be("slim"), I = Be("active_class"), C = Be("bg_color"), T = Be("filterable"), P = Be("expand_icon"), F = Be("collapse_icon"), A = Be("lines"), B = Be("prepend_gap"), D = Be("indent"), L = Be("nav"), W = Be("activatable"), N = Be("selectable"), J = Be("opened"), q = Be("selected"), $ = Be("mandatory"), ne = Be("items_registration"), K = Be("active_strategy"), H = Be("select_strategy"), G = Be("open_strategy"), X = Be("item_title"), fe = Be("item_value"), Z = Be("item_children"), ce = Be("item_props"), xe = Be("item_type"), Ce = Be("return_object"), Ie = Be("value_comparator");
    return (M, O) => {
      const j = Nv("v-list", !0);
      return XS(), QS(j, {
        border: Ve(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["border", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "rounded", "tile", "tag", "theme", "color", "variant", "activated", "disabled", "items", "activeColor", "baseColor", "slim", "activeClass", "bgColor", "filterable", "expandIcon", "collapseIcon", "lines", "prependGap", "indent", "nav", "activatable", "selectable", "opened", "selected", "mandatory", "itemsRegistration", "activeStrategy", "selectStrategy", "openStrategy", "itemTitle", "itemValue", "itemChildren", "itemProps", "itemType", "returnObject", "valueComparator"]);
    };
  }
