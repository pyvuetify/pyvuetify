...
const lT = {
  __name: "VIcon",
  setup(e) {
    const t = Cn("children"), n = Cn("end"), a = Cn("start"), l = Cn("icon"), i = Cn("tag"), o = Cn("theme"), r = Cn("color"), s = Cn("disabled"), u = Cn("size"), c = Cn("opacity");
    return (d, f) => {
      const v = Nv("v-icon", !0);
      return XS(), QS(v, {
        end: Ze(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["end", "start", "icon", "tag", "theme", "color", "disabled", "size", "opacity"]);
    };
  }
