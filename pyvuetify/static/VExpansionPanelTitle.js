...
const lT = {
  __name: "VExpansionPanelTitle",
  setup(e) {
    const t = Nt("children"), n = Nt("height"), a = Nt("max_height"), l = Nt("max_width"), i = Nt("min_height"), o = Nt("min_width"), r = Nt("width"), s = Nt("static"), u = Nt("color"), c = Nt("readonly"), d = Nt("ripple"), f = Nt("expand_icon"), v = Nt("collapse_icon"), k = Nt("hide_actions"), m = Nt("focusable");
    return (y, h) => {
      const x = Nv("v-expansion-panel-title", !0);
      return XS(), QS(x, {
        height: We(n),
        maxHeight: We(a),
        maxWidth: We(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "static", "color", "readonly", "ripple", "expandIcon", "collapseIcon", "hideActions", "focusable"]);
    };
  }
