...
function US(e, t) {
  ...
  const {
    ...
    if (j && _a(j, !1), (we = Se.onVnodeBeforeUpdate) && Cn(we, j, O, M), ge && Va(O, M, j, "beforeUpdate"), j && _a(j, !0), (ye.innerHTML && Se.innerHTML == null || ye.textContent && Se.textContent == null) && c(Y, ""), ie ? P(
      ...
      if (le & 16)
        ...
        for (let Fe = 0; Fe < De.length; Fe++) {
          const Ne = De[Fe], St = ye[Ne], Je = Se[Ne];
          (Je !== St || Ne === "value") && i(Y, Ne, St, Je, z, j);
        }
      }
    ...
    const Y = () => {
      if (M.isMounted) {
        ...
        M.subTree = Je, m(
          ...
          z,
          oe
        ), ye.el = Je.el, Ne === null && OS(M, Je.el), we && Ht(we, z), (St = ye.props && ye.props.onVnodeUpdated) && Ht(
          () => Cn(St, De, ye, Fe),
          z
        );
      } else {
        let ye;
        const { el: Se, props: we } = O, { bm: De, m: Fe, parent: Ne, root: St, type: Je } = M, rn = ai(O);
        _a(M, !1), De && uo(De), !rn && (ye = we && we.onVnodeBeforeMount) && Cn(ye, Ne, O), _a(M, !0);
        {
        ...
        (O.shapeFlag & 256 || Ne && ai(Ne.vnode) && Ne.vnode.shapeFlag & 256) && M.a && Ht(M.a, z), M.isMounted = !0, O = j = re = null;
      }
    };
    M.scope.on();
    ...
    if (ie > ye) {
      ...
      for (Ne = Mc.length - 1, ie = Je - 1; ie >= 0; ie--) {
        ...
        zl[ie] === 0 ? m(
          ...
          Y,
          le
        ) : rn && (Ne < 0 || ie !== Mc[Ne] ? ne(xn, j, Fc, 2) : Ne--);
      }
    }
  }, ne = (M, O, j, re, z = null) => {
    ...
    let Ne;
    if (Fe && (Ne = me && me.onVnodeBeforeUnmount) && Cn(Ne, O, M), ge & 6)
      X(M.component, j, re);
    else {
      if (ge & 128) {
    ...
    (Fe && (Ne = me && me.onVnodeUnmounted) || De) && Ht(() => {
      Ne && Cn(Ne, O, M), De && Va(M, null, O, "unmounted");
    }, j);
  }, H = (M) => {
...
function wm(e, t) {
  ...
  const a = function() {
    for (var l = arguments.length, i = new Array(l), o = 0; o < l; o++)
      i[o] = arguments[o];
    clearTimeout(n), n = setTimeout(() => e(...i), Ie(t));
  };
  return a.clear = () => {
    clearTimeout(n);
  }, a.immediate = e, a;
...
function lt(e, t) {
  const n = Bu(), a = /* @__PURE__ */ ae(e), l = _(() => {
    if (Ie(t?.disabled)) return n.value;
    const o = Ie(t?.scoped), r = Ie(t?.reset), s = Ie(t?.root);
...
function Ca(e, t) {
  ...
  function o(f, v) {
    ...
    Ie(k.value) === void 0 && (k.value = h, k.useIndexAsValue = !0), h > -1 ? a.splice(h, 0, k) : a.push(k);
  }
  function r(f) {
    if (n) return;
    s();
...
function Tg(e) {
  ...
  })), m = ct("validation"), y = _(() => e.name ?? Ie(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
  ...
  setup(e, t) {
    ...
    return () => {
      ...
      return f.value && Ge(p(C, U(m.linkProps, {
        ...
        }, l.prepend) : V(he, null, [e.prependIcon && p(Re, {
          key: "prepend-icon",
          icon: e.prependIcon,
          start: !0
        ...
        }, l.append) : V(he, null, [e.appendIcon && p(Re, {
          key: "append-icon",
          end: !0,
          icon: e.appendIcon
...
const Xu = (e) => {
  ...
  setup(e, t) {
    ...
    return te(() => {
      const Z = b.value ? "a" : e.tag, de = a.title || e.title != null, xe = a.subtitle || e.subtitle != null, Ce = !!(e.appendAvatar || e.appendIcon), _e = !!(Ce || a.append), M = !!(e.prependAvatar || e.prependIcon), O = !!(M || a.prepend);
...
const sc = R({
  ...
  setup(e, t) {
    ...
    function q(X) {
      ...
      if (!X.props.disabled)
        if (e.multiple) {
          const Z = c.value.findIndex((xe) => (e.valueComparator || xt)(xe.value, X.value)), de = ve ?? !~Z;
          if (~Z) {
    ...
    return ue(C, () => {
      ...
      const X = !!(e.chips || n.chip), ve = !!(!e.hideNoData || S.value.length || n["prepend-item"] || n["append-item"] || n["no-data"]), Z = c.value.length > 0, de = Mn.filterProps(e), xe = Z || !m.value && e.label && !e.persistentPlaceholder ? void 0 : e.placeholder;
      return p(Mn, U({
        ref: l
      }, de, {
        ...
        "append-inner": function() {
          for (var Ce = arguments.length, _e = new Array(Ce), M = 0; M < Ce; M++)
            _e[M] = arguments[M];
          return V(he, null, [n["append-inner"]?.(..._e), e.menuIcon ? p(Re, {
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = _(() => a?.transform ? Ie(t).map((s) => [s, a.transform(s)]) : Ie(t));
  at(() => {
    const s = typeof n == "function" ? n() : Ie(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = mC(o.value, u, {
      customKeyFilter: {
        ...e.customKeyFilter,
        ...Ie(a?.customKeyFilter)
      },
      default: e.customFilter,
      filterKeys: e.filterKeys,
      filterMode: e.filterMode,
      noFilter: e.noFilter
    }), d = Ie(t), f = [], v = /* @__PURE__ */ new Map();
    c.forEach((k) => {
      let {
        index: m,
        matches: y
      ...
      return p(Mn, U({
                ...
                default: (ie) => {
                  ...
                  return ge.type === "divider" ? n.divider?.({
                    ...
                    prepend: (De) => {
                      ...
                      }, null), ge.props.prependIcon && p(Re, {
        ...
        "append-inner": function() {
          for (var Y = arguments.length, le = new Array(Y), ie = 0; ie < Y; ie++)
            le[ie] = arguments[ie];
          return V(he, null, [n["append-inner"]?.(...le), e.menuIcon ? p(Re, {
      ...
      return p(e.tag, U({
        ...
        default: () => [V("div", {
          ...
          default: () => [Ge(V("span", U({
            ...
            "aria-live": "polite",
            role: "status"
          }, v), [e.dot ? void 0 : t.slots.badge ? t.slots.badge?.() : e.icon ? p(Re, {
            icon: e.icon
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      return p(e.tag, {
        ...
        }, n.append) : V(he, null, [e.appendIcon && p(Re, {
          key: "append-icon",
          density: e.density,
          icon: e.appendIcon
        }, null), e.appendAvatar && p(nn, {
  ...
  setup(e, t) {
    ...
    function H(X, ve) {
      ...
      if ([N, J, q, $].includes(X.key)) {
        const Ce = (h.value ? [i.value ? N : J, y.value ? q : $] : g.value !== i.value ? [N, $] : [J, $]).includes(X.key) ? 1 : -1, _e = X.shiftKey ? 2 : X.ctrlKey ? 1 : 0;
      ...
      return p(Mn, U({
                ...
                default: (Se) => {
                  ...
                  return we.type === "divider" ? a.divider?.({
                    ...
                    prepend: (St) => {
                      ...
                      }, null), we.props.prependIcon && p(Re, {
        ...
        "append-inner": function() {
          for (var ge = arguments.length, ye = new Array(ge), Se = 0; Se < ge; Se++)
            ye[Se] = arguments[Se];
          return V(he, null, [a["append-inner"]?.(...ye), (!e.hideNoData || e.items.length) && e.menuIcon ? p(Re, {
    ...
    const {
      ...
      return p(Ai, U({
        ...
        default: () => {
          ...
          }, [V("span", null, [P.title]), P.sortable && !e.disableSort && p(Re, {
            key: "icon",
...
const Pc = R({
  ...
  setup(e, t) {
    ...
    return te(() => {
      const de = Ti.filterProps(e), xe = qa.filterProps(Me(e, ["multiSort"])), Ce = Xa.filterProps(e), _e = Za.filterProps(e);
      return p(Za, U({
        class: ["v-data-table", {
  ...
  setup(e, t) {
    ...
    return te(() => {
      const _e = qa.filterProps(Me(e, ["multiSort"])), M = Xa.filterProps(e), O = Za.filterProps(e);
      return p(Za, U({
        class: ["v-data-table", {
          "v-data-table--loading": e.loading
        }, e.class],
...
`) : G;
    ...
    return ue(r, (G, X) => {
      ...
      const G = El.filterProps(e), X = Me(Ks.filterProps(e), ["viewMode"]), ve = Gs.filterProps(e), Z = qs.filterProps(e), de = Me(Xs.filterProps(e), ["modelValue"]), xe = Me(Zs.filterProps(e), ["modelValue"]), Ce = {
        color: v.value,
        header: w.value,
        transition: C.value
      };
  ...
  setup(e, t) {
    ...
    return te(() => Ge(V("button", {
      ...
      }, [n.actions?.(r.value) ?? p(Re, null, null)])]
    })]), [[_t, e.ripple]])), {};
  }
}), Hy = R({
  title: String,
  ...
  setup(e, t) {
    ...
    return te(() => {
      ...
      return Ge(V("button", {
        ...
        default: () => [n.icon?.(d.value) ?? (c.value ? p(Re, {
          icon: c.value
        }, null) : l.value)]
      }), V("div", {
...
function He(e) {
  ...
  const a = eS((i, o) => (n = o, {
    ...
    set(r) {
      t.set(Ie(e), kt(r)), t.save_changes();
    }
  })), l = () => {
    a.value = t.get(Ie(e)), n();
  };
  return ht(() => {
    t.on(`change:${e}`, l);
  }), Xo(() => {
...
const lT = {
  __name: "VColorPicker",
  setup(e) {
    const t = He("children"), n = He("title"), a = He("border"), l = He("model_value"), i = He("height"), o = He("max_height"), r = He("max_width"), s = He("min_height"), u = He("min_width"), c = He("width"), d = He("elevation"), f = He("location"), v = He("position"), k = He("rounded"), m = He("tile"), y = He("tag"), h = He("theme"), x = He("color"), w = He("disabled"), b = He("bg_color"), S = He("mode"), g = He("canvas_height"), I = He("dot_size"), C = He("hide_canvas"), T = He("hide_sliders"), P = He("hide_inputs"), F = He("modes"), A = He("show_swatches"), B = He("swatches_max_height"), D = He("divided"), L = He("landscape"), W = He("hide_header"), N = He("hide_title"), J = He("hide_eye_dropper"), q = He("eye_dropper_icon"), $ = He("swatches");
    return (ne, K) => {
      const H = Nv("v-color-picker", !0);
      return XS(), QS(H, {
        title: Ie(n),
        border: Ie(a),
        modelValue: Ie(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "border", "modelValue", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "location", "position", "rounded", "tile", "tag", "theme", "color", "disabled", "bgColor", "mode", "canvasHeight", "dotSize", "hideCanvas", "hideSliders", "hideInputs", "modes", "showSwatches", "swatchesMaxHeight", "divided", "landscape", "hideHeader", "hideTitle", "hideEyeDropper", "eyeDropperIcon", "swatches"]);
    };
  }
