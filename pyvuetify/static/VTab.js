...
const lT = {
  __name: "VTab",
  setup(e) {
    const t = Oe("children"), n = Oe("text"), a = Oe("replace"), l = Oe("fixed"), i = Oe("border"), o = Oe("icon"), r = Oe("density"), s = Oe("height"), u = Oe("max_height"), c = Oe("max_width"), d = Oe("min_height"), f = Oe("min_width"), v = Oe("width"), k = Oe("elevation"), m = Oe("rounded"), y = Oe("tile"), h = Oe("tag"), x = Oe("theme"), w = Oe("color"), b = Oe("variant"), S = Oe("disabled"), g = Oe("size"), I = Oe("value"), C = Oe("active_color"), T = Oe("base_color"), P = Oe("prepend_icon"), F = Oe("append_icon"), A = Oe("readonly"), B = Oe("slim"), D = Oe("stacked"), L = Oe("ripple"), W = Oe("selected_class"), N = Oe("loading"), J = Oe("href"), q = Oe("exact"), $ = Oe("to"), ne = Oe("spaced"), K = Oe("direction"), H = Oe("inset"), G = Oe("slider_color"), X = Oe("slider_transition_duration"), fe = Oe("hide_slider"), Z = Oe("slider_transition");
    return (ce, xe) => {
      const Ce = Nv("v-tab", !0);
      return XS(), QS(Ce, {
        text: Ve(n),
        ...
        inset: Ve(H),
        sliderColor: Ve(G),
        sliderTransitionDuration: Ve(X),
        hideSlider: Ve(fe),
        sliderTransition: Ve(Z)
      }, {
        default: pv(() => [
          Kt(
            Tn(Ve(t)),
        ...
        _: 1
        /* STABLE */
      }, 8, ["text", "replace", "fixed", "border", "icon", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "size", "value", "activeColor", "baseColor", "prependIcon", "appendIcon", "readonly", "slim", "stacked", "ripple", "selectedClass", "loading", "href", "exact", "to", "spaced", "direction", "inset", "sliderColor", "sliderTransitionDuration", "hideSlider", "sliderTransition"]);
    };
  }
