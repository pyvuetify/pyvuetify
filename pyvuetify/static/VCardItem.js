...
const Xy = N({
  ...
  setup(e, t) {
    ...
    return te(() => {
      const [x, w] = Bn(n), b = Pt.filterProps(e), S = ka.filterProps(e);
      return p(Pt, U({
        ref: d,
        class: ["v-switch", {
...
const lT = {
  __name: "VCardItem",
  setup(e) {
    const t = Nn("children"), n = Nn("tag"), a = Nn("title"), l = Nn("density"), i = Nn("prepend_icon"), o = Nn("append_icon"), r = Nn("subtitle"), s = Nn("append_avatar"), u = Nn("prepend_avatar");
    return (c, d) => {
      const f = Nv("v-card-item", !0);
      return XS(), QS(f, {
        tag: Ze(n),
        title: Ze(a),
        density: Ze(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "title", "density", "prependIcon", "appendIcon", "subtitle", "appendAvatar", "prependAvatar"]);
    };
  }
