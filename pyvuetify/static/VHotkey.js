...
const lT = {
  __name: "VHotkey",
  setup(e) {
    const t = Mt("children"), n = Mt("keys"), a = Mt("border"), l = Mt("elevation"), i = Mt("rounded"), o = Mt("tile"), r = Mt("theme"), s = Mt("color"), u = Mt("variant"), c = Mt("disabled"), d = Mt("prefix"), f = Mt("suffix"), v = Mt("display_mode"), k = Mt("key_map"), m = Mt("platform"), y = Mt("inline");
    return (h, x) => {
      const w = Nv("v-hotkey", !0);
      return XS(), QS(w, {
        keys: He(n),
        border: He(a),
        elevation: He(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["keys", "border", "elevation", "rounded", "tile", "theme", "color", "variant", "disabled", "prefix", "suffix", "displayMode", "keyMap", "platform", "inline"]);
    };
  }
