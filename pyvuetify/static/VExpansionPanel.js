...
const lT = {
  __name: "VExpansionPanel",
  setup(e) {
    const t = et("children"), n = et("title"), a = et("text"), l = et("height"), i = et("max_height"), o = et("max_width"), r = et("min_height"), s = et("min_width"), u = et("width"), c = et("elevation"), d = et("static"), f = et("rounded"), v = et("tile"), k = et("tag"), m = et("color"), y = et("disabled"), h = et("value"), x = et("readonly"), w = et("ripple"), b = et("selected_class"), S = et("eager"), g = et("bg_color"), I = et("expand_icon"), C = et("collapse_icon"), T = et("hide_actions"), P = et("focusable");
    return (F, A) => {
      const B = Nv("v-expansion-panel", !0);
      return XS(), QS(B, {
        title: $e(n),
        text: $e(a),
        height: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "text", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "static", "rounded", "tile", "tag", "color", "disabled", "value", "readonly", "ripple", "selectedClass", "eager", "bgColor", "expandIcon", "collapseIcon", "hideActions", "focusable"]);
    };
  }
