...
const lT = {
  __name: "VItemGroup",
  setup(e) {
    const t = Nn("children"), n = Nn("tag"), a = Nn("disabled"), l = Nn("max"), i = Nn("multiple"), o = Nn("model_value"), r = Nn("theme"), s = Nn("selected_class"), u = Nn("mandatory");
    return (c, d) => {
      const f = Nv("v-item-group", !0);
      return XS(), QS(f, {
        tag: Ze(n),
        disabled: Ze(a),
        max: Ze(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "disabled", "max", "multiple", "modelValue", "theme", "selectedClass", "mandatory"]);
    };
  }
