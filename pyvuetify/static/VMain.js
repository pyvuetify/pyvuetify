...
const lT = {
  __name: "VMain",
  setup(e) {
    const t = Nn("children"), n = Nn("height"), a = Nn("max_height"), l = Nn("max_width"), i = Nn("min_height"), o = Nn("min_width"), r = Nn("width"), s = Nn("tag"), u = Nn("scrollable");
    return (c, d) => {
      const f = Nv("v-main", !0);
      return XS(), QS(f, {
        height: Ze(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "tag", "scrollable"]);
    };
  }
