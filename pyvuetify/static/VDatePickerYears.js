...
const lT = {
  __name: "VDatePickerYears",
  setup(e) {
    const t = Ta("children"), n = Ta("model_value"), a = Ta("height"), l = Ta("color"), i = Ta("max"), o = Ta("min"), r = Ta("allowed_years");
    return (s, u) => {
      const c = Nv("v-date-picker-years", !0);
      return XS(), QS(c, {
        modelValue: nt(n),
        height: nt(a),
        color: nt(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["modelValue", "height", "color", "max", "min", "allowedYears"]);
    };
  }
