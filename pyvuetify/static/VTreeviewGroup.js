...
const lT = {
  __name: "VTreeviewGroup",
  setup(e) {
    const t = jt("children"), n = jt("tag"), a = jt("title"), l = jt("disabled"), i = jt("value"), o = jt("color"), r = jt("base_color"), s = jt("active_color"), u = jt("prepend_icon"), c = jt("append_icon"), d = jt("fluid"), f = jt("collapse_icon"), v = jt("expand_icon"), k = jt("raw_id");
    return (m, y) => {
      const h = Nv("v-treeview-group", !0);
      return XS(), QS(h, {
        tag: Ye(n),
        title: Ye(a),
        disabled: Ye(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "title", "disabled", "value", "color", "baseColor", "activeColor", "prependIcon", "appendIcon", "fluid", "collapseIcon", "expandIcon", "rawId"]);
    };
  }
