...
const lT = {
  __name: "VBtnToggle",
  setup(e) {
    const t = wt("children"), n = wt("tag"), a = wt("disabled"), l = wt("max"), i = wt("multiple"), o = wt("model_value"), r = wt("color"), s = wt("density"), u = wt("border"), c = wt("elevation"), d = wt("rounded"), f = wt("tile"), v = wt("theme"), k = wt("variant"), m = wt("base_color"), y = wt("selected_class"), h = wt("mandatory"), x = wt("divided"), w = wt("direction");
    return (b, S) => {
      const g = Nv("v-btn-toggle", !0);
      return XS(), QS(g, {
        tag: Ne(n),
        disabled: Ne(a),
        max: Ne(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "disabled", "max", "multiple", "modelValue", "color", "density", "border", "elevation", "rounded", "tile", "theme", "variant", "baseColor", "selectedClass", "mandatory", "divided", "direction"]);
    };
  }
