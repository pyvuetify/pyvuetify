  ...
  const {
    ...
    if (j && _a(j, !1), (we = Se.onVnodeBeforeUpdate) && Cn(we, j, $, M), ge && Va($, M, j, "beforeUpdate"), j && _a(j, !0), (ye.innerHTML && Se.innerHTML == null || ye.textContent && Se.textContent == null) && c(Y, ""), ie ? P(
      ...
      if (le & 16)
        ...
        for (let Fe = 0; Fe < Ae.length; Fe++) {
          const Ne = Ae[Fe], St = ye[Ne], Ze = Se[Ne];
    ...
    const Y = () => {
      if (M.isMounted) {
        ...
        let ye;
        const { el: Se, props: we } = $, { bm: Ae, m: Fe, parent: Ne, root: St, type: Ze } = M, rn = ai($);
...
const lT = {
  __name: "VImg",
  setup(e) {
    const t = Je("children"), n = Je("alt"), a = Je("height"), l = Je("src"), i = Je("width"), o = Je("draggable"), r = Je("absolute"), s = Je("color"), u = Je("rounded"), c = Je("tile"), d = Je("inline"), f = Je("transition"), v = Je("max_height"), k = Je("max_width"), m = Je("min_height"), y = Je("min_width"), h = Je("position"), x = Je("content_class"), w = Je("eager"), b = Je("options"), S = Je("cover"), g = Je("gradient"), I = Je("lazy_src"), C = Je("sizes"), T = Je("srcset"), P = Je("aspect_ratio"), F = Je("crossorigin"), A = Je("referrerpolicy");
    return (B, D) => {
      const L = Nv("v-img", !0);
      return XS(), QS(L, {
        alt: Me(n),
        ...
        _: 1
        /* STABLE */
      }, 8, ["alt", "height", "src", "width", "draggable", "absolute", "color", "rounded", "tile", "inline", "transition", "maxHeight", "maxWidth", "minHeight", "minWidth", "position", "contentClass", "eager", "options", "cover", "gradient", "lazySrc", "sizes", "srcset", "aspectRatio", "crossorigin", "referrerpolicy"]);
    };
  }
