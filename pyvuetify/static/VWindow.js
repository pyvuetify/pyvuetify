...
function Tg(e) {
  ...
  })), m = ut("validation"), y = _(() => e.name ?? He(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
...
const Gu = /* @__PURE__ */ Symbol.for("vuetify:v-slide-group"), qu = N({
  ...
  setup(e, t) {
    ...
    const {
      ...
      themeClasses: d
    } = Re(e), f = ke(e, "modelValue"), v = ba(e, Eg, !1), k = ba(e, Gu, !1), m = zi(e, n), y = /* @__PURE__ */ E(() => e.link !== !1 && m.isLink.value), h = _(() => !e.disabled && e.link !== !1 && (!!v || e.link || m.isClickable.value)), x = /* @__PURE__ */ E(() => ({
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = _(() => a?.transform ? He(t).map((s) => [s, a.transform(s)]) : He(t));
  nt(() => {
    const s = typeof n == "function" ? n() : He(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = mC(o.value, u, {
      customKeyFilter: {
        ...e.customKeyFilter,
...
function _t(e) {
  ...
  const a = eS((i, o) => (n = o, {
    ...
    set(r) {
      t.set(He(e), St(r)), t.save_changes();
    }
  })), l = () => {
...
const lT = {
  __name: "VWindow",
  setup(e) {
    const t = _t("children"), n = _t("tag"), a = _t("reverse"), l = _t("disabled"), i = _t("model_value"), o = _t("theme"), r = _t("selected_class"), s = _t("mandatory"), u = _t("direction"), c = _t("continuous"), d = _t("next_icon"), f = _t("prev_icon"), v = _t("show_arrows"), k = _t("touch"), m = _t("crossfade"), y = _t("transition_duration"), h = _t("vertical_arrows");
    return (x, w) => {
      const b = Nv("v-window", !0);
      return XS(), QS(b, {
        tag: He(n),
        reverse: He(a),
        disabled: He(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "reverse", "disabled", "modelValue", "theme", "selectedClass", "mandatory", "direction", "continuous", "nextIcon", "prevIcon", "showArrows", "touch", "crossfade", "transitionDuration", "verticalArrows"]);
    };
  }
