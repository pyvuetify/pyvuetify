...
const lT = {
  __name: "VVideoControls",
  setup(e) {
    const t = mt("children"), n = mt("density"), a = mt("elevation"), l = mt("theme"), i = mt("color"), o = mt("variant"), r = mt("playing"), s = mt("progress"), u = mt("fullscreen"), c = mt("floating"), d = mt("track_color"), f = mt("background_color"), v = mt("hide_play"), k = mt("hide_volume"), m = mt("hide_fullscreen"), y = mt("split_time"), h = mt("pills"), x = mt("detached"), w = mt("duration"), b = mt("volume"), S = mt("volume_props");
    return (g, I) => {
      const C = Nv("v-video-controls", !0);
      return XS(), QS(C, {
        density: Oe(n),
        elevation: Oe(a),
        theme: Oe(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["density", "elevation", "theme", "color", "variant", "playing", "progress", "fullscreen", "floating", "trackColor", "backgroundColor", "hidePlay", "hideVolume", "hideFullscreen", "splitTime", "pills", "detached", "duration", "volume", "volumeProps"]);
    };
  }
