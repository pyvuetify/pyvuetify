...
const lT = {
  __name: "VListItem",
  setup(e) {
    const t = Ne("children"), n = Ne("title"), a = Ne("replace"), l = Ne("link"), i = Ne("border"), o = Ne("density"), r = Ne("height"), s = Ne("max_height"), u = Ne("max_width"), c = Ne("min_height"), d = Ne("min_width"), f = Ne("width"), v = Ne("elevation"), k = Ne("rounded"), m = Ne("tile"), y = Ne("tag"), h = Ne("theme"), x = Ne("color"), w = Ne("variant"), b = Ne("disabled"), S = Ne("value"), g = Ne("active"), I = Ne("active_color"), C = Ne("base_color"), T = Ne("prepend_icon"), P = Ne("append_icon"), F = Ne("slim"), A = Ne("ripple"), B = Ne("href"), D = Ne("exact"), L = Ne("to"), W = Ne("subtitle"), N = Ne("active_class"), J = Ne("lines"), q = Ne("prepend_gap"), $ = Ne("nav"), ne = Ne("append_avatar"), K = Ne("prepend_avatar");
    return (H, G) => {
      const X = Nv("v-list-item", !0);
      return XS(), QS(X, {
        title: Ie(n),
        replace: Ie(a),
        link: Ie(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "replace", "link", "border", "density", "height", "maxHeight", "maxWidth", "minHeight", "minWidth", "width", "elevation", "rounded", "tile", "tag", "theme", "color", "variant", "disabled", "value", "active", "activeColor", "baseColor", "prependIcon", "appendIcon", "slim", "ripple", "href", "exact", "to", "subtitle", "activeClass", "lines", "prependGap", "nav", "appendAvatar", "prependAvatar"]);
    };
  }
