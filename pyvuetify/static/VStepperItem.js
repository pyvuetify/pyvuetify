...
const lT = {
  __name: "VStepperItem",
  setup(e) {
    const t = Mt("children"), n = Mt("title"), a = Mt("icon"), l = Mt("error"), i = Mt("color"), o = Mt("disabled"), r = Mt("value"), s = Mt("ripple"), u = Mt("selected_class"), c = Mt("subtitle"), d = Mt("rules"), f = Mt("complete_icon"), v = Mt("edit_icon"), k = Mt("editable"), m = Mt("error_icon"), y = Mt("complete");
    return (h, x) => {
      const w = Nv("v-stepper-item", !0);
      return XS(), QS(w, {
        title: He(n),
        icon: He(a),
        error: He(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["title", "icon", "error", "color", "disabled", "value", "ripple", "selectedClass", "subtitle", "rules", "completeIcon", "editIcon", "editable", "errorIcon", "complete"]);
    };
  }
