...
const lT = {
  __name: "VCarousel",
  setup(e) {
    const t = et("children"), n = et("tag"), a = et("reverse"), l = et("progress"), i = et("disabled"), o = et("height"), r = et("model_value"), s = et("color"), u = et("theme"), c = et("selected_class"), d = et("mandatory"), f = et("direction"), v = et("interval"), k = et("cycle"), m = et("delimiter_icon"), y = et("hide_delimiters"), h = et("hide_delimiter_background"), x = et("continuous"), w = et("next_icon"), b = et("prev_icon"), S = et("show_arrows"), g = et("touch"), I = et("crossfade"), C = et("transition_duration"), T = et("vertical_arrows"), P = et("vertical_delimiters");
    return (F, A) => {
      const B = Nv("v-carousel", !0);
      return XS(), QS(B, {
        tag: $e(n),
        reverse: $e(a),
        progress: $e(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["tag", "reverse", "progress", "disabled", "height", "modelValue", "color", "theme", "selectedClass", "mandatory", "direction", "interval", "cycle", "delimiterIcon", "hideDelimiters", "hideDelimiterBackground", "continuous", "nextIcon", "prevIcon", "showArrows", "touch", "crossfade", "transitionDuration", "verticalArrows", "verticalDelimiters"]);
    };
  }
