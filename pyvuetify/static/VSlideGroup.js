...
function at(e, t) {
  const n = Bu(), a = /* @__PURE__ */ ae(e), l = _(() => {
    if (Re(t?.disabled)) return n.value;
    const o = Re(t?.scoped), r = Re(t?.reset), s = Re(t?.root);
...
function Ca(e, t) {
  ...
  function o(f, v) {
    ...
    Re(k.value) === void 0 && (k.value = h, k.useIndexAsValue = !0), h > -1 ? a.splice(h, 0, k) : a.push(k);
  }
  function r(f) {
    if (n) return;
    s();
...
function Tg(e) {
  ...
  })), m = ut("validation"), y = _(() => e.name ?? Re(n));
  Bl(() => {
    i.register?.({
      id: y.value,
      vm: m,
...
function Wl(e, t, n, a) {
  const l = /* @__PURE__ */ se([]), i = /* @__PURE__ */ se(/* @__PURE__ */ new Map()), o = _(() => a?.transform ? Re(t).map((s) => [s, a.transform(s)]) : Re(t));
  nt(() => {
    const s = typeof n == "function" ? n() : Re(n), u = typeof s != "string" && typeof s != "number" ? "" : String(s), c = mC(o.value, u, {
      customKeyFilter: {
        ...e.customKeyFilter,
        ...Re(a?.customKeyFilter)
      },
      default: e.customFilter,
      filterKeys: e.filterKeys,
      filterMode: e.filterMode,
      noFilter: e.noFilter
    }), d = Re(t), f = [], v = /* @__PURE__ */ new Map();
    c.forEach((k) => {
      let {
        index: m,
        matches: y
...
function xr(e, t) {
  ...
  const l = ke(e, "modelValue", e.modelValue, (x) => {
    ...
    return w ? new Set(Ge(x).map((b) => n.value.find((S) => w(b, S.value))?.value ?? b)) : new Set(Ge(x).map((b) => ya(b) ? n.value.find((S) => b === S.value)?.value ?? b : n.value.find((S) => pt(b, S.value))?.value ?? b));
...
function Ct(e) {
  ...
  const a = eS((i, o) => (n = o, {
    ...
    set(r) {
      t.set(Re(e), St(r)), t.save_changes();
    }
  })), l = () => {
    a.value = t.get(Re(e)), n();
  };
  return gt(() => {
    t.on(`change:${e}`, l);
  }), Xo(() => {
...
const lT = {
  __name: "VSlideGroup",
  setup(e) {
    const t = Ct("children"), n = Ct("symbol"), a = Ct("model_value"), l = Ct("tag"), i = Ct("disabled"), o = Ct("max"), r = Ct("multiple"), s = Ct("selected_class"), u = Ct("mandatory"), c = Ct("content_class"), d = Ct("direction"), f = Ct("mobile"), v = Ct("next_icon"), k = Ct("prev_icon"), m = Ct("mobile_breakpoint"), y = Ct("center_active"), h = Ct("scroll_to_active"), x = Ct("show_arrows");
    return (w, b) => {
      const S = Nv("v-slide-group", !0);
      return XS(), QS(S, {
        symbol: Re(n),
        modelValue: Re(a),
        tag: Re(l),
        ...
        _: 1
        /* STABLE */
      }, 8, ["symbol", "modelValue", "tag", "disabled", "max", "multiple", "selectedClass", "mandatory", "contentClass", "direction", "mobile", "nextIcon", "prevIcon", "mobileBreakpoint", "centerActive", "scrollToActive", "showArrows"]);
    };
  }
