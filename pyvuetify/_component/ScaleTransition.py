...
class ScaleTransition(anywidget.AnyWidget):
    """The ScaleTransition component.
    ...
    Returns:
        A VScaleTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-scale-transition`__
    """

    _esm = bundled_path / "VScaleTransition.js"
    _css = bundled_path / "VScaleTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a ScaleTransition widget."""
