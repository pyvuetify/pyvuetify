...
class ScrollYReverseTransition(anywidget.AnyWidget):
    """The ScrollYReverseTransition component.
    ...
    Returns:
        A VScrollYReverseTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-scroll-y-reverse-transition`__
    """

    _esm = bundled_path / "VScrollYReverseTransition.js"
    _css = bundled_path / "VScrollYReverseTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a ScrollYReverseTransition widget."""
