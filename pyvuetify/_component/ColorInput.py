...
class ColorInput(anywidget.AnyWidget):
    """The ColorInput component.
    ...
    Args:
        ...
        hide_pip: Hide pip icon
        color_pip: Synchronize pip color with current value
        pip_icon: The icon used for pip
        pip_location: Move pip icon to a different slot
        pip_variant: Variant of the pip control
    ...
    Returns:
        A VColorInput widget.

    seealso:
        `https://vuetifyjs.com/api/v-color-input`__
    """

    _esm = bundled_path / "VColorInput.js"
    _css = bundled_path / "VColorInput-pyvuetify.css"
    ...
    hide_pip = traitlets.Bool(allow_none=True).tag(sync=True)
    """Hide pip icon"""

    color_pip = traitlets.Bool(allow_none=True).tag(sync=True)
    """Synchronize pip color with current value"""

    pip_icon = traitlets.Unicode(allow_none=True).tag(sync=True)
    """The icon used for pip"""

    pip_location = traitlets.Any(allow_none=True).tag(sync=True)
    """Move pip icon to a different slot"""

    pip_variant = traitlets.Any(allow_none=True).tag(sync=True)
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a ColorInput widget."""
        ...
        self.hide_pip = hide_pip
        self.color_pip = color_pip
        self.pip_icon = pip_icon
        self.pip_location = pip_location
        self.pip_variant = pip_variant
