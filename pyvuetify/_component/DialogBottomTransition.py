...
class DialogBottomTransition(anywidget.AnyWidget):
    """The DialogBottomTransition component.
    ...
    Returns:
        A VDialogBottomTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-dialog-bottom-transition`__
    """

    _esm = bundled_path / "VDialogBottomTransition.js"
    _css = bundled_path / "VDialogBottomTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a DialogBottomTransition widget."""
