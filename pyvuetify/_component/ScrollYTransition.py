...
class ScrollYTransition(anywidget.AnyWidget):
    """The ScrollYTransition component.
    ...
    Returns:
        A VScrollYTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-scroll-y-transition`__
    """

    _esm = bundled_path / "VScrollYTransition.js"
    _css = bundled_path / "VScrollYTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a ScrollYTransition widget."""
