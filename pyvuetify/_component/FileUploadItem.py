...
class FileUploadItem(anywidget.AnyWidget):
    """The FileUploadItem component.
    ...
    Args:
        ...
        show_size: Show the size of the file
        file: The file object uploaded
        file_icon: The icon prepending each uploaded file. This will be a preview image if the file is an image.
    ...
    Returns:
        A VFileUploadItem widget.

    seealso:
        `https://vuetifyjs.com/api/v-file-upload-item`__
    """

    _esm = bundled_path / "VFileUploadItem.js"
    _css = bundled_path / "VFileUploadItem-pyvuetify.css"
    ...
    file = traitlets.Any(allow_none=True).tag(sync=True)
    """The file object uploaded"""

    file_icon = traitlets.Unicode(allow_none=True).tag(sync=True)
    """The icon prepending each uploaded file. This will be a preview image if the file is an image."""
    ...
    def __init__(
        ...
        show_size=False,
        file=None,
        file_icon="mdi-file-document",
        append_avatar=None,
        prepend_avatar=None,
        **kwargs
    ):
        """Initialize a FileUploadItem widget."""
