...
class SpeedDial(anywidget.AnyWidget):
    ...
    seealso:
        `https://vuetifyjs.com/api/v-speed-dial`__
    """

    _esm = bundled_path / "VSpeedDial.js"
    _css = bundled_path / "VSpeedDial-pyvuetify.css"
