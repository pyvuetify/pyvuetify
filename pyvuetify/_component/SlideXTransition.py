...
class SlideXTransition(anywidget.AnyWidget):
    """The SlideXTransition component.
    ...
    Returns:
        A VSlideXTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-slide-x-transition`__
    """

    _esm = bundled_path / "VSlideXTransition.js"
    _css = bundled_path / "VSlideXTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a SlideXTransition widget."""
