...
class TabsWindowItem(anywidget.AnyWidget):
    """The TabsWindowItem component.
    ...
    Returns:
        A VTabsWindowItem widget.

    seealso:
        `https://vuetifyjs.com/api/v-tabs-window-item`__
    """

    _esm = bundled_path / "VTabsWindowItem.js"
    _css = bundled_path / "VTabsWindowItem-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a TabsWindowItem widget."""
