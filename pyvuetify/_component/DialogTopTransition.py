...
class DialogTopTransition(anywidget.AnyWidget):
    """The DialogTopTransition component.
    ...
    Returns:
        A VDialogTopTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-dialog-top-transition`__
    """

    _esm = bundled_path / "VDialogTopTransition.js"
    _css = bundled_path / "VDialogTopTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a DialogTopTransition widget."""
