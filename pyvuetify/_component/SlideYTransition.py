...
class SlideYTransition(anywidget.AnyWidget):
    """The SlideYTransition component.
    ...
    Returns:
        A VSlideYTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-slide-y-transition`__
    """

    _esm = bundled_path / "VSlideYTransition.js"
    _css = bundled_path / "VSlideYTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a SlideYTransition widget."""
