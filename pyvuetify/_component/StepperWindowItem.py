...
class StepperWindowItem(anywidget.AnyWidget):
    """The StepperWindowItem component.
    ...
    Returns:
        A VStepperWindowItem widget.

    seealso:
        `https://vuetifyjs.com/api/v-stepper-window-item`__
    """

    _esm = bundled_path / "VStepperWindowItem.js"
    _css = bundled_path / "VStepperWindowItem-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a StepperWindowItem widget."""
