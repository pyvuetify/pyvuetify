...
class ExpandTransition(anywidget.AnyWidget):
    """The ExpandTransition component.
    ...
    Returns:
        A VExpandTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-expand-transition`__
    """

    _esm = bundled_path / "VExpandTransition.js"
    _css = bundled_path / "VExpandTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a ExpandTransition widget."""
