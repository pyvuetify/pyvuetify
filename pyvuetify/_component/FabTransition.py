...
class FabTransition(anywidget.AnyWidget):
    """The FabTransition component.
    ...
    Returns:
        A VFabTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-fab-transition`__
    """

    _esm = bundled_path / "VFabTransition.js"
    _css = bundled_path / "VFabTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a FabTransition widget."""
