...
class ScrollXReverseTransition(anywidget.AnyWidget):
    """The ScrollXReverseTransition component.
    ...
    Returns:
        A VScrollXReverseTransition widget.

    seealso:
        `https://vuetifyjs.com/api/v-scroll-x-reverse-transition`__
    """

    _esm = bundled_path / "VScrollXReverseTransition.js"
    _css = bundled_path / "VScrollXReverseTransition-pyvuetify.css"
    ...
    def __init__(
        ...
        **kwargs
        ...
        """Initialize a ScrollXReverseTransition widget."""
