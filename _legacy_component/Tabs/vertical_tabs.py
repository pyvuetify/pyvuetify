                    ...
                    children=[
                        v.CardText(
                            children=[
                                ...
                                v.Html(tag="br"),
                                (
                                    "Nam ipsum risus, rutrum vitae, vestibulum eu, molestie vel, lacus. Aenean"
                                    " tellus metus, bibendum sed, posuere ac, mattis non, nunc. Aliquam "
                        ...
                        v.CardText(
                            children=[
                                (
                                    ...
                                    "dui. Proin viverra, ligula sit amet ultrices semper, ligula arcu "
    ...
    children=[
        ...
        v.Row(
            ...
            children=[
                ...
                v.Col(cols=9, children=[tab_items]),
            ],
        ),
    ]
)
