...
The :py:class:`AppBar <pyvuetify.AppBar>` component is pivotal to any graphical user interface (GUI),
as it generally is the primary source of site navigation. The app-bar component works great in conjunction
with a :py:class:`NavigationDrawer <pyvuetify.NavigationDrawer>` for providing site navigation in
your application.

.. api::

    :py:class:`pyvuetify.AppBar`
    :py:class:`pyvuetify.AppBarNavIcon`

Usage
-----

The :py:class:`AppBar <pyvuetify.AppBar>` component is used for application-wide actions and information.
...
A styled icon button component created specifically for use with :py:class:`Toolbar <pyvuetify.Toolbar>`
and :py:class:`AppBar <pyvuetify.AppBar>`. Typically seen on the left side of a toolbar as a hamburger
...
When using the ``elevate_on_scroll`` prop, the :py:class:`AppBar <pyvuetify.AppBar>` will rest at an
...
An :py:class:`AppBar <pyvuetify.AppBar>` with the ``prominent`` prop can opt to have its height shrunk
...
:py:class:`AppBar <pyvuetify.AppBar>` can be hidden on scroll. Use the ``hide_on_scroll``
property for this.
...
:py:class:`AppBar <pyvuetify.AppBar>` can contain background images. You can set source via the
``src`` prop. If you need to customize the :py:class:`Img <pyvuetify.Img>` properties, the app-bar
...
The background image of a :py:class:`AppBar <pyvuetify.AppBar>` can fade on scroll. Use the
...
designated threshold. Once past the threshold, the :py:class:`AppBar <pyvuetify.AppBar>` will
...
:py:class:`AppBar <pyvuetify.AppBar>` can have scroll threshold. It will start reacting to scroll
...
You can easily extend the functionality of app bar by adding :py:class:`Menu <pyvuetify.Menu>`
...
Using the functional component :py:class:`AppBarNavIcon <pyvuetify.AppBarNavIcon>` you can toggle the
state of other components such as a :py:class:`NavigationDrawer <pyvuetify.NavigationDrawer>`.
