                    ...
                    children=[
                        v.ListItem(
                            children=[
                                ...
                                v.ListItemContent(children=[v.ListItemTitle(children=["(650) 555-1234"])]),
                        ...
                        v.ListItem(
                            children=[
                                v.ListItemAction(children=[v.Icon(children=["mdi-phone"])]),
                                v.ListItemContent(children=[v.ListItemTitle(children=["(323) 555-6789"])]),
                                v.ListItemAction(children=[v.Icon(children=["mdi-message-text"])]),
                            ]
                        ),
                        v.Divider(inset=True, class_="mt-0"),
                        v.ListItem(
                            children=[
                                ...
                                v.ListItemContent(children=[v.ListItemTitle(children=["sarah@example.com"])]),
                                v.ListItemAction(children=[v.Icon(children=["mdi-message-text"])]),
                            ]
                        ),
                        v.Divider(inset=True, class_="mt-0"),
                        v.ListItem(
                            children=[
                                v.ListItemAction(children=[v.Icon(children=["mdi-email"])]),
                                v.ListItemContent(children=[v.ListItemTitle(children=["Orlando, FL 79938"])]),
                            ]
                        ),
                    ]
                ),
