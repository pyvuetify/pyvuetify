...
`Voici <https://github.com/voila-dashboards/voici>`__, `Solara <https://github.com/widgetti/solara>`__). Based on the `Vuetify UI <https://v2.vuetifyjs.com/en/>`__
library, it extends the standard Jupyter widget library with additional widgets that are more customizable and composable.
