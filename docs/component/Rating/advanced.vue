<template>
  <v-card class="mx-auto overflow-hidden" max-width="600">
    <v-row>
    ...
    <v-card-title class="align-start">
      <div>
        ...
        <div class="text-grey font-weight-light">Video game</div>
      </div>
    ...
    <v-card-actions>
      <span class="ps-2 text-grey-darken-2 font-weight-light text-body-small"
        >16,544 reviews</span
      >
