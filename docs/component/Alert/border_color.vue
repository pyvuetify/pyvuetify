<template>
  <div>
    <v-alert border="start" border-color="deep-purple accent-4" elevation="1">
    ...
    <v-alert border="top" border-color="success" elevation="1">
    ...
    <v-alert border="bottom" border-color="warning" elevation="1">
    ...
    <v-alert border="end" border-color="error" elevation="1">
