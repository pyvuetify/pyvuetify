  ...
  <v-container>
    <v-card class="pa-4 pb-2 mx-auto" rounded="lg" width="500">
      <div class="d-flex align-center ga-2 mb-1">
        ...
        <span class="text-uppercase text-body-small font-weight-bold"
          >Weekly Downloads</span
        >
      ...
      <div class="d-flex align-end ga-4 pl-1">
        <span
          class="text-headline-large font-weight-bold mb-1"
...
onMounted(async () => {
  ...
  const range = [adapter.startOfWeek(adapter.addMonths(today, -12), 1), today]
    .map((v) => adapter.toISO(v))
    .join(":");
