<template>
  <v-container class="pa-0" fluid>
    <v-alert class="mb-2" type="info" variant="tonal">
      <div>
        <strong>Custom Key Mapping:</strong> Override default key
        representations for localization, branding, or special keys.
      </div>
    </v-alert>
    ...
    <v-row density="comfortable">
      ...
      <v-col cols="12" md="6">
        <v-card
          subtitle="Customized key representations"
            ...
            <v-table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Uses "Return" and ⏎ symbol in Text mode and Symbol mode
                    respectively
                  </td>
                </tr>
              </tbody>
