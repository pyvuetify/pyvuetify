        ...
        <v-card>
          <template v-slot:text>
            ...
            <div class="d-flex flex-column ga-4">
              <div>
                <h4 class="text-body-large mt-0 mb-2">
              ...
              <div>
                ...
                <div class="pa-4 border rounded" style="line-height: 1.7">
                  <h4 class="text-title-large mt-0 mb-3">
                    Getting Started with Code Editor
                  </h4>

                  <p class="mb-3">
                    Welcome to your new development environment! Here are the
                    essential keyboard shortcuts to boost your productivity.
                    Press
                    <v-hotkey
                      :display-mode="displayMode"
                      :platform="platform"
                  ...
                  <p class="mb-3">
                    <strong>File Operations:</strong> Save your current file
                    with
                    <v-hotkey
                      :display-mode="displayMode"
                      :platform="platform"
