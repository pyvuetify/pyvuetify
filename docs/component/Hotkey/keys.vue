          ...
          <template v-slot:text>
            ...
            <div class="d-flex flex-wrap ga-4 align-center justify-center">
              <div class="text-center">
                ...
                <v-hotkey :platform="platform" keys="meta+shift+p"></v-hotkey>
              </div>

              <div class="text-center">
                <div class="text-body-small mb-1">ctrl+k meta+p</div>
                <v-hotkey :platform="platform" keys="ctrl+k meta+p"></v-hotkey>
              </div>

              <div class="text-center">
                <div class="text-body-small mb-1">alt+arrowup</div>
                <v-hotkey :platform="platform" keys="alt+arrowup"></v-hotkey>
              </div>
