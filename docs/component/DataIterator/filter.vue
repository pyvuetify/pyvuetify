              ...
              <v-card class="pb-3" border flat>
                ...
                <v-list-item :subtitle="item.raw.subtitle" class="mb-2">
                  <template v-slot:title>
                    <strong
                      class="d-block text-title-large py-2 text-truncate"
                      >{{ item.raw.title }}</strong
                    >
                  </template>
                </v-list-item>
                ...
                <div class="d-flex justify-space-between px-4">
                  <div
                    class="d-flex align-center text-body-small text-medium-emphasis me-1"
                  >
  ...
  data: () => ({
    ...
    games: [
      ...
      },
      {
        ...
        title: "1920s Mystery Detective Chronicles",
        subtitle:
          "Solve crimes and uncover secrets in the glamorous 1920s era.",
        advanced: false,
        duration: "9 minutes",
      },
    ],
