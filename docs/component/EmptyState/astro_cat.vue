              ...
              <v-card>
                ...
                >
                  ...
                  <template v-slot:title>
                    <div class="text-title-large text-high-emphasis">
                      Get Started
                    </div>
                  </template>
                  ...
                  <template v-slot:text>
                    <div
                      class="text-body-medium font-weight-medium text-medium-emphasis"
                    >
                      Find a great movie, then relax and enjoy with the Movies &
                      TV app.
                    </div>
                  </template>
