  ...
  <div class="text-center my-3">
    ...
    >
      ...
      <template v-slot:append>
        <div
          class="d-flex pa-3 ga-1 text-body-small align-center border-t opacity-70"
        >
          <v-kbd>
            <v-icon
              :icon="[
                'M16.018 3.815L15.232 8h-4.966l.716-3.815l-1.964-.37L8.232 8H4v2h3.857l-.751 4H3v2h3.731l-.714 3.805l1.965.369L8.766 16h4.966l-.714 3.805l1.965.369l.783-4.174H20v-2h-3.859l.751-4H21V8h-3.733l.716-3.815zM14.106 14H9.141l.751-4h4.966z',
              ]"
              size="14"
            ></v-icon>
          </v-kbd>
...
function futureTime(minutes) {
  ...
  return new Intl.DateTimeFormat(adapter.locale, {
    hour: "numeric",
    minute: "numeric",
  }).format(d);
}
...
export default {
  ...
  methods: {
    futureTime(minutes) {
      const d = new Date();
      d.setMinutes(d.getMinutes() + minutes);
      return new Intl.DateTimeFormat(this.$vuetify.date.locale, {
        hour: "numeric",
        minute: "numeric",
      }).format(d);
    },
