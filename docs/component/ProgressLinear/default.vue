<template>
  <v-container>
    ...
    <v-progress-linear :model-value="knowledge" height="25">
      <!-- your value, no need to round unless you want to -->
      <strong>{{ knowledge }}%</strong>
    </v-progress-linear>

    <br />

    <v-progress-linear :model-value="skill" color="blue-grey" height="25">
